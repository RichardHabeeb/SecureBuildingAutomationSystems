...
.LFB2:
	...
	.loc 1 39 0
	.syntax divided
@ 39 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/cpuid.h" 1
	mrs r3, cpsr
@ 0 "" 2
	.arm
	.syntax unified
...
.LFE2:
	...
	.local	kernel_info
	.comm	kernel_info,24,4
	.local	user_info
	.comm	user_info,24,4
	.local	non_boot_lock
	.comm	non_boot_lock,4,4
	.align	2
	.global	non_boot_main
	.syntax unified
	.arm
	.type	non_boot_main, %function
non_boot_main:
	.fnstart
.LFB3:
	.file 2 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/boot.c"
	.loc 2 38 0
	.cfi_startproc
...
.LFE3:
	.fnend
	.size	non_boot_main, .-non_boot_main
	.section	.rodata
	.align	2
.LC0:
	.ascii	"\012ELF-loader started on \000"
	.align	2
.LC1:
	.ascii	"  paddr=[%p..%p]\012\000"
	.align	2
.LC2:
	.ascii	"No user images loaded!\012\000"
	.align	2
.LC3:
	.ascii	"Enabling hypervisor MMU and paging\012\000"
	.align	2
.LC4:
	.ascii	"Enabling MMU and paging\012\000"
	.align	2
.LC5:
	.ascii	"Jumping to kernel-image entry point...\012\012\000"
	.align	2
.LC6:
	.ascii	"Kernel returned back to the elf-loader.\012\000"
	.text
	.align	2
	.global	main
	.syntax unified
...
.LFB4:
	...
	ldr	r3, .L8
	mov	r2, r3
	movw	r1, #:lower16:_start
	movt	r1, #:upper16:_start
	movw	r0, #:lower16:.LC1
	movt	r0, #:upper16:.LC1
	bl	printf
	.loc 2 86 0
	sub	r3, fp, #20
	mov	r2, #1
	movw	r1, #:lower16:user_info
	movt	r1, #:upper16:user_info
	movw	r0, #:lower16:kernel_info
	movt	r0, #:upper16:kernel_info
	bl	load_images
	.loc 2 87 0
	ldr	r3, [fp, #-20]
	cmp	r3, #1
...
.L6:
	...
	bl	arm_enable_mmu
	.loc 2 112 0
	movw	r3, #:lower16:kernel_info
	movt	r3, #:upper16:kernel_info
	ldr	r2, [r3, #8]
	mov	r3, #32768
	movt	r3, 542
	cmp	r2, r3
...
.L7:
	...
	ldr	r3, [r3, #16]
	mov	r4, r3
	movw	r3, #:lower16:user_info
	movt	r3, #:upper16:user_info
	ldr	r0, [r3]
	movw	r3, #:lower16:user_info
	movt	r3, #:upper16:user_info
	ldr	r1, [r3, #4]
...
.Ldebug_macro0:
	...
	.4byte	.Ldebug_macro2
	.byte	0x4
	.file 6 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/stdio.h"
	.byte	0x3
	.uleb128 0xe
	.uleb128 0x6
	.byte	0x7
	.4byte	.Ldebug_macro3
	.byte	0x4
	.file 7 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/stdlib.h"
	.byte	0x3
	.uleb128 0xf
	.uleb128 0x7
	.byte	0x5
	...
	.4byte	.LASF453
	.byte	0x4
	.file 8 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/string.h"
	.byte	0x3
	.uleb128 0x10
	.uleb128 0x8
	.byte	0x5
	...
	.4byte	.Ldebug_macro5
	.byte	0x4
	.file 9 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/plat-imx6/platform.h"
	.byte	0x3
	.uleb128 0x14
	.uleb128 0x9
	.byte	0x7
...
.Ldebug_macro4:
	...
	.4byte	.LASF460
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.cpuid.h.12.78f23c7df0b9193b7e32d45b8ee79c3c,comdat
.Ldebug_macro5:
	.2byte	0x4
	.byte	0
	.byte	0x5
	...
	.4byte	.LASF464
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.platform.h.12.71548d715c2b89059b2426eec29b4a4d,comdat
.Ldebug_macro6:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF469:
	.ascii	"IMX6_UART4_PADDR 0x021f0000\000"
.LASF70:
...
.LASF467:
	.ascii	"IMX6_UART2_PADDR 0x021e8000\000"
.LASF226:
...
.LASF471:
	.ascii	"UART_PPTR IMX6_UART2_PADDR\000"
.LASF203:
...
.LASF470:
	.ascii	"IMX6_UART5_PADDR 0x021F4000\000"
.LASF299:
...
.LASF466:
	.ascii	"IMX6_UART1_PADDR 0x02020000\000"
.LASF63:
...
.LASF500:
	...
	.ascii	"lfloader/src/arch-arm/boot.c\000"
.LASF61:
...
.LASF468:
	.ascii	"IMX6_UART3_PADDR 0x021ec000\000"
.LASF495:
	.ascii	"non_boot_lock\000"
.LASF443:
