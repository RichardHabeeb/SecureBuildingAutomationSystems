...
init_boot_pd:
	.fnstart
.LFB0:
	.file 1 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/mmu.c"
	.loc 1 27 0
	.cfi_startproc
...
.L3:
	...
	orr	r3, r3, #2
	.loc 1 34 0 discriminator 3
	movw	r2, #:lower16:_boot_pd
	movt	r2, #:upper16:_boot_pd
	ldr	r1, [fp, #-8]
	str	r3, [r2, r1, lsl #2]
...
.LFE0:
	...
	.align	2
	.global	init_lpae_boot_pd
	.syntax unified
	.arm
	.type	init_lpae_boot_pd, %function
init_lpae_boot_pd:
	.fnstart
.LFB1:
	.loc 1 61 0
...
.L8:
	...
	ldr	r3, [fp, #-8]
	lsl	r2, r3, #12
	movw	r3, #:lower16:_lpae_boot_pmd
	movt	r3, #:upper16:_lpae_boot_pmd
	add	r3, r2, r3
	...
	mov	r0, r3
	mov	r1, #0
	movw	r3, #:lower16:_lpae_boot_pgd
	movt	r3, #:upper16:_lpae_boot_pgd
	ldr	r2, [fp, #-8]
	lsl	r2, r2, #3
	add	r3, r3, r2
	strd	r0, [r3]
...
.LFE1:
	.fnend
	.size	init_lpae_boot_pd, .-init_lpae_boot_pd
.Letext0:
	.file 2 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/stdint.h"
	.file 3 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/elfloader.h"
...
.LASF423:
	...
	.ascii	"lfloader/src/arch-arm/mmu.c\000"
.LASF183:
...
.LASF395:
	.ascii	"ARM_2MB_BLOCK_BITS 21\000"
.LASF156:
...
.LASF394:
	.ascii	"ARM_1GB_BLOCK_BITS 30\000"
.LASF228:
