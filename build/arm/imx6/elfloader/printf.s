...
write_string:
	.fnstart
.LFB0:
	.file 1 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/printf.c"
	.loc 1 30 0
	.cfi_startproc
...
.L8:
	...
	mov	r3, r1
	mov	r2, r3
	movw	r3, #:lower16:hex.3776
	movt	r3, #:upper16:hex.3776
...
.LFE2:
	.fnend
	.size	vxprintf, .-vxprintf
	.align	2
	.syntax unified
	.arm
	.type	arch_write_char, %function
arch_write_char:
	.fnstart
.LFB3:
	.loc 1 162 0
...
.LFE3:
	.fnend
	.size	arch_write_char, .-arch_write_char
	.align	2
	.global	printf
	.syntax unified
	.arm
...
.LFB4:
	...
	ldr	r3, [fp, #-12]
	ldr	r2, [fp, #4]
	movw	r0, #:lower16:arch_write_char
	movt	r0, #:upper16:arch_write_char
	bl	vxprintf
	.loc 1 175 0
	ldr	r3, [fp, #-8]
	.loc 1 176 0
...
.LFE5:
	...
	.syntax unified
	.arm
	.type	sprintf_write_char, %function
sprintf_write_char:
	.fnstart
.LFB6:
	.loc 1 196 0
...
.LFE6:
	.fnend
	.size	sprintf_write_char, .-sprintf_write_char
	.align	2
	.global	sprintf
	.syntax unified
	.arm
...
.LFB7:
	...
	ldr	r3, [fp, #-20]
	ldr	r2, [fp, #4]
	movw	r0, #:lower16:sprintf_write_char
	movt	r0, #:upper16:sprintf_write_char
	bl	vxprintf
	.loc 1 209 0
	ldr	r3, [fp, #-12]
	.loc 1 210 0
...
.LFE7:
	...
	.section	.rodata
	.align	2
	.type	hex.3776, %object
	.size	hex.3776, 17
hex.3776:
	.ascii	"0123456789abcdef\000"
	.text
.Letext0:
	.file 2 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/stdarg.h"
	.file 3 "<built-in>"
...
.Ldebug_macro0:
	...
	.uleb128 0xc
	.4byte	.LASF380
	.file 4 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/stdint.h"
	.byte	0x3
	.uleb128 0xb
	.uleb128 0x4
	.byte	0x7
...
.Ldebug_macro1:
	...
	.4byte	.LASF383
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.stdarg.h.19.5bcb4808aa38d0faf4bfb60f856d049f,comdat
.Ldebug_macro2:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF385:
	.ascii	"va_arg(ap,type) __builtin_va_arg(ap, type)\000"
.LASF14:
...
.LASF424:
	.ascii	"/home/mint/seL4/dhs-demo-feb-2018/build/arm/imx6/el"
	.ascii	"floader\000"
.LASF423:
	.ascii	"/home/mint/seL4/dhs-demo-feb-2018/tools/common/../e"
	.ascii	"lfloader/src/arch-arm/printf.c\000"
.LASF373:
...
.LASF392:
	.ascii	"MAX_INT_BUFF_SIZE 80\000"
.LASF28:
...
.LASF362:
	.ascii	"__linux 1\000"
.LASF386:
	.ascii	"va_copy(dest,src) __builtin_va_copy(dest, src)\000"
.LASF277:
...
.LASF388:
	.ascii	"va_start(ap,parmN) __builtin_va_start(ap, parmN)\000"
.LASF322:
...
.LASF417:
	.ascii	"num_chars_printed_ptr\000"
.LASF128:
