# 1 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/mmu.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/mmu.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/mmu.c"
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/mmu.c" 2
...
# 13 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/mmu.c" 2
...
# 14 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/mmu.c" 2
...
void init_lpae_boot_pd(struct image_info *kernel_info)
{
    ...
    for(i = 0; i < 4; i++){
        _lpae_boot_pgd[i] = ((uintptr_t)_lpae_boot_pmd + (i << 12))
                           | (1 << (1))
                           | (1 << (0));
    }

    for (i = 0; i < (first_vaddr >> 21); i++) {
        _lpae_boot_pmd[i] = (i << 21)
                            | (1 << (10))
                            | (1 << (0));
    }

    for (k = 0; k < ((-first_vaddr) >> 21); k++) {
        _lpae_boot_pmd[i + k] = ((k << 21) + first_paddr)
                                | (1 << (10))
                                | (1 << (0));
    }
}
