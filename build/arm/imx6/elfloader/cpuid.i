# 1 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/cpuid.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/cpuid.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/cpuid.c"
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/cpuid.h" 2
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/cpuid.c" 2
...
# 13 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/cpuid.c" 2
...
void print_cpuid(void)
{
    ...
    if (((((cpuid) >> 4) & 0xfff) & 0xf00) == 0xC00) {
        printf("Cortex-A%d ", (((cpuid) >> 4) & 0xfff) & 0xff);
    } else {
        printf("Part: 0x%03x ", (((cpuid) >> 4) & 0xfff));
    }

    printf("r%dp%d", (((cpuid) >> 20) & 0xf), (((cpuid) >> 0) & 0xf));
    printf("\n");
}
...
int get_cortex_a_part(void)
{
    uint32_t cpuid;
    cpuid = read_cpuid_id();
    if((((cpuid) >> 16) & 0xf) == 0xF && (((cpuid) >> 24) & 0xff) == 'A'){
        return (((cpuid) >> 4) & 0xfff) & 0xFF;
    }else{
        return -1;
    }
}
