# 1 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/elf/elf.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/elf/elf.c"
# 81 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/elf/elf.c"
...
void elf_getProgramHeaderInfo(void *elfFile, uint16_t ph, uint64_t *p_vaddr,
                              uint64_t *p_paddr, uint64_t *p_filesz,
                              uint64_t *p_offset, uint64_t *p_memsz);
# 82 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/elf/elf.c" 2
...
# 83 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/elf/elf.c" 2
...
{
    return ( ((struct Elf32_Header*)elfFile)->e_ident[4] == 1 )
...
{
    uint64_t mem_min = (18446744073709551615ULL);
    uint64_t mem_max = 0;
    int i;
