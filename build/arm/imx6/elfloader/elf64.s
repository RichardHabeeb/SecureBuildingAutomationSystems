...
elf64_getSectionTable:
	.fnstart
.LFB11:
	.file 1 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/elf/elf64.h"
	.loc 1 168 0
	.cfi_startproc
...
elf64_checkFile:
	.fnstart
.LFB22:
	.file 2 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/elf/elf64.c"
	.loc 2 86 0
	.cfi_startproc
...
.L28:
	...
	str	r3, [fp, #-8]
.L27:
	.loc 2 203 0 is_stmt 0 discriminator 1
	ldr	r2, [fp, #-8]
	ldr	r3, [fp, #-12]
	cmp	r2, r3
	blt	.L30
...
.LFB33:
	...
	.loc 2 220 0
	ldr	r0, [fp, #-8]
	bl	elf64_getProgramSegmentTable
	mov	r1, r0
	ldr	r2, [fp, #-12]
	mov	r3, r2
	lsl	r3, r3, #3
...
.Ldebug_macro0:
	...
	.4byte	.Ldebug_macro2
	.byte	0x4
	.file 6 "/home/mint/seL4/dhs-demo-feb-2018/tools/common/../elfloader/src/arch-arm/elf/elf32.h"
	.byte	0x3
	.uleb128 0x6d
	.uleb128 0x6
	.byte	0x5
...
.LASF513:
	...
	.ascii	"lfloader/src/arch-arm/elf/elf64.c\000"
.LASF46:
