	...
	.eabi_attribute 34, 1
	.eabi_attribute 18, 4
	.file	"protocol.capnp.c"
	.text
.Ltext0:
	.cfi_sections	.debug_frame
	.align	2
	.global	new_BuildingData
	.syntax unified
	.arm
	.type	new_BuildingData, %function
new_BuildingData:
	.fnstart
.LFB17:
	.file 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/protocol.capnp.c"
	.loc 1 13 0
	.cfi_startproc
...
.LFE17:
	.fnend
	.size	new_BuildingData, .-new_BuildingData
	.align	2
	.global	new_BuildingData_list
	.syntax unified
	.arm
	.type	new_BuildingData_list, %function
new_BuildingData_list:
	.fnstart
.LFB18:
	.loc 1 18 0
	.cfi_startproc
...
.LFE18:
	.fnend
	.size	new_BuildingData_list, .-new_BuildingData_list
	.align	2
	.global	read_BuildingData
	.syntax unified
	.arm
	.type	read_BuildingData, %function
read_BuildingData:
	.fnstart
.LFB19:
	.loc 1 23 0
...
.LBB54:
.LBB55:
	.file 2 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_c.h"
	.loc 2 395 0
	cmp	r3, #7
	ble	.L6
	ldr	r1, [sp, #80]
...
.LFE19:
	.fnend
	.size	read_BuildingData, .-read_BuildingData
	.align	2
	.global	write_BuildingData
	.syntax unified
	.arm
	.type	write_BuildingData, %function
write_BuildingData:
	.fnstart
.LFB20:
	.loc 1 32 0
...
.LFE20:
	.fnend
	.size	write_BuildingData, .-write_BuildingData
	.align	2
	.global	get_BuildingData
	.syntax unified
	.arm
	.type	get_BuildingData, %function
get_BuildingData:
	.fnstart
.LFB21:
	.loc 1 41 0
...
.LFE21:
	.fnend
	.size	get_BuildingData, .-get_BuildingData
	.align	2
	.global	set_BuildingData
	.syntax unified
	.arm
	.type	set_BuildingData, %function
set_BuildingData:
	.fnstart
.LFB22:
	.loc 1 46 0
...
.LFE22:
	.fnend
	.size	set_BuildingData, .-set_BuildingData
	.align	2
	.global	new_BuildingConfig
	.syntax unified
	.arm
	.type	new_BuildingConfig, %function
new_BuildingConfig:
	.fnstart
.LFB23:
	.loc 1 52 0
...
.LFE23:
	.fnend
	.size	new_BuildingConfig, .-new_BuildingConfig
	.align	2
	.global	new_BuildingConfig_list
	.syntax unified
	.arm
	.type	new_BuildingConfig_list, %function
new_BuildingConfig_list:
	.fnstart
.LFB24:
	.loc 1 57 0
	.cfi_startproc
...
.LFE24:
	.fnend
	.size	new_BuildingConfig_list, .-new_BuildingConfig_list
	.align	2
	.global	read_BuildingConfig
	.syntax unified
	.arm
	.type	read_BuildingConfig, %function
read_BuildingConfig:
	.fnstart
.LFB25:
	.loc 1 62 0
...
.LFE25:
	.fnend
	.size	read_BuildingConfig, .-read_BuildingConfig
	.align	2
	.global	write_BuildingConfig
	.syntax unified
	.arm
	.type	write_BuildingConfig, %function
write_BuildingConfig:
	.fnstart
.LFB26:
	.loc 1 67 0
	.cfi_startproc
...
.LFE26:
	.fnend
	.size	write_BuildingConfig, .-write_BuildingConfig
	.align	2
	.global	get_BuildingConfig
	.syntax unified
	.arm
	.type	get_BuildingConfig, %function
get_BuildingConfig:
	.fnstart
.LFB27:
	.loc 1 72 0
	.cfi_startproc
	@ args = 28, pretend = 16, frame = 40
	@ frame_needed = 0, uses_anonymous_args = 0
.LVL64:
	.pad #16
	sub	sp, sp, #16
...
.LFE27:
	.fnend
	.size	get_BuildingConfig, .-get_BuildingConfig
	.align	2
	.global	set_BuildingConfig
	.syntax unified
	.arm
	.type	set_BuildingConfig, %function
set_BuildingConfig:
	.fnstart
.LFB28:
	.loc 1 77 0
...
.LFE28:
	.fnend
	.size	set_BuildingConfig, .-set_BuildingConfig
	.section	.rodata
	.align	2
	.set	.LANCHOR0,. + 0
	.type	capn_val0, %object
	.size	capn_val0, 12
capn_val0:
	.word	0
	.word	.LC0
...
.Letext0:
	...
	.file 4 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/protocol.capnp.h"
...
.Ldebug_macro0:
	...
	.4byte	.Ldebug_macro9
	.byte	0x4
	.file 9 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/unistd.h"
	.byte	0x3
	.uleb128 0x10
	.uleb128 0x9
	.byte	0x7
	...
	.file 10 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/bits/posix.h"
	.byte	0x3
	.uleb128 0xea
	.uleb128 0xa
	.byte	0x7
	...
	.byte	0x4
	.file 11 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/endian.h"
	.byte	0x3
	.uleb128 0x13
	.uleb128 0xb
	.byte	0x7
	...
	.byte	0x4
	.file 12 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/stddef.h"
	.byte	0x3
	.uleb128 0x1c
	.uleb128 0xc
	.byte	0x7
...
.LASF907:
	.ascii	"write_BuildingConfig\000"
.LASF118:
...
.LASF916:
	.ascii	"get_BuildingConfig\000"
.LASF625:
	.ascii	"_SC_BC_DIM_MAX 37\000"
.LASF887:
	.ascii	"BuildingConfig_ptr\000"
.LASF719:
...
.LASF842:
	.ascii	"capnp_unused __attribute__((unused))\000"
.LASF611:
...
.LASF912:
	.ascii	"get_BuildingData\000"
.LASF913:
	.ascii	"set_BuildingData\000"
.LASF430:
...
.LASF932:
	.ascii	"/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/prot"
	.ascii	"ocol.capnp.c\000"
.LASF393:
...
.LASF915:
	.ascii	"new_BuildingConfig_list\000"
.LASF604:
...
.LASF909:
	.ascii	"new_BuildingData_list\000"
.LASF454:
