# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capn-malloc.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capn-malloc.c"
# 12 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capn-malloc.c"
#pragma GCC diagnostic ignored "-Wunused-parameter"


# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_c.h" 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_c.h"
#define CAPNP_C_H 
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_c.h" 2
...
char *ctermid(char *);
#define L_ctermid 20
# 16 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_c.h" 2
...
# 17 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_c.h" 2


# 1 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/endian.h" 1
...
# 20 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_c.h" 2
# 28 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_c.h"
...
# 29 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_c.h" 2
...
# 73 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_c.h"
struct capn {

 struct capn_segment *(*lookup)(void* , uint32_t );
 struct capn_segment *(*create)(void* , uint32_t , int );
 struct capn_segment *(*create_local)(void* , int );
 void *user;
...
# 122 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_c.h"
struct __attribute__ ((aligned(8))) capn_segment {
...
# 206 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_c.h"
...
static inline uint64_t capn_read64(capn_ptr p, int off);
static inline int capn_write1(capn_ptr p, int off, int val);
static inline int capn_write8(capn_ptr p, int off, uint8_t val);
static inline int capn_write16(capn_ptr p, int off, uint16_t val);
static inline int capn_write32(capn_ptr p, int off, uint32_t val);
static inline int capn_write64(capn_ptr p, int off, uint64_t val);
# 275 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_c.h"
...
static inline uint8_t capn_flip8(uint8_t v) {
 return v;
}
static inline uint16_t capn_flip16(uint16_t v) {

 return v;
# 308 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_c.h"
}
static inline uint32_t capn_flip32(uint32_t v) {

 return v;
# 323 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_c.h"
}
static inline uint64_t capn_flip64(uint64_t v) {

 return v;
# 342 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_c.h"
}
...
static inline float capn_to_f32(uint32_t v) {
 union capn_conv_f32 u;
 u.u = v;
 return u.f;
}
static inline double capn_to_f64(uint64_t v) {
 union capn_conv_f64 u;
 u.u = v;
 return u.f;
}
static inline uint32_t capn_from_f32(float v) {
 union capn_conv_f32 u;
 u.f = v;
 return u.u;
}
static inline uint64_t capn_from_f64(double v) {
 union capn_conv_f64 u;
 u.f = v;
 return u.u;
}
# 16 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capn-malloc.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_priv.h" 1
# 17 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_priv.h"
#define CAPNP_PRIV_H 
...
# 35 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_priv.h"
struct capn_stream {
...
# 58 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capnp_priv.h"
__attribute__((visibility ("internal"))) int capn_deflate(struct capn_stream*);
__attribute__((visibility ("internal"))) int capn_inflate(struct capn_stream*);
# 17 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capn-malloc.c" 2
...
int rand_r (unsigned *);
# 18 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capn-malloc.c" 2
...
# 19 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capn-malloc.c" 2
...
# 20 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capn-malloc.c" 2
...
# 21 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capn-malloc.c" 2
# 32 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capn-malloc.c"
...
static int read_fp(void *p, size_t sz, FILE *f, struct capn_stream *z, uint8_t* zbuf, int packed) {
 if (f && packed) {
  ...
  while (z->avail_out && capn_inflate(z) == -2) {
   int r;
   memmove(zbuf, z->next_in, z->avail_in);
   r = fread(zbuf+z->avail_in, 1, 4096 - z->avail_in, f);
   if (r <= 0)
    return -1;
   z->avail_in += r;
  }
...
# 129 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capn-malloc.c"
 struct capn_segment *s = ((void*)0);
 ...
 for (i = 0; i < segnum; i++) {
  ...
  if (n > 0x7fffffff/8 || n > (0xffffffff)/8 || (0xffffffff) - total < n*8)
   goto err;
  hdr[i] = n*8;
  total += hdr[i];
 }
...
int capn_init_mem(struct capn *c, const uint8_t *p, size_t sz, int packed) {
 ...
 z.next_in = p;
 z.avail_in = sz;
 return init_fp(c, ((void*)0), &z, packed);
}

static void header_calc(struct capn *c, uint32_t *headerlen, size_t *headersz)
{
# 211 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/capn-malloc.c"
