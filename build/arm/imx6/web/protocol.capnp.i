# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/protocol.capnp.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/protocol.capnp.c"
# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/protocol.capnp.h" 1
...
# 5 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/protocol.capnp.h" 2
...
# 23 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/protocol.capnp.h"
struct BuildingData;
...
# 2 "/home/mint/seL4/dhs-demo-feb-2018/apps/web/src/protocol.capnp.c" 2
...
void read_BuildingData(struct BuildingData *s __attribute__((unused)), BuildingData_ptr p) {
 capn_resolve(&p.p);
 (void) s;;
...
void write_BuildingData(const struct BuildingData *s __attribute__((unused)), BuildingData_ptr p) {
 capn_resolve(&p.p);
 (void) s;;
...
void read_BuildingConfig(struct BuildingConfig *s __attribute__((unused)), BuildingConfig_ptr p) {
 capn_resolve(&p.p);
 (void) s;;
 s->desiredTemp = capn_to_f64(capn_read64(p.p, 0));
}
void write_BuildingConfig(const struct BuildingConfig *s __attribute__((unused)), BuildingConfig_ptr p) {
 capn_resolve(&p.p);
 (void) s;;
