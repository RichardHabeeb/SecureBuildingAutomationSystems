# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsos/src/sos.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsos/src/sos.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsos/src/sos.c"
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsos/src/sos.c" 2
...
# 13 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsos/src/sos.c" 2
...
int rand_r (unsigned *);
# 14 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsos/src/sos.c" 2
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsos/src/sos.c" 2
...
char *ctermid(char *);
#define L_ctermid 20
# 17 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/sos.h" 2
...
# 16 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsos/src/sos.c" 2



int sos_sys_open(const char *path, fmode_t mode) {
    ((!"You need to implement this") ? ((void)0) : (__assert_fail("!\"You need to implement this\"", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsos/src/sos.c", 20, __func__)));
    return -1;
}

int sos_sys_read(int file, char *buf, size_t nbyte) {
    ((!"You need to implement this") ? ((void)0) : (__assert_fail("!\"You need to implement this\"", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsos/src/sos.c", 25, __func__)));
    return -1;
}

int sos_sys_write(int file, const char *buf, size_t nbyte) {
    ((!"You need to implement this") ? ((void)0) : (__assert_fail("!\"You need to implement this\"", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsos/src/sos.c", 30, __func__)));
    return -1;
}

void sos_sys_usleep(int msec) {
    ((!"You need to implement this") ? ((void)0) : (__assert_fail("!\"You need to implement this\"", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsos/src/sos.c", 35, __func__)));
}

int64_t sos_sys_time_stamp(void) {
    ((!"You need to implement this") ? ((void)0) : (__assert_fail("!\"You need to implement this\"", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsos/src/sos.c", 39, __func__)));
    return -1;
}
