# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/mach/imx/epit.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/mach/imx/epit.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/mach/imx/epit.c"
...
char *ctermid(char *);
#define L_ctermid 20
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/mach/imx/epit.c" 2
...
# 13 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/mach/imx/epit.c" 2
...
# 14 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/mach/imx/epit.c" 2
...
int rand_r (unsigned *);
# 15 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/mach/imx/epit.c" 2
...
# 18 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/mach/imx/epit.c" 2
...
# 20 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/mach/imx/epit.c" 2
...
# 21 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/mach/imx/epit.c" 2
...
# 22 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/mach/imx/epit.c" 2
...
typedef enum {
    ...
    RLD = 3,
# 64 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/mach/imx/epit.c"
    PRESCALER = 4,
...
configure_epit(const pstimer_t *timer, uint64_t ns)
{
    ...
    uint64_t counterValue = (uint64_t) ((((528u) / 4u) / 2u) / (epit->prescaler + 1)) * (ns / 1000ULL);
...
static int
epit_oneshot_absolute(const pstimer_t *timer __attribute__((__unused__)), uint64_t ns __attribute__((__unused__)))
{
...
epit_handle_irq(const pstimer_t *timer, uint32_t irq)
{
    ...
    ((irq == epit->irq) ? ((void)0) : (__assert_fail("irq == epit->irq", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/mach/imx/epit.c", 196, __func__)));
...
epit_get_time(const pstimer_t *timer)
{
    ...
    uint64_t ns = (value / (uint64_t)(((528u) / 4u) / 2u)) * 1000llu * (epit->prescaler + 1);
...
epit_get_timer(epit_config_t *config)
{
    ...
    if (config->irq != 88 && config->irq != 89) {
    ...
    epit->epit_map->epitcr = (IPG_CLK << CLKSRC) |
