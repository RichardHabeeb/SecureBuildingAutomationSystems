# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/src.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/src.c"
# 10 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/src.c"
# 1 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/src.h" 1
# 11 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/src.h"
#define SRC_H 
...
# 14 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/src.h" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/plat/src.h" 1
# 11 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/plat/src.h"
#define PLAT_SRC_H 
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/src.h" 2
...
# 11 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/src.c" 2
...
reset_controller_assert_reset(src_dev_t* dev, enum src_rst_id id)
{
    ...
    if (id >= 0 && id < (sizeof(reset_map)/sizeof((reset_map)[0]))) {
        reset_bit = reset_map[id];
        regs = src_get_regs(dev);

        regs->scr |= (1ul<<(reset_bit));
        while (regs->scr & (1ul<<(reset_bit)));
    }
}
...
{
    ((sizeof(struct src_regs) == 0x48) ? ((void)0) : (__assert_fail("sizeof(struct src_regs) == 0x48", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/src.c", 75, __func__)));
    if (id < 0 || id >= NSRC) {
        return -1;
    }

    src_regs = ps_io_map(&ops->io_mapper, 0x20D8000, 0x1000, 0, PS_MEM_NORMAL);
    if (src_regs == ((void*)0)) {
        return -1;
    }
