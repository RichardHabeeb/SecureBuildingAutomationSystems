...
.Ltext0:
	...
	.syntax unified
	.arm
	.type	ps_cdev_init, %function
ps_cdev_init:
	.fnstart
.LFB28:
	.file 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/chardev.c"
	.loc 1 47 0
	.cfi_startproc
...
.LFE28:
	.fnend
	.size	ps_cdev_init, .-ps_cdev_init
	.section	.rodata
	.align	2
	.set	.LANCHOR0,. + 0
	.type	dev_defn, %object
	.size	dev_defn, 100
dev_defn:
	.word	0
	.word	33685504
	...
	.word	uart5_irqs
	.word	uart_init
	.type	uart5_irqs, %object
	.size	uart5_irqs, 8
uart5_irqs:
	.word	62
	.word	-1
	.type	uart4_irqs, %object
	.size	uart4_irqs, 8
uart4_irqs:
	.word	61
	.word	-1
	.type	uart3_irqs, %object
	.size	uart3_irqs, 8
uart3_irqs:
	.word	60
	.word	-1
	.type	uart2_irqs, %object
	.size	uart2_irqs, 8
uart2_irqs:
	.word	59
	.word	-1
	.type	uart1_irqs, %object
	.size	uart1_irqs, 8
uart1_irqs:
	.word	58
	.word	-1
...
.Letext0:
	...
	.file 8 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/chardev.h"
	.file 9 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/plat/serial.h"
	.file 10 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/../../chardev.h"
...
.Ldebug_macro0:
	...
	.uleb128 0xc
	.4byte	.LASF383
	.file 11 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/stddef.h"
	.byte	0x3
	.uleb128 0xe
	.uleb128 0xb
	.byte	0x7
	...
	.4byte	.Ldebug_macro8
	.byte	0x4
	.file 15 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/assert.h"
	.byte	0x3
	.uleb128 0x10
	.uleb128 0xf
	.byte	0x7
	...
	.byte	0x4
	.byte	0x4
	.file 36 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/../../common.h"
	.byte	0x3
	.uleb128 0x11
	.uleb128 0x24
	.byte	0x5
	.uleb128 0xc
	.4byte	.LASF804
	.file 37 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/../../services.h"
	.byte	0x3
	.uleb128 0x10
	.uleb128 0x25
	...
	.byte	0x4
	.byte	0x4
	.file 39 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/serial.h"
	.byte	0x3
	.uleb128 0x14
	.uleb128 0x27
	.byte	0x4
...
.LASF824:
	.ascii	"UART_DEFN(devid) { .id = IMX6_UART ##devid, .paddr "
	.ascii	"= UART ##devid ##_PADDR, .size = BIT(12), .irqs = u"
	.ascii	"art ##devid ##_irqs, .init_fn = &uart_init }\000"
.LASF841:
	.ascii	"double\000"
.LASF654:
...
.LASF991:
	...
	.ascii	"rt/src/plat/imx6/chardev.c\000"
.LASF30:
