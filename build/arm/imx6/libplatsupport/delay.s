...
.Ltext0:
	...
	.syntax unified
	.arm
	.type	ps_udelay, %function
ps_udelay:
	.fnstart
.LFB1:
	.file 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/delay.c"
	.loc 1 63 0
	.cfi_startproc
...
.LBB5:
	...
	mov	r3, r2
	.syntax divided
@ 40 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/delay.c" 1
	1:    subs r3, r3, #1;    subs r3, r3, #1;    subs r3, r3, #1;    subs r3, r3, #1;    subs r3, r3, #1;    subs r3, r3, #1;    subs r3, r3, #1;    subs r3, r3, #1;    subs r3, r3, #1;    subs r3, r3, #1;    subs r3, r3, #1;    subs r3, r3, #1;    subs r3, r3, #1;    subs r3, r3, #1;    subs r3, r3, #1;    subs r3, r3, #1;    bpl 1b
@ 0 "" 2
.LVL4:
	.arm
	.syntax unified
...
.LFE1:
	.fnend
	.size	ps_udelay, .-ps_udelay
	.align	2
	.global	ps_cpufreq_hint
	.syntax unified
	.arm
	.type	ps_cpufreq_hint, %function
ps_cpufreq_hint:
	.fnstart
.LFB2:
	.loc 1 75 0
...
.LFE2:
	.fnend
	.size	ps_cpufreq_hint, .-ps_cpufreq_hint
	.data
	.align	2
	.set	.LANCHOR0,. + 0
	.type	cpufreq_hint, %object
	.size	cpufreq_hint, 4
cpufreq_hint:
	.word	792000000
...
.LC0:
	...
	.ascii	"rt/src/arch/arm/delay.c\000"
	.space	1
.LC1:
	.ascii	"%s:%d - Unable to determine CPU frequency for delay"
	.ascii	" loop\012\000"
	.text
.Letext0:
...
.Ldebug_macro0:
	...
	.uleb128 0xb
	.4byte	.LASF380
	.file 4 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/delay.h"
	.byte	0x3
	.uleb128 0xb
	.uleb128 0x4
	.byte	0x7
...
.LASF516:
	.ascii	"CYCLES_PER_US (cpufreq_hint / 1000000)\000"
.LASF67:
...
.LASF515:
	.ascii	"DEFAULT_CPUFREQ 792000000UL\000"
.LASF369:
	.ascii	"__ELF__ 1\000"
.LASF349:
