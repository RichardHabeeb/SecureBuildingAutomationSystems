...
.Ltext0:
	...
	.syntax unified
	.arm
	.type	gpt_timer_start, %function
gpt_timer_start:
	.fnstart
.LFB28:
	.file 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/mach/imx/gpt.c"
	.loc 1 153 0
	.cfi_startproc
...
.LFE28:
	.fnend
	.size	gpt_timer_start, .-gpt_timer_start
	.align	2
	.syntax unified
	.arm
	.type	gpt_timer_stop, %function
gpt_timer_stop:
	.fnstart
.LFB29:
	.loc 1 165 0
...
.LFE29:
	.fnend
	.size	gpt_timer_stop, .-gpt_timer_stop
	.align	2
	.syntax unified
	.arm
	.type	gpt_oneshot_relative, %function
gpt_oneshot_relative:
	.fnstart
.LFB32:
	.loc 1 188 0
	.cfi_startproc
...
.LFE32:
	.fnend
	.size	gpt_oneshot_relative, .-gpt_oneshot_relative
	.align	2
	.syntax unified
	.arm
	.type	gpt_handle_irq, %function
gpt_handle_irq:
	.fnstart
.LFB33:
	.loc 1 194 0
...
.LFE33:
	.fnend
	.size	gpt_handle_irq, .-gpt_handle_irq
	.global	__aeabi_uldivmod
	.align	2
	.syntax unified
	.arm
	.type	gpt_get_time, %function
gpt_get_time:
	.fnstart
.LFB34:
	.loc 1 203 0
...
.LFE34:
	.fnend
	.size	gpt_get_time, .-gpt_get_time
	.align	2
	.syntax unified
	.arm
	.type	gpt_get_nth_irq, %function
gpt_get_nth_irq:
	.fnstart
.LFB35:
	.loc 1 214 0
...
.LFE35:
	.fnend
	.size	gpt_get_nth_irq, .-gpt_get_nth_irq
	.align	2
	.syntax unified
	.arm
	.type	gpt_periodic, %function
gpt_periodic:
	.fnstart
.LFB38:
	.cfi_startproc
...
.LFE38:
	.fnend
	.size	gpt_periodic, .-gpt_periodic
	.align	2
	.syntax unified
	.arm
	.type	gpt_oneshot_absolute, %function
gpt_oneshot_absolute:
	.fnstart
.LFB40:
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 0
...
.LFE40:
	.fnend
	.size	gpt_oneshot_absolute, .-gpt_oneshot_absolute
	.align	2
	.global	gpt_get_timer
	.syntax unified
	.arm
	.type	gpt_get_timer, %function
gpt_get_timer:
	.fnstart
.LFB36:
	.loc 1 223 0
...
.LVL18:
	...
	mov	r5, #32
	.loc 1 236 0
	movw	lr, #:lower16:gpt_timer_start
	.loc 1 237 0
	movw	ip, #:lower16:gpt_timer_stop
	.loc 1 227 0
	ldrb	r2, [r3]	@ zero_extendqisi2
	.loc 1 236 0
	movt	lr, #:upper16:gpt_timer_start
	.loc 1 238 0
	movw	r1, #:lower16:gpt_get_time
	.loc 1 236 0
	str	lr, [r3, #8]
	.loc 1 237 0
	movt	ip, #:upper16:gpt_timer_stop
	.loc 1 238 0
	movt	r1, #:upper16:gpt_get_time
	.loc 1 231 0
	orr	r2, r2, #1
	.loc 1 239 0
	movw	r4, #:lower16:gpt_oneshot_absolute
	.loc 1 231 0
	bfc	r2, #1, #1
	.loc 1 240 0
	movw	lr, #:lower16:gpt_oneshot_relative
	.loc 1 231 0
	strb	r2, [r3]
	.loc 1 239 0
	movt	r4, #:upper16:gpt_oneshot_absolute
	.loc 1 232 0
	ldrh	r2, [r3]
	.loc 1 240 0
	movt	lr, #:upper16:gpt_oneshot_relative
	.loc 1 237 0
	str	ip, [r3, #12]
	.loc 1 233 0
	mov	r7, #1
	.loc 1 241 0
	movw	ip, #:lower16:gpt_periodic
	.loc 1 232 0
	bfi	r2, r5, #2, #7
	.loc 1 241 0
	movt	ip, #:upper16:gpt_periodic
	.loc 1 232 0
	strh	r2, [r3]	@ movhi
	.loc 1 246 0
	ldm	r0, {r2, r6}
	.loc 1 242 0
	movw	r0, #:lower16:gpt_handle_irq
.LVL19:
	.loc 1 238 0
	str	r1, [r3, #16]
	.loc 1 243 0
	movw	r1, #:lower16:gpt_get_nth_irq
	.loc 1 239 0
	str	r4, [r3, #20]
	.loc 1 242 0
	movt	r0, #:upper16:gpt_handle_irq
	.loc 1 240 0
	str	lr, [r3, #24]
	.loc 1 243 0
	movt	r1, #:upper16:gpt_get_nth_irq
	.loc 1 233 0
	str	r7, [r3, #4]
	.loc 1 249 0
	mov	r4, #0
...
.LFE36:
	.fnend
	.size	gpt_get_timer, .-gpt_get_timer
	.bss
	.align	2
	.set	.LANCHOR0,. + 0
...
singleton_timer:
	.space	44
	.type	singleton_gpt, %object
	.size	singleton_gpt, 16
singleton_gpt:
	.space	16
	.text
.Letext0:
	...
	.file 4 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/mach/gpt.h"
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0x4
	.file 38 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/plat/timer.h"
	.byte	0x3
	.uleb128 0x14
	.uleb128 0x26
	.byte	0x7
...
.LASF1023:
	...
	.ascii	"rt/src/mach/imx/gpt.c\000"
.LASF577:
...
.LASF954:
	.ascii	"GPT_STATUS_REGISTER_CLEAR 0x3F\000"
.LASF371:
...
.LASF1025:
	.ascii	"gpt_interrupt_register_bits\000"
.LASF37:
...
.LASF1026:
	.ascii	"gpt_oneshot_relative\000"
.LASF74:
