# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/chardev.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/chardev.c"
# 16 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/chardev.c"
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/../../chardev.h" 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/../../chardev.h"
#define __SRC_CHARDEV_H__ 

# 1 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/chardev.h" 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/chardev.h"
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/chardev.h" 2

struct ps_clk;
typedef struct ps_chardevice ps_chardevice_t;

# 1 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/plat/serial.h" 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/plat/serial.h"
...
# 20 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/chardev.h" 2
...
# 77 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/chardev.h"
...
ps_chardevice_t* ps_cdev_new(const ps_io_ops_t* o,
                             ps_chardevice_t* d);
# 97 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/chardev.h"
static inline void ps_cdev_putchar(ps_chardevice_t* d, int c)
{
    int ret;
    do {
        char data = c;
        ret = d->write(d, &data, 1, ((void*)0), ((void*)0));
    } while (ret < 1);
}
...
static inline int ps_cdev_getchar(ps_chardevice_t* d)
{
    int ret;
    char data;
    ret = d->read(d, &data, 1, ((void*)0), ((void*)0));
    return (ret == 1) ? data : (-1);
}
# 137 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/chardev.h"
...
# 161 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/chardev.h"
...
static inline void ps_cdev_handle_irq(ps_chardevice_t* d, int irq __attribute__((__unused__)))
{
    d->handle_irq(d);
}
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/../../chardev.h" 2
...
# 17 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/chardev.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/../../common.h" 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/../../common.h"
#define __COMMON_H__ 
...
# 17 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/../../common.h" 2
# 18 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/chardev.c" 2


# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/serial.h" 1
# 13 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/serial.h"
int uart_init(const struct dev_defn* defn, const ps_io_ops_t* ops, ps_chardevice_t* dev);
# 21 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/chardev.c" 2

static const int uart1_irqs[] = {58, -1};
static const int uart2_irqs[] = {59, -1};
static const int uart3_irqs[] = {60, -1};
static const int uart4_irqs[] = {61, -1};
static const int uart5_irqs[] = {62, -1};


#define UART_DEFN(devid) { .id = IMX6_UART ##devid, .paddr = UART ##devid ##_PADDR, .size = BIT(12), .irqs = uart ##devid ##_irqs, .init_fn = &uart_init }
# 38 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/chardev.c"
static const struct dev_defn dev_defn[] = {
    { .id = IMX6_UART1, .paddr = 0x02020000, .size = (1ul<<(12)), .irqs = uart1_irqs, .init_fn = &uart_init },
    { .id = IMX6_UART2, .paddr = 0x021E8000, .size = (1ul<<(12)), .irqs = uart2_irqs, .init_fn = &uart_init },
    { .id = IMX6_UART3, .paddr = 0x021EC000, .size = (1ul<<(12)), .irqs = uart3_irqs, .init_fn = &uart_init },
    { .id = IMX6_UART4, .paddr = 0x021F0000, .size = (1ul<<(12)), .irqs = uart4_irqs, .init_fn = &uart_init },
    { .id = IMX6_UART5, .paddr = 0x021F4000, .size = (1ul<<(12)), .irqs = uart5_irqs, .init_fn = &uart_init }
};

struct ps_chardevice*
ps_cdev_init(enum chardev_id id, const ps_io_ops_t* o, struct ps_chardevice* d) {
    unsigned int i;
    for (i = 0; i < (sizeof(dev_defn)/sizeof((dev_defn)[0])); i++) {
        if (dev_defn[i].id == id) {
            return (dev_defn[i].init_fn(dev_defn + i, o, d)) ? ((void*)0) : d;
        }
    }
    return ((void*)0);
}
