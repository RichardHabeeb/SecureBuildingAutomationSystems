# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c"
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c" 2
...
# 13 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c" 2
...
# 14 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c" 2
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c" 2
...
imx6_gpio_get_bank(gpio_t* gpio) {
    ...
    int port;
    ((gpio) ? ((void)0) : (__assert_fail("gpio", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c", 68, __func__)));
    ((gpio->gpio_sys) ? ((void)0) : (__assert_fail("gpio->gpio_sys", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c", 69, __func__)));
    ((gpio->gpio_sys->priv) ? ((void)0) : (__assert_fail("gpio->gpio_sys->priv", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c", 70, __func__)));
    gpio_priv = (struct imx6_gpio*)gpio->gpio_sys->priv;
    port = ((gpio->id) / 32);
    ((port < GPIO_NBANKS) ? ((void)0) : (__assert_fail("port < GPIO_NBANKS", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c", 73, __func__)));
    ((port >= 0) ? ((void)0) : (__assert_fail("port >= 0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c", 74, __func__)));
...
imx6_gpio_init(gpio_sys_t* gpio_sys, int id, enum gpio_dir dir, gpio_t* gpio)
{
    ...
    uint32_t v;
    int pin;
    ((gpio) ? ((void)0) : (__assert_fail("gpio", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c", 85, __func__)));
    ((gpio_sys) ? ((void)0) : (__assert_fail("gpio_sys", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c", 86, __func__)));
    gpio_priv = (struct imx6_gpio*)gpio_sys->priv;
    ((gpio_priv) ? ((void)0) : (__assert_fail("gpio_priv", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c", 88, __func__)));
    pin = ((id) % 32);
    ((pin < 32) ? ((void)0) : (__assert_fail("pin < 32", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c", 90, __func__)));
    ((pin >= 0) ? ((void)0) : (__assert_fail("pin >= 0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c", 91, __func__)));
...
imx6_gpio_write(gpio_t* gpio, const char* data, int len)
{
    ...
    for (count = 0; count < len && gpio; count++) {
        ...
        bank = imx6_gpio_get_bank(gpio);
        pin = ((gpio->id) % 32);
        ((pin < 32) ? ((void)0) : (__assert_fail("pin < 32", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c", 136, __func__)));
        ((pin >= 0) ? ((void)0) : (__assert_fail("pin >= 0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c", 137, __func__)));
        ...
        bank->data = v;
        ((bank->data == v) ? ((void)0) : (__assert_fail("bank->data == v", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c", 150, __func__)));
...
imx6_gpio_read(gpio_t* gpio, char* data, int len)
{
    ...
    for (count = 0; count < len && gpio; count++) {
        ...
        bank = imx6_gpio_get_bank(gpio);
        pin = ((gpio->id) % 32);
        ((pin < 32) ? ((void)0) : (__assert_fail("pin < 32", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c", 168, __func__)));
        ((pin >= 0) ? ((void)0) : (__assert_fail("pin >= 0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/plat/imx6/gpio.c", 169, __func__)));
...
{
    do { if(_gpio.bank[0] == ((void*)0)){ _gpio.bank[0] = ps_io_map(&(io_ops->io_mapper), (uintptr_t) 0x0209C000, 0x1000, 0, PS_MEM_NORMAL); } }while(0);
    do { if(_gpio.bank[1] == ((void*)0)){ _gpio.bank[1] = ps_io_map(&(io_ops->io_mapper), (uintptr_t) 0x020A0000, 0x1000, 0, PS_MEM_NORMAL); } }while(0);
    do { if(_gpio.bank[2] == ((void*)0)){ _gpio.bank[2] = ps_io_map(&(io_ops->io_mapper), (uintptr_t) 0x020A4000, 0x1000, 0, PS_MEM_NORMAL); } }while(0);
    do { if(_gpio.bank[3] == ((void*)0)){ _gpio.bank[3] = ps_io_map(&(io_ops->io_mapper), (uintptr_t) 0x020A8000, 0x1000, 0, PS_MEM_NORMAL); } }while(0);
    do { if(_gpio.bank[4] == ((void*)0)){ _gpio.bank[4] = ps_io_map(&(io_ops->io_mapper), (uintptr_t) 0x020AC000, 0x1000, 0, PS_MEM_NORMAL); } }while(0);
    do { if(_gpio.bank[5] == ((void*)0)){ _gpio.bank[5] = ps_io_map(&(io_ops->io_mapper), (uintptr_t) 0x020B0000, 0x1000, 0, PS_MEM_NORMAL); } }while(0);
    do { if(_gpio.bank[6] == ((void*)0)){ _gpio.bank[6] = ps_io_map(&(io_ops->io_mapper), (uintptr_t) 0x020B4000, 0x1000, 0, PS_MEM_NORMAL); } }while(0);
