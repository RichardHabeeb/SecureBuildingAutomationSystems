# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.c"
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.h" 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.h"
#define ARCH_CLOCK_H 
...
# 16 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.h" 2
...
# 19 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/platsupport/clock.h" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/assert.h" 1
...
# 17 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.h" 2

#define _CLK_OPS(_id,_name,ops,data) .id = _id, .name = _name, .get_freq = _ ##ops ##_get_freq, .set_freq = _ ##ops ##_set_freq, .recal = _ ##ops ##_recal, .init = _ ##ops ##_init, .parent = NULL, .sibling = NULL, .child = NULL, .req_freq = 0, .priv = (void*)data
# 31 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.h"
...
{
    ((clk) ? ((void)0) : (__assert_fail("clk", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.h", 46, __func__)));
    return clk->clk_sys;
}
...
clk_init(clk_t* clk)
{
    ((clk) ? ((void)0) : (__assert_fail("clk", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.h", 53, __func__)));
    ((clk->init) ? ((void)0) : (__assert_fail("clk->init", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.h", 54, __func__)));
    return clk->init(clk);
}
...
clk_recal(clk_t* clk)
{
    ((clk) ? ((void)0) : (__assert_fail("clk", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.h", 61, __func__)));
    ((clk->recal) ? ((void)0) : (__assert_fail("clk->recal", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.h", 62, __func__)));
    clk->recal(clk);
}
# 75 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.h"
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.c" 2
...
# 13 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/assert.h" 1
...
void __assert_fail (const char *, const char *, int, const char *);
# 14 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.c" 2
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.c" 2
...
static freq_t
_fixed_clk_set_freq(clk_t* clk, freq_t hz __attribute__((__unused__)))
{
    return clk_get_freq(clk);
}

void
_fixed_clk_recal(clk_t* clk __attribute__((__unused__)))
{
    ((0) ? ((void)0) : (__assert_fail("0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.c", 32, __func__)));
}
...
{
    ((clk->id >= 0 && clk->id < NCLOCKS) ? ((void)0) : (__assert_fail("clk->id >= 0 && clk->id < NCLOCKS", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.c", 45, __func__)));
    return ps_freq_default[clk->id];
}

freq_t
_default_clk_set_freq(clk_t* clk, freq_t hz __attribute__((__unused__)))
{
    return clk_get_freq(clk);
}

void
_default_clk_recal(clk_t* clk __attribute__((__unused__)))
{
    ((0) ? ((void)0) : (__assert_fail("0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.c", 58, __func__)));
}
...
static clk_t*
get_clock_default(clock_sys_t* clock_sys __attribute__((__unused__)), enum clk_id id)
{
    if (id < 0 || id >= NCLOCKS) {
        return ((void*)0);
    } else {
...
static int
gate_enable_default(clock_sys_t* clock_sys __attribute__((__unused__)), enum clock_gate gate __attribute__((__unused__)), enum clock_gate_mode mode __attribute__((__unused__)))
{
...
ps_get_clock(clock_sys_t* sys, enum clk_id id)
{
    if (id < 0 || id >= NCLOCKS) {
        ...
        clk_t* clk;
        clk = ps_clocks[id];
        ((clk) ? ((void)0) : (__assert_fail("clk", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.c", 121, __func__)));
        ((ps_clocks[id]->init) ? ((void)0) : (__assert_fail("ps_clocks[id]->init", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.c", 122, __func__)));
        clk->clk_sys = sys;
        return clk_init(clk);
    }
}
...
clk_register_child(clk_t* parent, clk_t* child)
{
    ...
    if (child->parent != ((void*)0)) {
        ...
        while (sibling != child) {
            ((sibling) ? ((void)0) : (__assert_fail("sibling", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.c", 175, __func__)));
    ...
    if (child->parent == ((void*)0)) {
        ...
        printf("%s->%s\n | %s already has parent %s",
               ...
               child->parent->name);
        ((!"Changing parents not supported yet") ? ((void)0) : (__assert_fail("!\"Changing parents not supported yet\"", "/home/mint/seL4/dhs-demo-feb-2018/libs/libplatsupport/src/arch/arm/clock.c", 187, __func__)));
    }
}
...
{
    clk_t ret = { .id = id, .name = "Fixed clock", .get_freq = _fixed_clk_get_freq, .set_freq = _fixed_clk_set_freq, .recal = _fixed_clk_recal, .init = _fixed_clk_init, .parent = ((void*)0), .sibling = ((void*)0), .child = ((void*)0), .req_freq = 0, .priv = (void*)((void*)0) };
