# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/proxy/src/proxy.c"
...
# 5 "/home/mint/seL4/dhs-demo-feb-2018/apps/proxy/src/proxy.c" 2
...
char *ctermid(char *);
#define L_ctermid 20
# 6 "/home/mint/seL4/dhs-demo-feb-2018/apps/proxy/src/proxy.c" 2
...
int rand_r (unsigned *);
# 7 "/home/mint/seL4/dhs-demo-feb-2018/apps/proxy/src/proxy.c" 2
...
# 8 "/home/mint/seL4/dhs-demo-feb-2018/apps/proxy/src/proxy.c" 2
...
# 9 "/home/mint/seL4/dhs-demo-feb-2018/apps/proxy/src/proxy.c" 2
...
# 10 "/home/mint/seL4/dhs-demo-feb-2018/apps/proxy/src/proxy.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/semaphore.h" 1
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/semaphore.h" 2
...
#define S_IXOTH 0001
#define S_IRWXO 0007
# 14 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/semaphore.h" 2
...
int sem_wait(sem_t *);
# 11 "/home/mint/seL4/dhs-demo-feb-2018/apps/proxy/src/proxy.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/include/generated/autoconf.h" 1
...
#define CONFIG_LIB_ETHDRIVER_TX_DESC_COUNT 32
#define CONFIG_BUILDSYS_USE_CCACHE 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/apps/proxy/src/proxy.c" 2
...
# 43 "/home/mint/seL4/dhs-demo-feb-2018/apps/proxy/src/rijndael-api-fst.h" 2
...
int padDecrypt(cipherInstance *cipher, keyInstance *key,
  BYTE *input, int inputOctets, BYTE *outBuffer);
# 14 "/home/mint/seL4/dhs-demo-feb-2018/apps/proxy/src/proxy.c" 2




#define IP4_ADDR(a,b,c,d) ((unsigned int)((d) & 0xff) << 24) | ((unsigned int)((c) & 0xff) << 16) | ((unsigned int)((b) & 0xff) << 8) | (unsigned int)((a) & 0xff)
...
static uint64_t thread_stacks[16][512];

static proxy_config_t *config = (proxy_config_t*)0x70000000;

keyInstance key_e[16];
keyInstance key_d[16];
cipherInstance cipher_e[16];
cipherInstance cipher_d[16];
# 77 "/home/mint/seL4/dhs-demo-feb-2018/apps/proxy/src/proxy.c"
...
static uint32_t recv_packet(seL4_Word port, char * data, uint32_t max_len) {
    ...
    tag = seL4_Call((2), tag);
    len = (((max_len)<(seL4_MessageInfo_get_length(tag)))?(max_len):(seL4_MessageInfo_get_length(tag)));
...
void worker_thread(void) {
    static char recieved_data[(1 << 12)];
    uint32_t len;
    uint32_t id;
    seL4_Word port;
    ...
    id = (((seL4_Word)seL4_GetIPCBuffer() - 0xa0000000) >> 12) - 1;
    ...
    while(1) {
        ...
        switch(seL4_GetMR(0)) {
            case SendPacket:
                len = (((sizeof(recieved_data))<(seL4_MessageInfo_get_length(tag)))?(sizeof(recieved_data)):(seL4_MessageInfo_get_length(tag)));
...
int main(void) {
    ...
    for(int i = 0; i < config->num_clients; i++) {
        if(config->enable_encryption) {
            ...
            err = makeKey(&key_e[i], 0, 256, config->clients[i].psk);
            if(err < 0) {
                printf("makeKey e error: %i\n", err);
            }

            err = makeKey(&key_d[i], 1, 256, config->clients[i].psk);
            if(err < 0) {
                printf("makeKey d error: %i\n", err);
            }

            err = cipherInit(&cipher_e[i], 1, config->clients[i].iv);
            if(err < 0) {
                printf("cipherInit e error: %i\n", err);
            }

            err = cipherInit(&cipher_d[i], 1, config->clients[i].iv);
            if(err < 0) {
        ...
        seL4_TCB_WriteRegisters(config->clients[i].tcb_cap, 1, 0, 2, &regs);
        seL4_Yield();
    }
# 229 "/home/mint/seL4/dhs-demo-feb-2018/apps/proxy/src/proxy.c"
    while(1) seL4_Yield();
