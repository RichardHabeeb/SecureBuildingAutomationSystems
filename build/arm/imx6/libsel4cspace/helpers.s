...
.Ltext0:
	...
	.align	2
	.global	cspace_retype_depth
	.syntax unified
	.arm
	.type	cspace_retype_depth, %function
cspace_retype_depth:
	.fnstart
.LFB114:
	.file 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c"
	.loc 1 20 0
	.cfi_startproc
...
.LFE114:
	.fnend
	.size	cspace_retype_depth, .-cspace_retype_depth
	.align	2
	.global	cspace_alloc_level1_index
	.syntax unified
	.arm
	.type	cspace_alloc_level1_index, %function
cspace_alloc_level1_index:
	.fnstart
.LFB115:
	.loc 1 34 0
	.cfi_startproc
...
.LFE115:
	.fnend
	.size	cspace_alloc_level1_index, .-cspace_alloc_level1_index
	.align	2
	.global	cspace_free_level1_index
	.syntax unified
	.arm
	.type	cspace_free_level1_index, %function
cspace_free_level1_index:
	.fnstart
.LFB116:
	.loc 1 46 0
	.cfi_startproc
...
.LFE116:
	.fnend
	.size	cspace_free_level1_index, .-cspace_free_level1_index
	.align	2
	.global	cspace_alloc_level2_slot
	.syntax unified
	.arm
	.type	cspace_alloc_level2_slot, %function
cspace_alloc_level2_slot:
	.fnstart
.LFB117:
	.loc 1 54 0
	.cfi_startproc
...
.LBE74:
	.loc 1 66 0
	movw	r3, #:lower16:cspace_ut_alloc
	mov	r0, #14
	movt	r3, #:upper16:cspace_ut_alloc
	ldr	r3, [r3]
	blx	r3
.LVL21:
	.loc 1 67 0
...
.LVL34:
	...
	movw	r3, #:lower16:.LC0
	.loc 1 90 0
	movw	fp, #:lower16:cspace_malloc
	.loc 1 94 0
	movt	r3, #:upper16:.LC0
	.loc 1 90 0
	movt	fp, #:upper16:cspace_malloc
	.loc 1 94 0
	str	r3, [sp, #4]
	.loc 1 84 0
	mov	r4, r8
...
.LFE117:
	.fnend
	.size	cspace_alloc_level2_slot, .-cspace_alloc_level2_slot
	.align	2
	.global	cspace_free_level2_slot
	.syntax unified
	.arm
	.type	cspace_free_level2_slot, %function
cspace_free_level2_slot:
	.fnstart
.LFB118:
	.loc 1 117 0
	.cfi_startproc
...
.LC0:
	...
	.ascii	"e/src/helpers.c\000"
	.space	1
.LC1:
	.ascii	"0\000"
	.space	2
.LC2:
	.ascii	"s != CSPACE_NOSLOT\000"
	.space	1
.LC3:
	.ascii	"s >= 0 && s < CSPACE_NODE_SIZE_IN_SLOTS\000"
.LC4:
	.ascii	"l1 != CSPACE_NOSLOT\000"
.LC5:
	.ascii	"v != 0\000"
	.space	1
.LC6:
	.ascii	"cerr == CSPACE_NOERROR\000"
	.space	1
.LC7:
	.ascii	"serr == seL4_NoError\000"
	.space	3
.LC8:
	.ascii	"c->level2_alloc_tables[i]\000"
	.space	2
.LC9:
	.ascii	"s >= 0 && s < (CSPACE_NODE_SIZE_IN_SLOTS * CSPACE_N"
	.ascii	"ODE_SIZE_IN_SLOTS)\000"
	.text
.Letext0:
	...
	.file 11 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
	.file 12 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/sel4/objecttype.h"
	...
	.file 15 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.h"
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0x4
	.file 28 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/stdlib.h"
	.byte	0x3
	.uleb128 0x29
	.uleb128 0x1c
	.byte	0x7
	...
	.uleb128 0xc
	.4byte	.LASF612
	.file 29 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/sel4/sel4.h"
	.byte	0x3
	.uleb128 0xd
	.uleb128 0x1d
	.byte	0x5
	...
	.uleb128 0x9
	.4byte	.LASF618
	.file 30 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/sel4/arch/invocation.h"
	.byte	0x3
	.uleb128 0x2c
	.uleb128 0x1e
	.byte	0x5
	...
	.4byte	.LASF621
	.byte	0x4
	.file 31 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/sel4/bootinfo.h"
	.byte	0x3
	.uleb128 0x15
	.uleb128 0x1f
	.byte	0x7
	...
	.byte	0x4
	.file 32 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/stdio.h"
	.byte	0x3
	.uleb128 0xf
	.uleb128 0x20
	.byte	0x7
