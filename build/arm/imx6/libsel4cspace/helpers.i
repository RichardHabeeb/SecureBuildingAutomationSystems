# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c"
...
extern seL4_Error cspace_ut_retype_addr(seL4_Word address,
                                        ...
                                        cspace_t *dest,
                                        seL4_CPtr *dest_cap);
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c" 2
...
# 13 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c" 2
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c" 2
...
char *ctermid(char *);
#define L_ctermid 20
# 16 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c" 2
...
int cspace_retype_depth(cspace_t *c)
{
 ...
 ((0) ? ((void)0) : (__assert_fail("0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c", 28, __func__)));
 return 0;
    }
}
...
int32_t cspace_alloc_level1_index(cspace_t *c)
{
    ...
    ((s != (-1)) ? ((void)0) : (__assert_fail("s != CSPACE_NOSLOT", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c", 37, __func__)));
...
cspace_err_t cspace_free_level1_index(cspace_t *c, int32_t s)
{
    ((s >= 0 && s < (1 << (14 - 4))) ? ((void)0) : (__assert_fail("s >= 0 && s < CSPACE_NODE_SIZE_IN_SLOTS", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c", 47, __func__)));
...
seL4_CPtr cspace_alloc_level2_slot(cspace_t *c)
{
    ...
    if (c->num_free_slots <= 0) {
        ...
        ((l1 != (-1)) ? ((void)0) : (__assert_fail("l1 != CSPACE_NOSLOT", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c", 64, __func__)));

        v = cspace_ut_alloc(14);
        ((v != 0) ? ((void)0) : (__assert_fail("v != 0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c", 67, __func__)));
        cerr = cspace_ut_translate(v, &ut_cptr, &offset);
        ((cerr == CSPACE_NOERROR) ? ((void)0) : (__assert_fail("cerr == CSPACE_NOERROR", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c", 69, __func__)));
        c->level1_alloc_table[l1] = v;
        ...
        serr = seL4_Untyped_RetypeAtOffset(ut_cptr,
                                           ...
                                           l1,
                                           1);
        ((serr == seL4_NoError) ? ((void)0) : (__assert_fail("serr == seL4_NoError", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c", 82, __func__)));

        for (j = (l1 << (14 - 4)), i = j >> (14 - 4);
             j < ((l1 +1) << (14 - 4))-1;
             j++) {
            if ((j & ((1 << (14 - 4)) -1)) == 0) {
                i = j >> (14 - 4);
                ...
                ((c->level2_alloc_tables[i]) ? ((void)0) : (__assert_fail("c->level2_alloc_tables[i]", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c", 94, __func__)));
            }
            c->level2_alloc_tables[i][j & ((1 << (14 - 4)) -1)] = j+1;

        }
        c->level2_alloc_tables[i][j & ((1 << (14 - 4)) -1)] = 0;

        c->num_free_slots = (1 << (14 - 4));
        c->next_level2_free_slot = l1 << (14 - 4);
    ...
    c->next_level2_free_slot = c->level2_alloc_tables[s>>(14 - 4)]
 [s & ((1 << (14 - 4)) -1)];
    c->num_free_slots--;
    return s;
}
...
cspace_err_t cspace_free_level2_slot(cspace_t *c, seL4_CPtr s)
{
    ((s >= 0 && s < ((1 << (14 - 4)) * (1 << (14 - 4)))) ? ((void)0) : (__assert_fail("s >= 0 && s < (CSPACE_NODE_SIZE_IN_SLOTS * CSPACE_NODE_SIZE_IN_SLOTS)", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.c", 118, __func__)));
    c->level2_alloc_tables[s>>(14 - 4)]
 [s & ((1 << (14 - 4)) -1)] = c->next_level2_free_slot;
