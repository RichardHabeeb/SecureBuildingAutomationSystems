# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c"
# 1 "/home/mint/seL4/dhs-demo-feb-2018/build/arm/imx6/libsel4cspace//"
# 1 "<built-in>"
#define __STDC__ 1
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c"
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h" 1
# 38 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
...
# 40 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h" 2
...
# 41 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h" 2
...
int rand_r (unsigned *);
# 42 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h" 2
...
# 67 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
typedef struct {
    uint32_t levels;
    seL4_CPtr root_cnode;
    seL4_CapData_t guard;
    seL4_Word addr;
    int32_t next_level1_free_index;
    int32_t next_level2_free_slot;
    uint32_t num_free_slots;
    uint32_t level1_alloc_table[(1 << (14 - 4))];





    uint32_t *level2_alloc_tables[(1 << (14 - 4))];
...
# 133 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
typedef seL4_Word (*cspace_ut_alloc_t)(int size_in_bits);
# 146 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
typedef void (*cspace_ut_free_t)(seL4_Word address, int size_in_bits);
# 166 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
typedef int (*cspace_ut_translate_t)(seL4_Word address, seL4_CPtr *ut_cptr, seL4_Word *offset);
# 179 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
...
# 223 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
extern cspace_err_t cspace_root_task_bootstrap(cspace_ut_alloc_t ut_alloc,
                                               ...
                                               cspace_free_t free);
# 245 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
extern cspace_t * cspace_create(int levels);
# 264 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
extern cspace_err_t cspace_destroy(cspace_t *c);
# 281 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
extern seL4_CPtr cspace_alloc_slot(cspace_t *c);
# 301 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
extern cspace_err_t cspace_free_slot(cspace_t *c, seL4_CPtr slot);
# 320 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
extern seL4_CPtr cspace_copy_cap(cspace_t *dest,
                                 cspace_t *src,
                                 seL4_CPtr src_cap,
                                 seL4_CapRights rights);
# 335 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
extern cspace_err_t cspace_delete_cap(cspace_t *c,
                                      seL4_CPtr cap);
# 357 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
extern seL4_CPtr cspace_mint_cap(cspace_t *dest,
                                 cspace_t *src,
                                 seL4_CPtr src_cap,
                                 seL4_CapRights rights,
                                 seL4_CapData_t badge);
# 376 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
extern seL4_CPtr cspace_move_cap(cspace_t *dest,
                                 cspace_t *src,
                                 seL4_CPtr src_cap);
# 394 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
extern seL4_CPtr cspace_mutate_cap(cspace_t *dest,
                                   cspace_t *src,
                                   seL4_CPtr src_cap,
                                   seL4_CapData_t badge);
# 409 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
extern cspace_err_t cspace_recycle_cap(cspace_t *c,
                                       seL4_CPtr cap);
# 427 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
extern cspace_err_t cspace_revoke_cap(cspace_t *c,
                                       seL4_CPtr cap);
# 442 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
extern seL4_CPtr cspace_rotate_cap(cspace_t *dest,
                                   ...
                                   cspace_t *src,
                                   seL4_CPtr src_cap);
# 465 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
extern seL4_CPtr cspace_save_reply_cap(cspace_t *dest);
# 482 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
extern seL4_CPtr cspace_irq_control_get_cap(cspace_t *dest,
                                            seL4_IRQControl irq_cap,
                                            int irq);
# 511 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/cspace/cspace.h"
extern seL4_Error cspace_ut_retype_addr(seL4_Word address,
                                        seL4_Word type,
                                        seL4_Word size_bits,
                                        cspace_t *dest,
                                        seL4_CPtr *dest_cap);
# 13 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.h" 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.h"
...
# 14 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/helpers.h" 2
...
# 14 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c" 2
...
char *ctermid(char *);
#define L_ctermid 20
# 17 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c" 2
...
# 22 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/sel4_debug.h" 1
# 21 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/sel4_debug.h"
#undef sel4_error
...
# 23 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c" 2

cspace_t *cur_cspace = ((void*)0);
                                        ...
                                        cspace_free_t mfree_func)
{
    ...
    seL4_CPtr i;
    cspace_t *space;
    ((bi) ? ((void)0) : (__assert_fail("bi", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 52, __func__)));
    ...
    (((bi->empty.end - bi->empty.start) >= 2) ? ((void)0) : (__assert_fail("(bi->empty.end - bi->empty.start) >= 2", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 62, __func__)));
    level1_cptr = bi->empty.start;
    boot_cptr = 0;
# 73 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c"
    space = cspace_malloc(sizeof(cspace_t));
    ((space) ? ((void)0) : (__assert_fail("space", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 74, __func__)));

    space->levels = 2;


    for (i = 0; i < ((1 << (14 - 4))-1) ; i++) {
        space->level1_alloc_table[i] = i+1;
    }


    space->level1_alloc_table[(1 << (14 - 4))-1] = (-1);


    addr = cspace_ut_alloc(14);
    ((addr != 0) ? ((void)0) : (__assert_fail("addr != 0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 88, __func__)));
    err = cspace_ut_translate(addr, &ut_cptr, &offset);
    ((err == CSPACE_NOERROR) ? ((void)0) : (__assert_fail("err == CSPACE_NOERROR", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 90, __func__)));
    ...
    err = seL4_Untyped_RetypeAtOffset(ut_cptr,
                                      ...
                                      level1_cptr,
                                      1);
    ((err == seL4_NoError) ? (void)0 : __sel4_error(err, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 103, "Allocating new root cnode"));
    ...
    for (i = 0;
         i <= ((bi->empty.start -1) >> (14 - 4));
         i++) {

        addr = cspace_ut_alloc(14);
        ((addr != 0) ? ((void)0) : (__assert_fail("addr != 0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 115, __func__)));
        err = cspace_ut_translate(addr, &ut_cptr, &offset);
        ((err == CSPACE_NOERROR) ? ((void)0) : (__assert_fail("err == CSPACE_NOERROR", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 117, __func__)));





        space->level1_alloc_table[i] = addr;
        ...
        err = seL4_Untyped_RetypeAtOffset(ut_cptr,
                                          ...
                                          i,
                                          1);
        ((err == seL4_NoError) ? (void)0 : __sel4_error(err, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 137, "Allocating new level 2 cnodes"));
...
# 164 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c"
    err = seL4_CNode_Copy(level1_cptr,
                          ...
                          32,
                          seL4_AllRights);
    ((err == seL4_NoError) ? (void)0 : __sel4_error(err, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 171, "Making copy of root task's initial cnode cap"));
    ...
    err = seL4_CNode_Mint(level1_cptr,
                          ...
                          32,
                          seL4_AllRights,
                          seL4_CapData_Guard_new(0, (32 - 2 * (14 - 4))));
    ((err == seL4_NoError) ? (void)0 : __sel4_error(err, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 182, "Making new cap to new cspace"));

    space->guard = seL4_CapData_Guard_new(0, (32 - 2 * (14 - 4)));
    ...
    ((err == seL4_NoError) ? (void)0 : __sel4_error(err, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 195, "Replacing intial cnode with new cspace"));
# 204 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c"
    for (i = 1; i < bi->empty.start; i++) {
        ...
        err = seL4_CNode_Move(seL4_CapInitThreadCNode,
                        ...
                        i,
                        32);
        ((err == seL4_NoError) ? (void)0 : __sel4_error(err, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 225, "Copying initial cnode caps to new cspace"));
    }
    ...
    err = seL4_CNode_Delete(seL4_CapInitThreadCNode,
                            boot_cptr,
                            32);
    ((err == seL4_NoError) ? (void)0 : __sel4_error(err, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 235, "Deleting root task's original cnode cap"));
# 251 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c"
    for (j = 0; j < bi->empty.start; j++) {
        if ((j & ((1 << (14 - 4)) -1)) == 0) {
            i = j >> (14 - 4);
            space->level2_alloc_tables[i] = cspace_malloc(sizeof(uint32_t)*(1 << (14 - 4)));



            ((space->level2_alloc_tables[i]) ? ((void)0) : (__assert_fail("space->level2_alloc_tables[i]", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 258, __func__)));
        }
        space->level2_alloc_tables[i][j & ((1 << (14 - 4)) -1)] = 0;
    ...
    for (;
         (j & ((1 << (14 - 4)) -1)) < ((1 << (14 - 4)) -1);
         j++) {
        space->level2_alloc_tables[i][j & ((1 << (14 - 4)) -1)] = j + 1 ;
    }
    ...
    for (i = space->next_level1_free_index;
         i < (1 << (14 - 4));
         i++) {
        space->level2_alloc_tables[i] = ((void*)0);
    }
...
cspace_t *cspace_create(int levels)
{
    ...
    ((c != ((void*)0)) ? ((void)0) : (__assert_fail("c != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 310, __func__)));

    addr = cspace_ut_alloc(14);
    ((addr != 0) ? ((void)0) : (__assert_fail("addr != 0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 313, __func__)));
    c->addr = addr;
    err = cspace_ut_translate(addr, &ut_cptr, &offset);
    ((err == CSPACE_NOERROR) ? ((void)0) : (__assert_fail("err == CSPACE_NOERROR", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 316, __func__)));

    slot = cspace_alloc_slot(cur_cspace);
    ((slot != 0) ? ((void)0) : (__assert_fail("slot != CSPACE_NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 319, __func__)));
    ...
    r = seL4_Untyped_RetypeAtOffset(ut_cptr,
                                    ...
                                    slot >> (14 - 4),
                                    cspace_retype_depth(cur_cspace),
                                    (slot & ((1 << (14 - 4)) -1)),
                                    1);
    ((r == seL4_NoError) ? (void)0 : __sel4_error(r, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 330, "Creating first cnode in new cspace"));
    c->root_cnode = slot;
    ...
    c->level1_alloc_table[(1 << (14 - 4))-1] = (-1);
    switch (levels) {
    case 1:
        c->next_level1_free_index = 1;
        break;
    case 2:
        c->next_level1_free_index = 0;
        break;
    default:
        ((!"unsupported number of levels") ? ((void)0) : (__assert_fail("!\"unsupported number of levels\"", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 347, __func__)));
        break;
    }
    c->levels = levels;

    if (levels == 1) {
        c->num_free_slots = (1 << (14 - 4)) -1;
    }
    else if (levels == 2) {
        seL4_CPtr l1slot;
        uint32_t l1index;
        ...
        addr = cspace_ut_alloc(14);
        ((addr!= 0) ? ((void)0) : (__assert_fail("addr!= 0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 365, __func__)));

        err = cspace_ut_translate(addr, &ut_cptr, &offset);
        ((err == CSPACE_NOERROR) ? ((void)0) : (__assert_fail("err == CSPACE_NOERROR", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 368, __func__)));

        l1index = cspace_alloc_level1_index(c);
        ((l1index != (-1)) ? ((void)0) : (__assert_fail("l1index != CSPACE_NOINDEX", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 371, __func__)));

        l1slot = l1index << (14 - 4);



        c->level1_alloc_table[l1index] = addr;
        ...
        r = seL4_Untyped_RetypeAtOffset(ut_cptr,
                                        ...
                                        l1index,
                                        1);
        ((r == seL4_NoError) ? (void)0 : __sel4_error(r, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 389, "Creating 2-level cnode in new cspace"));


        for (i = 0; i < (1 << (14 - 4)); i++) {
            c->level2_alloc_tables[i] = ((void*)0);
        }


        c->level2_alloc_tables[l1index] =
            cspace_malloc(sizeof(uint32_t)*(1 << (14 - 4)));
        ...
        c->level2_alloc_tables[l1index][(1 << (14 - 4))-1] = 0;
        ...
        ((0) ? ((void)0) : (__assert_fail("0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 413, __func__)));
    }
    ...
    switch (c->levels) {
    case 1:
        c->guard = seL4_CapData_Guard_new(0, (32 - (14 - 4)));
        break;
    case 2:
        c->guard = seL4_CapData_Guard_new(0, (32 - 2 * (14 - 4)));
        break;
    }
    ...
    c->root_cnode = cspace_mint_cap(cur_cspace,
                                    ...
                                    seL4_AllRights,
                                    c->guard);
    ((c->root_cnode != 0) ? ((void)0) : (__assert_fail("c->root_cnode != CSPACE_NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 437, __func__)));
    cspace_delete_cap(cur_cspace,slot);
    return c;
}
...
cspace_err_t cspace_destroy(cspace_t *c)
{
    ...
    ((cur_cspace != c) ? ((void)0) : (__assert_fail("cur_cspace != c", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 450, __func__)));
    ((cur_cspace != ((void*)0)) ? ((void)0) : (__assert_fail("cur_cspace != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 451, __func__)));
# 466 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c"
    if (c->levels == 2) {
        for (i = 0; i < (1 << (14 - 4)); i++) {
            if (c->level2_alloc_tables[i] != ((void*)0)) {

                serr = seL4_CNode_Delete(c->root_cnode,
                                         i,
                                         32 - (14 - 4));
                ((serr == seL4_NoError) ? (void)0 : __sel4_error(serr, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 473, "Deleting level-2 cnodes"));
                cspace_ut_free(c->level1_alloc_table[i], 14);
                cspace_free(c->level2_alloc_tables[i]);
            }
        }
    }

    cspace_delete_cap(cur_cspace, c->root_cnode);
    cspace_ut_free(c->addr,14);
...
{
# 505 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c"
    seL4_CPtr r;
    ((c != ((void*)0)) ? ((void)0) : (__assert_fail("c != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 506, __func__)));

    switch(c->levels) {
    case 1:
# 519 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c"
        if (c->num_free_slots > 0) {
            c->num_free_slots--;
            r = cspace_alloc_level1_index(c);
            if (r == (-1)){
                return 0;
            }
            return r;
    ...
    default:
        ((0) ? ((void)0) : (__assert_fail("0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 540, __func__)));
        break;
    }
    return 0;
...
cspace_err_t cspace_free_slot(cspace_t *c, seL4_CPtr slot)
{
    ((c != ((void*)0)) ? ((void)0) : (__assert_fail("c != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 548, __func__)));
    ((slot != 0) ? ((void)0) : (__assert_fail("slot != CSPACE_NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 549, __func__)));
# 558 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c"
    switch(c->levels) {
    case 1:
        c->num_free_slots++;
        return cspace_free_level1_index(c,slot);
        break;
    case 2:
        return cspace_free_level2_slot(c,slot);
        break;
    default:
        ((0) ? ((void)0) : (__assert_fail("0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 567, __func__)));
    }
    return CSPACE_NOERROR;
}
                                 ...
                                 seL4_CPtr *p)
{
    ...
    ((p != ((void*)0)) ? ((void)0) : (__assert_fail("p != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 588, __func__)));
    *p = new;
    ...
    err = seL4_Untyped_RetypeAtOffset(ut_cptr,
                                      ...
                                      new & ((1 << (14 - 4)) -1),
                                      1);
# 618 "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c"
    return err;
}
                          ...
                          seL4_CapRights rights)
{
    ...
    ((dest != ((void*)0) && src != ((void*)0)) ? ((void)0) : (__assert_fail("dest != NULL && src != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 629, __func__)));

    slot = cspace_alloc_slot(dest);
    ((slot != 0) ? ((void)0) : (__assert_fail("slot != CSPACE_NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 632, __func__)));
    ...
    err = seL4_CNode_Copy(dest->root_cnode,
                          ...
                          32,
                          rights);
    ((err == seL4_NoError) ? (void)0 : __sel4_error(err, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 641, "Copying cap"));
...
{
    seL4_Error err;
    ((c != ((void*)0)) ? ((void)0) : (__assert_fail("c != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 649, __func__)));

    err = seL4_CNode_Delete(c->root_cnode,
                            cap,
                            32);
    ((err == seL4_NoError) ? (void)0 : __sel4_error(err, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 654, "Copying cap"));
                          ...
                          seL4_CapData_t badge)
{
    ...
    ((dest != ((void*)0) && src != ((void*)0)) ? ((void)0) : (__assert_fail("dest != NULL && src != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 668, __func__)));

    slot = cspace_alloc_slot(dest);
    ((slot != 0) ? ((void)0) : (__assert_fail("slot != CSPACE_NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 671, __func__)));
    ...
    err = seL4_CNode_Mint(dest->root_cnode,
                          ...
                          rights,
                          badge);
    ((err == seL4_NoError) ? (void)0 : __sel4_error(err, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 681, "Minting a cap"));
...
seL4_CPtr cspace_move_cap(cspace_t *dest, cspace_t *src, seL4_CPtr src_cap)
{
    seL4_CPtr slot;
    seL4_Error err;
    ((dest != ((void*)0) && src != ((void*)0)) ? ((void)0) : (__assert_fail("dest != NULL && src != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 690, __func__)));

    slot = cspace_alloc_slot(dest);
    ((slot != 0) ? ((void)0) : (__assert_fail("slot != CSPACE_NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 693, __func__)));
    ...
    err = seL4_CNode_Move(dest->root_cnode,
                          ...
                          src_cap,
                          32);
    ((err == seL4_NoError) ? (void)0 : __sel4_error(err, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 701, "Moving cap"));
                            ...
                            seL4_CapData_t badge)
{
    seL4_CPtr slot;
    seL4_Error err;
    ((dest != ((void*)0) && src != ((void*)0)) ? ((void)0) : (__assert_fail("dest != NULL && src != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 713, __func__)));

    slot = cspace_alloc_slot(dest);
    ((slot != 0) ? ((void)0) : (__assert_fail("slot != CSPACE_NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 716, __func__)));
    ...
    err = seL4_CNode_Mutate(dest->root_cnode,
                            ...
                            32,
                            badge);
    ((err == seL4_NoError) ? (void)0 : __sel4_error(err, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 725, "Mutating cap"));
...
{
    seL4_Error err;
    ((c != ((void*)0)) ? ((void)0) : (__assert_fail("c != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 734, __func__)));

    err = seL4_CNode_Recycle(c->root_cnode,
                             cap,
                             32);
    ((err == seL4_NoError) ? (void)0 : __sel4_error(err, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 739, "Recycling cap"));
...
{
    seL4_Error err;
    ((c != ((void*)0)) ? ((void)0) : (__assert_fail("c != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 749, __func__)));

    err = seL4_CNode_Revoke(c->root_cnode,
                            cap,
                            32);
    ((err == seL4_NoError) ? (void)0 : __sel4_error(err, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 754, "Revoking cap"));
...
seL4_CPtr cspace_rotate_cap(cspace_t *dest,
                            ...
                            seL4_CPtr src_cap)
{
    ((!"This is not implemented. Why do you want to use it?") ? ((void)0) : (__assert_fail("!\"This is not implemented. Why do you want to use it?\"", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 767, __func__)));
    return 0;
}
...
seL4_CPtr cspace_save_reply_cap(cspace_t *c)
{
    ...
    ((slot != 0) ? ((void)0) : (__assert_fail("slot != CSPACE_NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 778, __func__)));

    err = seL4_CNode_SaveCaller(c->root_cnode,
                                slot,
                                32);
    ((err == seL4_NoError) ? (void)0 : __sel4_error(err, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 783, "Saving reply cap"));
                                     ...
                                     int irq)
{
    ...
    seL4_Error err;
    slot = cspace_alloc_slot(dest);
    ((slot != 0) ? ((void)0) : (__assert_fail("slot != CSPACE_NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", 794, __func__)));

    err = seL4_IRQControl_Get(irq_cap,irq,
                              dest->root_cnode,
                              slot,
                              32);
    ((err == seL4_NoError) ? (void)0 : __sel4_error(err, "/home/mint/seL4/dhs-demo-feb-2018/libs/libsel4cspace/src/cspace.c", __func__, 800, "Getting an IRQ control cap"));
