# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/lwip.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/lwip.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/lwip.c"
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/lwip.c" 2



# 1 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/lwip.h" 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/lwip.h"
...
#define CONFIG_LIB_ETHDRIVER_TX_DESC_COUNT 32
#define CONFIG_BUILDSYS_USE_CCACHE 1
# 15 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/lwip.h" 2
...
# 19 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/lwip.h" 2
...
# 20 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/lwip.h" 2
...
# 21 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/lwip.h" 2
...
# 36 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/netif.h" 2
...
# 40 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/netif.h" 2
...
# 45 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/netif.h" 2
...
# 22 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/lwip.h" 2
...
# 65 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/lwip.h"
...
# 16 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/lwip.c" 2
...
# 18 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/lwip.c" 2
...
# 45 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/netif/etharp.h"
...
# 46 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/netif/etharp.h" 2
...
# 20 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/lwip.c" 2
...
# 45 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/mem.h"
...
# 21 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/lwip.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/debug.h" 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/debug.h"
#define __DEBUG_H__ 
# 28 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/debug.h"
#define MAP_DEBUG(x) do{;}while(0)
# 39 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/debug.h"
...
# 22 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/lwip.c" 2

static void initialize_free_bufs(lwip_iface_t *iface) {
    dma_addr_t *dma_bufs = ((void*)0);
    dma_bufs = malloc(sizeof(dma_addr_t) * 512);
    if (!dma_bufs) {
        goto error;
    }
    memset(dma_bufs, 0, sizeof(dma_addr_t) * 512);
    iface->bufs = malloc(sizeof(dma_addr_t*) * 512);
    if (!iface->bufs) {
        goto error;
    }
    for (int i = 0; i < 512; i++) {
        dma_bufs[i] = dma_alloc_pin(&iface->dma_man, 2048, 1, iface->driver.dma_alignment);
        if (!dma_bufs[i].phys) {
            goto error;
        }
        ps_dma_cache_clean_invalidate(&iface->dma_man, dma_bufs[i].virt, 2048);
        iface->bufs[i] = &dma_bufs[i];
    }
    iface->num_free_bufs = 512;
    return;
error:
    if (iface->bufs) {
        free(iface->bufs);
    ...
    if (dma_bufs) {
        for (int i = 0; i < 512; i++) {
            if (dma_bufs[i].virt) {
                dma_unpin_free(&iface->dma_man, dma_bufs[i].virt, 2048);
            }
        }
        free(dma_bufs);
    }
...
static uintptr_t lwip_allocate_rx_buf(void *iface, size_t buf_size, void **cookie) {
    ...
    if (buf_size > 2048) {
        printf("ERROR:%s:%d: ""Requested RX buffer of size %d which can never be fullfilled by preallocated buffers of size %d""\n", __func__, 62, buf_size, 2048);
        return 0;
    }
    if (lwip_iface->num_free_bufs == 0) {
        if (!lwip_iface->bufs) {
            ...
            if (!lwip_iface->bufs) {
                printf("ERROR:%s:%d: ""Failed lazy initialization of preallocated free buffers""\n", __func__, 69);
                return 0;
            }
        } else {
            return 0;
...
static void lwip_rx_complete(void *iface, unsigned int num_bufs, void **cookies, unsigned int *lens) {
    ...
    while (copied < len) {
        unsigned int next = ({ typeof (q->len - pbuf_done) _a = (q->len - pbuf_done); typeof (lens[buf] - buf_done) _b = (lens[buf] - buf_done); _a < _b ? _a : _b; });
    ...
    case 0x0806U:
        ...
        if (lwip_iface->netif->input(p, lwip_iface->netif) != 0) {
            ;
            pbuf_free(p);
            p = ((void*)0);
        }
...
static uintptr_t lwip_pbuf_allocate_rx_buf(void *iface, size_t buf_size, void **cookie) {
    ...
    new_payload = ({ typeof (new_payload) _n = (new_payload); typeof (lwip_iface->driver.dma_alignment) _b = (lwip_iface->driver.dma_alignment); (_n + (_n % lwip_iface->driver.dma_alignment == 0 ? 0 : (_b - (_n % _b)))); });
...
static void lwip_pbuf_tx_complete(void *iface, void *cookie) {
    ...
    for (; p; p = p->next) {
        ...
        while (loc < end) {
            uintptr_t next = ({ typeof (loc + 1) _n = (loc + 1); typeof (((1ul<<(12)))) _b = (((1ul<<(12)))); (_n + (_n % ((1ul<<(12))) == 0 ? 0 : (_b - (_n % _b)))); });
            if (next > end) {
                next = end;
            }
...
static void lwip_pbuf_rx_complete(void *iface, unsigned int num_bufs, void **cookies, unsigned int *lens) {
    ...
    ((num_bufs > 0) ? ((void)0) : (__assert_fail("num_bufs > 0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/lwip.c", 283, __func__)));
    ...
    case 0x0806U:
        ...
        if (lwip_iface->netif->input(p, lwip_iface->netif) != 0) {
            ;
            printf("INFO :%s:%d: ""failed to input\n""\n", __func__, 317);
            pbuf_free(p);
        }
    break;
...
ethif_pbuf_link_output(struct netif *netif, struct pbuf *p)
{
    ...
    for (q = p; q; q = q->next) {
        uintptr_t base = (((uintptr_t)q->payload) & ~(((1ul<<(12))) - 1));
        uintptr_t top = (((uintptr_t)q->payload + q->len - 1) & ~(((1ul<<(12))) - 1));
        max_frames += ((top - base) / ((1ul<<(12)))) + 1;
    }
    int num_frames = 0;
    ...
    for (q = p; q; q = q->next) {
        ...
        while (loc < end) {
            ...
            ((phys[num_frames]) ? ((void)0) : (__assert_fail("phys[num_frames]", "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/lwip.c", 363, __func__)));
            num_frames++;
            loc = next;
        }
    }
