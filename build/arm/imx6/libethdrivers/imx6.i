# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/imx6.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/imx6.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/imx6.c"
# 1 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/imx6.h" 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/imx6.h"
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/imx6.h" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/raw.h" 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/raw.h"
...
int rand_r (unsigned *);
# 16 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/raw.h" 2
...
# 40 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/raw.h"
typedef int (*ethif_raw_tx)(struct eth_driver *driver, unsigned int num, uintptr_t *phys, unsigned int *len, void *cookie);
# 49 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/raw.h"
typedef void (*ethif_raw_handleIRQ_t)(struct eth_driver *driver, int irq);
# 58 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/raw.h"
...
# 84 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/raw.h"
typedef uintptr_t (*ethif_raw_allocate_rx_buf)(void *cb_cookie, size_t buf_size, void **cookie);
# 98 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/raw.h"
...
# 121 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/raw.h"
...
# 16 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/imx6.h" 2

#define IMX6_INTERRUPT_ENET 150
# 27 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/imx6.h"
int ethif_imx6_init(struct eth_driver *eth_driver, ps_io_ops_t io_ops, void *config);
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/imx6.c" 2

# 1 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/helpers.h" 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/ethdrivers/helpers.h"
...
# 14 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/imx6.c" 2
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/imx6.c" 2
...
# 17 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/imx6.c" 2
...
# 18 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/imx6.c" 2
...
# 19 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/imx6.c" 2
...
# 20 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/imx6.c" 2
...
# 21 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/imx6.c" 2
...
# 22 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/imx6.c" 2
...
#define gpio_init() 
# 23 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/imx6.c" 2
...
#define RXD_EMPTY BIT(15)
#define RXD_OWN0 BIT(14)
#define RXD_WRAP BIT(13)
#define RXD_OWN1 BIT(12)
#define RXD_LAST BIT(11)
#define RXD_MISS BIT( 8)
#define RXD_BROADCAST BIT( 7)
#define RXD_MULTICAST BIT( 6)
#define RXD_BADLEN BIT( 5)
#define RXD_BADALIGN BIT( 4)
#define RXD_CRCERR BIT( 2)
#define RXD_OVERRUN BIT( 1)
#define RXD_TRUNC BIT( 0)

#define RXD_ERROR (RXD_BADLEN | RXD_BADALIGN | RXD_CRCERR | RXD_OVERRUN | RXD_TRUNC)



#define TXD_READY BIT(15)
#define TXD_OWN0 BIT(14)
#define TXD_WRAP BIT(13)
#define TXD_OWN1 BIT(12)
#define TXD_LAST BIT(11)
#define TXD_ADDCRC BIT(10)
#define TXD_ADDBADCRC BIT( 9)
...
static void fill_rx_bufs(struct eth_driver *driver) {
    ...
    while (dev->rx_remain > 0) {
        ...
        uintptr_t phys = driver->i_cb.allocate_rx_buf(driver->cb_cookie, 1536, &cookie);
        if (!phys) {
            break;
        }
        ...
        __sync_synchronize();
        dev->rx_ring[dev->rdt].stat = (1ul<<(15)) | (next_rdt == 0 ? (1ul<<(13)) : 0);
        dev->rdt = next_rdt;
        dev->rx_remain--;
    }
    __sync_synchronize();
...
static void enable_interrupts(struct imx6_eth_data *dev) {
    ...
    ((enet) ? ((void)0) : (__assert_fail("enet", "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/imx6.c", 125, __func__)));
    enet_enable_events(enet, 0);
    enet_clr_events(enet, ~((1UL << 25) | (1UL << 27) | (1UL << 22)));
    enet_enable_events(enet, (1UL << 25) | (1UL << 27) | (1UL << 22));
}
...
static void free_desc_ring(struct imx6_eth_data *dev, ps_dma_man_t *dma_man) {
    ...
    if (dev->rx_cookies) {
        free(dev->rx_cookies);
        dev->rx_cookies = ((void*)0);
    }
    if (dev->tx_cookies) {
        free(dev->tx_cookies);
        dev->tx_cookies = ((void*)0);
    }
    if (dev->tx_lengths) {
        free(dev->tx_lengths);
        dev->tx_lengths = ((void*)0);
    }
}

static int initialize_desc_ring(struct imx6_eth_data *dev, ps_dma_man_t *dma_man) {
    dma_addr_t rx_ring = dma_alloc_pin(dma_man, sizeof(struct descriptor) * dev->rx_size, 0, 32);
    if (!rx_ring.phys) {
        printf("ERROR:%s:%d: ""Failed to allocate rx_ring""\n", __func__, 157);
        return -1;
    }
    dev->rx_ring = rx_ring.virt;
    dev->rx_ring_phys = rx_ring.phys;
    dma_addr_t tx_ring = dma_alloc_pin(dma_man, sizeof(struct descriptor) * dev->tx_size, 0, 32);
    if (!tx_ring.phys) {
        printf("ERROR:%s:%d: ""Failed to allocate tx_ring""\n", __func__, 164);
    ...
    if (!dev->rx_cookies || !dev->tx_cookies || !dev->tx_lengths) {
        ...
        printf("ERROR:%s:%d: ""Failed to malloc""\n", __func__, 183);
        free_desc_ring(dev, dma_man);
        return -1;
    }
...
static void complete_tx(struct eth_driver *driver) {
    ...
    while (dev->tdh != dev->tdt) {
        ...
        for (i = 0; i < dev->tx_lengths[dev->tdh]; i++) {
            if (dev->tx_ring[(i + dev->tdh) % dev->tx_size].stat & (1ul<<(15))) {
...
handle_irq(struct eth_driver *driver, int irq)
{
    ...
    uint32_t e;
    e = enet_clr_events(enet, (1UL << 25) | (1UL << 27) | (1UL << 22));
    if(e & (1UL << 27)){
        complete_tx(driver);
    }
    if(e & (1UL << 25)){
    ...
    if(e & (1UL << 22)){
        ...
        ((0) ? ((void)0) : (__assert_fail("0", "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/imx6.c", 287, __func__)));
        while(1);
    }
}
...
static int raw_tx(struct eth_driver *driver, unsigned int num, uintptr_t *phys, unsigned int *len, void *cookie) {
    ...
    for (i = 0; i < num; i++) {
        ...
        __sync_synchronize();
        dev->tx_ring[ring].stat = (1ul<<(15)) | (ring + 1 == dev->tx_size ? (1ul<<(13)) : 0) | (i + 1 == num ? (1ul<<(10)) | (1ul<<(11)) : 0);
    }
...
int ethif_imx6_init(struct eth_driver *eth_driver, ps_io_ops_t io_ops, void *config) {
    struct ocotp *ocotp = ((void*)0);
    int err;
    struct enet * enet;
    struct imx6_eth_data *eth_data = ((void*)0);
    uint8_t mac[6];

    eth_data = (struct imx6_eth_data*)malloc(sizeof(struct imx6_eth_data));
    if (eth_data == ((void*)0)) {
        printf("ERROR:%s:%d: ""Failed to allocate eth data struct""\n", __func__, 347);
        goto error;
    }
    ...
    eth_driver->dma_alignment = 32;
    eth_driver->i_fn = iface_fns;

    err = initialize_desc_ring(eth_data, &io_ops.dma_manager);
    if (err) {
        printf("ERROR:%s:%d: ""Failed to allocate descriptor rings""\n", __func__, 359);
        goto error;
    }
    ...
    if (!ocotp) {
        printf("ERROR:%s:%d: ""Failed to initialize ocotp""\n", __func__, 366);
        goto error;
    }

    err = setup_iomux_enet(&io_ops);
    if (err) {
        printf("ERROR:%s:%d: ""Failed to setup iomux enet""\n", __func__, 372);
        goto error;
    }
    ...
    enet = enet_init((struct desc_data){.tx_phys = eth_data->tx_ring_phys, .rx_phys = eth_data->rx_ring_phys, .rx_bufsize = 1536}, &io_ops);
    if (!enet) {
        printf("ERROR:%s:%d: ""Failed to initialize RGMII""\n", __func__, 382);

        ((!"enet cannot be cleaned up") ? ((void)0) : (__assert_fail("!\"enet cannot be cleaned up\"", "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/imx6.c", 384, __func__)));
        goto error;
    }
    eth_data->enet = enet;


    if (ocotp == ((void*)0) || ocotp_get_mac(ocotp, mac)) {
        memcpy(mac, "\x00\x19\xb8\x00\xf0\xa3", 6);
    }
    enet_set_mac(enet, mac);


    if (fec_init((0xf << 4), enet)) {
        printf("ERROR:%s:%d: ""Failed to initialize fec""\n", __func__, 397);
        goto error;
    }
