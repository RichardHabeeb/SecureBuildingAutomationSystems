# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/micrel.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/micrel.c"
# 27 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/micrel.c"
...
# 5 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/config.h" 2
# 28 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/micrel.c" 2
...
# 29 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/micrel.c" 2
...
# 30 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/micrel.c" 2
...
# 33 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.h" 2
...
# 31 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/micrel.c" 2
...
static struct phy_driver KSZ804_driver = {
 ...
 .uid = 0x221510,
 .mask = 0xfffff0,
 .features = ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3) | (1 << 6) | (1 << 7) | (1 << 9)),
...
int ksz9021_phy_extended_write(struct phy_device *phydev, int regnum, uint16_t val)
{
 ...
 phy_write(phydev, (-1), 0x0b, regnum | 0x8000);
 return phy_write(phydev, (-1), 0x0c, val);
}

int ksz9021_phy_extended_read(struct phy_device *phydev, int regnum)
{

 phy_write(phydev, (-1), 0x0b, regnum);
 return phy_read(phydev, (-1), 0x0d);
}
...
{
 unsigned ctrl1000 = 0;
 const unsigned master = (1 << 10) |
   (1 << 11) | (1 << 12);
 unsigned features = phydev->drv->features;


 if (features & (1 << 4))
  ctrl1000 |= 0x0100 | master;
 if (features & (1 << 5))
  ctrl1000 |= 0x0200 | master;
 phydev->advertising = phydev->supported = features;
 phy_write(phydev, (-1), 0x09, ctrl1000);
...
void print_phyregs(struct phy_device *phydev){
    ...
    printf("\n\nIEEE\n");
    for(i = 0; i < 16; i++){
     uint16_t val = phy_read(phydev, (-1), i);
        printf("%3d | 0x%04x\n", i, val);
    }
...
int ksz9021_startup(struct phy_device *phydev)
{
 ...
 phy_ctl = phy_read(phydev, (-1), 0x1f);
...
static struct phy_driver ksz9021_driver = {
 ...
 .uid = 0x221610,
 .mask = 0xfffff0,
 .features = (((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3) | (1 << 6) | (1 << 7) | (1 << 9)) | (1 << 4) | (1 << 5)),
