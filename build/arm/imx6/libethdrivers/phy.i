# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c"
# 30 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c"
...
int rand_r (unsigned *);
# 31 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c" 2
...
# 5 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/config.h" 2
# 32 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c" 2
...
# 33 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c" 2
...
# 34 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c" 2
...
# 35 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c" 2
...
# 37 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/bitops.h" 1
...
# 16 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/bitops.h"
...
# 38 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c" 2
...
# 40 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c" 2
# 52 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c"
static int genphy_config_advert(struct phy_device *phydev)
{
 ...
 oldadv = adv = phy_read(phydev, (-1), 0x04);

 if (adv < 0)
  return adv;

 adv &= ~((0x0020 | 0x0040 | 0x0080 | 0x0100) | 0x0200 | 0x0400 |
   0x0800);
 if (advertise & (1 << 0))
  adv |= 0x0020;
 if (advertise & (1 << 1))
 ...
 if (adv != oldadv) {
  err = phy_write(phydev, (-1), 0x04, adv);
 ...
 if (phydev->supported & ((1 << 4) |
    (1 << 5))) {
  oldadv = adv = phy_read(phydev, (-1), 0x09);
...
# 127 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c"
static int genphy_setup_forced(struct phy_device *phydev)
{
 ...
 if (1000 == phydev->speed)
  ctl |= 0x0040;
 else if (100 == phydev->speed)
  ctl |= 0x2000;

 if (0x01 == phydev->duplex)
  ctl |= 0x0100;

 err = phy_write(phydev, (-1), 0x00, ctl);
...
int genphy_restart_aneg(struct phy_device *phydev)
{
 ...
 ctl = phy_write(phydev, (-1), 0x00, ctl);

 return ctl;
}
# 180 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c"
int genphy_config_aneg(struct phy_device *phydev)
{
 int result;

 if (0x01 != phydev->autoneg)
 ...
 if (result == 0) {
  ...
  int ctl = phy_read(phydev, (-1), 0x00);

  if (ctl < 0)
   return ctl;

  if (!(ctl & 0x1000) || (ctl & 0x0400))
   result = 1;
 }
...
# 220 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c"
int genphy_update_link(struct phy_device *phydev)
{
 ...
 mii_reg = phy_read(phydev, (-1), 0x01);





 if (phydev->link && mii_reg & 0x0004)
  return 0;

 if ((mii_reg & 0x0008) && !(mii_reg & 0x0020)) {
  int i = 0;

  printf("%s Waiting for PHY auto negotiation to complete", phydev->dev->name);
        fflush((stdout));
  while (!(mii_reg & 0x0020)) {
...
# 284 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c"
static int genphy_parse_link(struct phy_device *phydev)
{
 int mii_reg = phy_read(phydev, (-1), 0x01);
 ...
 if (mii_reg & 0x0008) {
  ...
  lpa = phy_read(phydev, (-1), 0x04);
  lpa &= phy_read(phydev, (-1), 0x05);

  if (lpa & (0x0100 | 0x0080)) {
   phydev->speed = 100;
  ...
  u32 bmcr = phy_read(phydev, (-1), 0x00);
    ...
    phy_interface_t interface)
{
 ...
 struct phy_driver *drv = ((void*)0);

 for (entry = (&phy_drivers)->next; prefetch(entry->next), entry != (&phy_drivers); entry = entry->next) {
  drv = ({ const typeof( ((struct phy_driver *)0)->list ) *__mptr = (entry); (struct phy_driver *)( (char *)__mptr - ((size_t)( (char *)&(((struct phy_driver *)0)->list) - (char *)0 )) );});
...
# 517 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c"
static int get_phy_id(struct mii_dev *bus, int addr, int devad, u32 *phy_id)
{
 ...
 phy_reg = bus->read(bus, addr, devad, 0x02);
 ...
 *phy_id = (phy_reg & 0xffff) << 16;
 ...
 phy_reg = bus->read(bus, addr, devad, 0x03);
  ...
  unsigned phy_mask, phy_interface_t interface)
{
 ...
 for (i = 0; i < 5; i++) {
  phydev = create_phy_by_mask(bus, phy_mask, i ? i : (-1), interface);
 ...
 return phy_device_create(bus, generic_ffs(phy_mask) - 1, 0xffffffff, interface);
}
# 603 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c"
...
int phy_reset(struct phy_device *phydev)
{
 ...
 int timeout = 500;
 int devad = (-1);
# 625 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c"
 reg = phy_read(phydev, devad, 0x00);
 if (reg < 0) {
  do { if (1) printf("PHY status read failed\n"); } while (0);
  return -1;
 }

 reg |= 0x8000;

 if (phy_write(phydev, devad, 0x00, reg) < 0) {
  do { if (1) printf("PHY reset failed\n"); } while (0);
  return -1;
 }
# 646 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/phy.c"
 while ((reg & 0x8000) && timeout--) {
  reg = phy_read(phydev, devad, 0x00);
  ...
  struct eth_device *dev, phy_interface_t interface)
{
 ...
 do { if (1) printf("%s connected to %s\n", dev->name, phydev->drv->name); } while (0);
