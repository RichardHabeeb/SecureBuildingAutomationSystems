# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/miiphyutil.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/miiphyutil.c"
# 33 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/miiphyutil.c"
...
# 34 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/miiphyutil.c" 2
...
# 35 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/miiphyutil.c" 2
...
# 39 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/miiphyutil.c" 2
...
int rand_r (unsigned *);
# 40 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/miiphyutil.c" 2
...
# 41 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/miiphyutil.c" 2
...
struct mii_dev *miiphy_get_dev_by_name(const char *devname)
{
 ...
 for (entry = (&mii_devs)->next; prefetch(entry->next), entry != (&mii_devs); entry = entry->next) {
  dev = ({ const typeof( ((struct mii_dev *)0)->link ) *__mptr = (entry); (struct mii_dev *)( (char *)__mptr - ((size_t)( (char *)&(((struct mii_dev *)0)->link) - (char *)0 )) );});
...
void mdio_list_devices(void)
{
 ...
 for (entry = (&mii_devs)->next; prefetch(entry->next), entry != (&mii_devs); entry = entry->next) {
  int i;
  struct mii_dev *bus = ({ const typeof( ((struct mii_dev *)0)->link ) *__mptr = (entry); (struct mii_dev *)( (char *)__mptr - ((size_t)( (char *)&(((struct mii_dev *)0)->link) - (char *)0 )) );});
...
struct phy_device *mdio_phydev_for_ethname(const char *ethname)
{
 ...
 for (entry = (&mii_devs)->next; prefetch(entry->next), entry != (&mii_devs); entry = entry->next) {
  int i;
  bus = ({ const typeof( ((struct mii_dev *)0)->link ) *__mptr = (entry); (struct mii_dev *)( (char *)__mptr - ((size_t)( (char *)&(((struct mii_dev *)0)->link) - (char *)0 )) );});
...
# 298 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/miiphyutil.c"
int miiphy_read(const char *devname, unsigned char addr, unsigned char reg,
   unsigned short *value)
{
 struct mii_dev *bus;
...
# 326 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/miiphyutil.c"
int miiphy_write(const char *devname, unsigned char addr, unsigned char reg,
    unsigned short value)
{
 struct mii_dev *bus;
 ...
 bus = miiphy_get_active_dev(devname);
 if (bus)
  return bus->write(bus, addr, (-1), reg, value);
...
# 371 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/miiphyutil.c"
int miiphy_info(const char *devname, unsigned char addr, unsigned int *oui,
   unsigned char *model, unsigned char *rev)
{
 unsigned int reg = 0;
...
# 456 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/miiphyutil.c"
int miiphy_speed(const char *devname, unsigned char addr)
{
 u16 bmcr, anlpar;
# 484 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/miiphyutil.c"
 if (miiphy_read(devname, addr, 0x00, &bmcr)) {
  printf("PHY speed");
 ...
 if (bmcr & 0x1000) {
  ...
  if (miiphy_read(devname, addr, 0x05, &anlpar)) {
   printf("PHY AN speed");
   goto miiphy_read_failed;
  }
  return (anlpar & (0x0100 | 0x0080 | 0x0200)) ? 100 : 10;
 }

 return (bmcr & 0x2000) ? 100 : 10;
...
{
 u16 bmcr, anlpar;
# 542 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/miiphyutil.c"
 if (miiphy_read(devname, addr, 0x00, &bmcr)) {
  puts("PHY duplex");
  goto miiphy_read_failed;
 }
 ...
 if (bmcr & 0x1000) {
  ...
  return (anlpar & (0x0040 | 0x0100)) ?
      44 : 22;
 }

 return (bmcr & 0x0100) ? 44 : 22;
...
int miiphy_is_1000base_x(const char *devname, unsigned char addr)
{
# 581 "/home/mint/seL4/dhs-demo-feb-2018/libs/libethdrivers/src/plat/imx6/uboot/miiphyutil.c"
 return 0;
