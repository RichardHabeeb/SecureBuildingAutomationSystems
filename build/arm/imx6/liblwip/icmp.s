...
icmp_send_response.isra.0:
	.fnstart
.LFB4:
	.file 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"
	.loc 1 291 0
	.cfi_startproc
...
.LVL5:
	...
	ldr	r9, [r3, #12]	@ unaligned
	str	lr, [r8, #8]	@ unaligned
	str	ip, [r8, #12]	@ unaligned
	str	r1, [r8, #16]	@ unaligned
	str	r9, [r8, #20]	@ unaligned
	ldr	lr, [r3, #16]	@ unaligned
	ldr	ip, [r3, #20]	@ unaligned
	ldr	r1, [r3, #24]	@ unaligned
	str	lr, [r8, #24]	@ unaligned
	str	ip, [r8, #28]	@ unaligned
	str	r1, [r8, #32]	@ unaligned
	.loc 1 327 0
	strb	r5, [r4, #2]
	strb	r5, [r4, #3]
	.loc 1 328 0
...
.LBB2:
	.loc 1 113 0
	movw	fp, #:lower16:current_iphdr_dest
	.loc 1 119 0
	mov	r1, r9
	.loc 1 113 0
	movt	fp, #:upper16:current_iphdr_dest
	ldr	r10, [fp]
.LVL22:
	.loc 1 119 0
	mov	r0, r10
...
.LBB5:
	.loc 1 222 0
	mov	r3, #1
	movw	r1, #:lower16:current_iphdr_dest
	mov	r2, r0
	str	r0, [sp]
	str	r3, [sp, #4]
	movt	r1, #:upper16:current_iphdr_dest
	str	r9, [sp, #8]
	mov	r3, #255
	mov	r0, r7
	bl	ip_output_if
...
.LC0:
	...
	.ascii	"-1.4.1/src/core/ipv4/icmp.c\000"
	.space	1
.LC1:
	.ascii	"check that first pbuf can hold icmp message\000"
.LC2:
	.ascii	"Assertion \"%s\" failed at line %d in %s\012\000"
.LC3:
	.ascii	"icmp_input: moving p->payload to ip header failed\012"
	.ascii	"\000"
	.space	1
.LC4:
	.ascii	"check that first pbuf can hold struct the ICMP head"
	.ascii	"er\000"
	.space	2
.LC5:
	.ascii	"icmp_input: copying to new pbuf failed\012\000"
.LC6:
	.ascii	"icmp_input: restoring original p->payload failed\012"
	.ascii	"\000"
	.space	2
.LC7:
...
.Letext0:
	...
	.file 8 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/icmp.h"
	.file 9 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/ip.h"
	.file 10 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/stats.h"
...
.Ldebug_macro0:
	...
	.byte	0x4
	.file 24 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/memp.h"
	.byte	0x3
	.uleb128 0x26
	.uleb128 0x18
	.byte	0x7
	...
	.byte	0x4
	.file 27 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/string.h"
	.byte	0x3
	.uleb128 0x35
	.uleb128 0x1b
	.byte	0x7
...
.Ldebug_macro23:
	...
	.4byte	.LASF898
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.icmp.h.44.450dbf91f594cc26ad19d086cdc83713,comdat
.Ldebug_macro24:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF1253:
	.ascii	"hlen\000"
.LASF1154:
	.ascii	"ICMP_DEST_UNREACH_DATASIZE 8\000"
.LASF217:
...
.LASF1153:
	.ascii	"LWIP_ICMP_ECHO_CHECK_INPUT_PBUF_LEN 1\000"
.LASF1098:
