# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
# 49 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
...
# 50 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c" 2
...
# 54 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c" 2
...
# 56 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c" 2
...
# 57 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c" 2
...
# 60 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c" 2
...
# 61 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c" 2
...
# 62 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c" 2
...
#define PERF_START 
#define PERF_STOP(x) 
# 63 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c" 2
...
# 64 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c" 2
...
# 66 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c" 2
...
again:
  ...
  return udp_port;
# 136 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
}
# 150 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
void
udp_input(struct pbuf *p, struct netif *inp)
{
  ...
  ;
                                                                                         ...
                                                                                         ;
# 221 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
  {
    prev = ((void*)0);
    local_match = 0;
    uncon_pcb = ((void*)0);
...
# 253 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
            (broadcast &&
  ...
  if (pcb != ((void*)0) || ((&inp->ip_addr)->addr == (&current_iphdr_dest)->addr)) {
    ;
# 326 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
    {
    ...
    if(pbuf_header(p, -8)) {
      ...
      do { if(!(0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_header failed\n", 344, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"); fflush((stdout)); abort(); } while(0); } while(0);
      ++lwip_stats.udp.drop;
      ;
      pbuf_free(p);
      goto end;
    ...
    if (pcb != ((void*)0)) {
      ;
# 401 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
      if (pcb->recv != ((void*)0)) {
      ...
      if (!broadcast &&
        ...
        do { if(!((p->payload == iphdr))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "p->payload == iphdr", 419, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"); fflush((stdout)); abort(); } while(0); } while(0);
...
# 453 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
err_t
...
# 490 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
err_t
udp_sendto(struct udp_pcb *pcb, struct pbuf *p,
  ip_addr_t *dst_ip, u16_t dst_port)
{
# 504 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
  struct netif *netif;
...
# 548 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
err_t
udp_sendto_if(struct udp_pcb *pcb, struct pbuf *p,
  ip_addr_t *dst_ip, u16_t dst_port, struct netif *netif)
{
# 563 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
  struct udp_hdr *udphdr;
  ip_addr_t *src_ip;
  err_t err;
  struct pbuf *q;
# 578 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
  if (pcb->local_port == 0) {
    ;
  ...
  do { if(!((q->len >= sizeof(struct udp_hdr)))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "check that first pbuf can hold struct udp_hdr",
                                                610
# 609 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
  ,
                                                "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
# 609 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
...
# 627 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
  ...
  ;
# 697 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
  {
    ;
    ...
    if ((pcb->flags & 0x01U) == 0) {
      u16_t udpchksum;
# 713 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
      {
...
# 765 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
err_t
udp_bind(struct udp_pcb *pcb, ip_addr_t *ipaddr, u16_t port)
{
  ...
  for (ipcb = udp_pcbs; ipcb != ((void*)0); ipcb = ipcb->next) {
    ...
    if (pcb == ipcb) {
      ...
      do { if(!(rebind == 0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "rebind == 0", 781, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"); fflush((stdout)); abort(); } while(0); } while(0);

      rebind = 1;
    }
# 794 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
    else {
...
# 852 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
err_t
udp_connect(struct udp_pcb *pcb, ip_addr_t *ipaddr, u16_t port)
{
  ...
  pcb->flags |= 0x04U;
# 886 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
...
# 929 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
void
...
# 945 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
void
...
# 976 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
struct udp_pcb *
udp_new(void)
{
  struct udp_pcb *pcb;
  pcb = (struct udp_pcb *)malloc(memp_sizes[MEMP_UDP_PCB]);
