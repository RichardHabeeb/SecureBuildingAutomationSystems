# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
# 64 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
...
# 65 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c" 2
...
# 67 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c" 2
...
# 68 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c" 2
...
# 71 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c" 2
...
# 72 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c" 2
...
#define PERF_START 
#define PERF_STOP(x) 
# 73 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c" 2
...
# 75 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c" 2
...
# 81 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c" 2

#define SIZEOF_STRUCT_PBUF LWIP_MEM_ALIGN_SIZE(sizeof(struct pbuf))


#define PBUF_POOL_BUFSIZE_ALIGNED LWIP_MEM_ALIGN_SIZE(PBUF_POOL_BUFSIZE)
# 103 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
volatile u8_t pbuf_free_ooseq_pending;
#define PBUF_POOL_IS_EMPTY() pbuf_pool_is_empty()
# 117 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
void
...
# 151 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
static void
pbuf_pool_is_empty(void)
{
  ...
  ;
# 172 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
}
# 206 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
struct pbuf *
pbuf_alloc(pbuf_layer layer, u16_t length, pbuf_type type)
{
  ...
  case PBUF_RAW:
    ...
    break;
  default:
    do { if(!(0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_alloc: bad pbuf layer", 232, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
    return ((void*)0);
  }
  ...
  case PBUF_POOL:
    ...
    p = (struct pbuf *)malloc(memp_sizes[MEMP_PBUF_POOL]);
    ;
    if (p == ((void*)0)) {
      pbuf_pool_is_empty();
      return ((void*)0);
    ...
    p->payload = ((void *)(((mem_ptr_t)((void *)((u8_t *)p + ((((sizeof(struct pbuf)) + 1 - 1) & ~(1 -1)) + offset))) + 1 - 1) & ~(mem_ptr_t)(1 -1)));
    do { if(!(((mem_ptr_t)p->payload % 1) == 0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_alloc: pbuf p->payload properly aligned",
                                                        251
# 250 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
    ,
                                                        "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
# 250 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
    ...
    p->len = (((length) < (((((((536 +40+(14 + 0)) + 1 - 1) & ~(1 -1))) + 1 - 1) & ~(1 -1)) - (((offset) + 1 - 1) & ~(1 -1)))) ? (length) : (((((((536 +40+(14 + 0)) + 1 - 1) & ~(1 -1))) + 1 - 1) & ~(1 -1)) - (((offset) + 1 - 1) & ~(1 -1))));
    do { if(!(((u8_t*)p->payload + p->len <= (u8_t*)p + (((sizeof(struct pbuf)) + 1 - 1) & ~(1 -1)) + ((((((536 +40+(14 + 0)) + 1 - 1) & ~(1 -1))) + 1 - 1) & ~(1 -1))))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "check p->payload + p->len does not overflow pbuf",

                                                                           258
# 256 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
    ,
...
# 256 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
                                                                            ...
                                                                            ;
    do { if(!((((((((536 +40+(14 + 0)) + 1 - 1) & ~(1 -1))) + 1 - 1) & ~(1 -1)) - (((offset) + 1 - 1) & ~(1 -1))) > 0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "PBUF_POOL_BUFSIZE must be bigger than MEM_ALIGNMENT",
                                                                    260
# 259 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
    ,
                                                                    "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
# 259 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
    ); fflush((stdout)); abort(); } while(0); } while(0)
    ...
    while (rem_len > 0) {
      q = (struct pbuf *)malloc(memp_sizes[MEMP_PBUF_POOL]);
      if (q == ((void*)0)) {
        pbuf_pool_is_empty();
      ...
      do { if(!(rem_len < 0xffff)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "rem_len < max_u16_t", 286, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
      q->tot_len = (u16_t)rem_len;

      q->len = ((((u16_t)rem_len) < (((((((536 +40+(14 + 0)) + 1 - 1) & ~(1 -1))) + 1 - 1) & ~(1 -1)))) ? ((u16_t)rem_len) : (((((((536 +40+(14 + 0)) + 1 - 1) & ~(1 -1))) + 1 - 1) & ~(1 -1))));
      q->payload = (void *)((u8_t *)q + (((sizeof(struct pbuf)) + 1 - 1) & ~(1 -1)));
      do { if(!(((mem_ptr_t)q->payload % 1) == 0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_alloc: pbuf q->payload properly aligned",
                                                          292
# 291 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
      ,
                                                          "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
# 291 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
      ); fflush((stdout)); abort(); } while(0); } while(0)
      ...
      do { if(!(((u8_t*)p->payload + p->len <= (u8_t*)p + (((sizeof(struct pbuf)) + 1 - 1) & ~(1 -1)) + ((((((536 +40+(14 + 0)) + 1 - 1) & ~(1 -1))) + 1 - 1) & ~(1 -1))))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "check p->payload + p->len does not overflow pbuf",
                                                                             ...
                                                                             295
# 293 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
      ,
...
# 293 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
  ...
  case PBUF_RAM:
    ...
    p = (struct pbuf*)malloc(((((((sizeof(struct pbuf)) + 1 - 1) & ~(1 -1)) + offset) + 1 - 1) & ~(1 -1)) + (((length) + 1 - 1) & ~(1 -1)));
    if (p == ((void*)0)) {
      return ((void*)0);
    }
    ...
    do { if(!(((mem_ptr_t)p->payload % 1) == 0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_alloc: pbuf->payload properly aligned",
                                                       319
# 318 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
    ,
                                                       "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
# 318 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
    ); fflush((stdout)); abort(); } while(0); } while(0)
  ...
  case PBUF_REF:
    ...
    p = (struct pbuf *)malloc(memp_sizes[MEMP_PBUF]);
    if (p == ((void*)0)) {
    ...
    break;
  default:
    do { if(!(0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_alloc: erroneous type", 340, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
    return ((void*)0);
  }
...
# 366 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
struct pbuf*
                    ...
                    void *payload_mem, u16_t payload_mem_len)
{
  ...
  case PBUF_RAW:
    ...
    break;
  default:
    do { if(!(0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_alloced_custom: bad pbuf layer", 391, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
    return ((void*)0);
  }

  if ((((offset) + 1 - 1) & ~(1 -1)) + length > payload_mem_len) {
    ;
    return ((void*)0);
  }
  ...
  if (payload_mem != ((void*)0)) {
    p->pbuf.payload = (u8_t *)payload_mem + (((offset) + 1 - 1) & ~(1 -1));
  } else {
...
# 429 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
void
pbuf_realloc(struct pbuf *p, u16_t new_len)
{
  ...
  do { if(!(p != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_realloc: p != NULL", 436, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
  do { if(!(p->type == PBUF_POOL || p->type == PBUF_ROM || p->type == PBUF_RAM || p->type == PBUF_REF)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_realloc: sane p->type",
                                 ...
                                 440
# 437 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
  ,
...
# 437 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
  ...
  while (rem_len > q->len) {
    ...
    do { if(!(grow < 0xffff)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "grow < max_u16_t", 460, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
    q->tot_len += (u16_t)grow;

    q = q->next;
    do { if(!(q != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_realloc: q != NULL", 464, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
  }
  ...
  if ((q->type == PBUF_RAM) && (rem_len != q->len)) {
    ...
    q = (struct pbuf *)(q);
    do { if(!(q != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "mem_trim returned q == NULL", 474, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
  }
...
# 510 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
u8_t
pbuf_header(struct pbuf *p, s16_t header_size_increment)
{
  ...
  do { if(!(p != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "p != NULL", 517, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
  ...
  if (header_size_increment < 0){
    ...
    do { if (!((increment_magnitude <= p->len))) { do { printf("Assertion \"%s\" failed at line %d in %s\n", "increment_magnitude <= p->len", 525, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); return 1;;}} while(0);
  } else {
    increment_magnitude = header_size_increment;
# 538 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
  }
  ...
  if (type == PBUF_RAM || type == PBUF_POOL) {
    ...
    if ((u8_t *)p->payload < (u8_t *)p + (((sizeof(struct pbuf)) + 1 - 1) & ~(1 -1))) {
    ...
    do { if(!(0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "bad pbuf type", 571, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
    return 1;
  }
...
# 617 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
u8_t
pbuf_free(struct pbuf *p)
{
  ...
  if (p == ((void*)0)) {
    do { if(!(p != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "p != NULL", 625, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
  ...
  do { if(!(p->type == PBUF_RAM || p->type == PBUF_ROM || p->type == PBUF_REF || p->type == PBUF_POOL)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_free: sane type",
                                               ...
                                               637
# 635 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
  ,
...
# 635 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
  ...
  while (p != ((void*)0)) {
    ...
    do { if(!(p->ref > 0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_free: p->ref > 0", 650, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
    ...
    if (ref == 0) {
      ...
      if ((p->flags & 0x02U) != 0) {
        ...
        do { if(!(pc->custom_free_function != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "pc->custom_free_function != NULL", 664, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
...
# 703 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
u8_t
...
# 744 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
void
pbuf_cat(struct pbuf *h, struct pbuf *t)
{
  struct pbuf *p;

  do { if (!(((h != ((void*)0)) && (t != ((void*)0))))) { do { printf("Assertion \"%s\" failed at line %d in %s\n", "(h != NULL) && (t != NULL) (programmer violates API)",
                                                  750
# 749 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
  ,
                                                  "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
# 749 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
  ); fflush((stdout)); abort(); } while(0); return;;}} while(0)
                                                   ;
  ...
  do { if(!(p->tot_len == p->len)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "p->tot_len == p->len (of last pbuf in chain)", 758, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
  do { if(!(p->next == ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "p->next == NULL", 759, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
...
# 785 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
void
...
# 802 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
struct pbuf *
pbuf_dechain(struct pbuf *p)
{
  ...
  if (q != ((void*)0)) {
    ...
    do { if(!(q->tot_len == p->tot_len - p->len)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "p->tot_len == p->len + q->tot_len", 812, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
  ...
  do { if(!(p->tot_len == p->len)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "p->tot_len == p->len", 829, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
  return ((tail_gone > 0) ? ((void*)0) : q);
}
# 851 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
err_t
pbuf_copy(struct pbuf *p_to, struct pbuf *p_from)
{
  ...
  do { if (!(((p_to != ((void*)0)) && (p_from != ((void*)0)) && (p_to->tot_len >= p_from->tot_len)))) { do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_copy: target not big enough to hold source",
                                                                                     861
# 860 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
  ,
                                                                                     "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
# 860 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
  ); fflush((stdout)); abort(); } while(0); return -14;;}} while(0)
                                                                                      ;
  ...
  do
  {
    ...
    offset_to += len;
    offset_from += len;
    do { if(!(offset_to <= p_to->len)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "offset_to <= p_to->len", 877, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
    do { if(!(offset_from <= p_from->len)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "offset_from <= p_from->len", 878, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
    ...
    if (offset_to == p_to->len) {
      ...
      offset_to = 0;
      p_to = p_to->next;
      do { if (!((p_to != ((void*)0)) || (p_from == ((void*)0)))) { do { printf("Assertion \"%s\" failed at line %d in %s\n", "p_to != NULL", 888, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); return -14;;}} while(0);
    }

    if((p_from != ((void*)0)) && (p_from->len == p_from->tot_len)) {

      do { if (!((p_from->next == ((void*)0)))) { do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_copy() does not allow packet queues!\n",
                                                        894
# 893 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
      ,
                                                        "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
# 893 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
      ); fflush((stdout)); abort(); } while(0); return -6;;}} while(0)
                                                         ;
    }
    if((p_to != ((void*)0)) && (p_to->len == p_to->tot_len)) {

      do { if (!((p_to->next == ((void*)0)))) { do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_copy() does not allow packet queues!\n",
                                                       899
# 898 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
      ,
                                                       "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
# 898 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
      ); fflush((stdout)); abort(); } while(0); return -6;;}} while(0)
...
# 917 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
u16_t
pbuf_copy_partial(struct pbuf *buf, void *dataptr, u16_t len, u16_t offset)
{
  ...
  do { if (!((buf != ((void*)0)))) { do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_copy_partial: invalid buf", 925, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); return 0;;}} while(0);
  do { if (!((dataptr != ((void*)0)))) { do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_copy_partial: invalid dataptr", 926, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); return 0;;}} while(0);
...
# 965 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
err_t
pbuf_take(struct pbuf *buf, const void *dataptr, u16_t len)
{
  ...
  do { if (!((buf != ((void*)0)))) { do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_take: invalid buf", 973, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); return 0;;}} while(0);
  do { if (!((dataptr != ((void*)0)))) { do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_take: invalid dataptr", 974, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); return 0;;}} while(0);
  ...
  for(p = buf; total_copy_len != 0; p = p->next) {
    do { if(!(p != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_take: invalid pbuf", 982, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
  ...
  do { if(!(total_copy_len == 0 && copied_total == len)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "did not copy all data", 993, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
  return 0;
}
# 1009 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
struct pbuf*
pbuf_coalesce(struct pbuf *p, pbuf_layer layer)
{
  ...
  err = pbuf_copy(q, p);
  do { if(!(err == 0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "pbuf_copy failed", 1023, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"); fflush((stdout)); abort(); } while(0); } while(0);
  pbuf_free(p);
  return q;
}
# 1076 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
u8_t
...
# 1103 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
u16_t
...
# 1139 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
u16_t
...
# 1167 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/pbuf.c"
u16_t
