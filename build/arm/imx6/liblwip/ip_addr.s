...
ip4_addr_isbroadcast:
	.fnstart
.LFB0:
	.file 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/ip_addr.c"
	.loc 1 56 0
	.cfi_startproc
...
.LVL37:
	...
	cmp	r3, #88
	.loc 1 175 0
	ldrbeq	ip, [r0, #2]	@ zero_extendqisi2
.LVL38:
	.loc 1 172 0
	addne	r0, r0, #1
.LVL39:
...
.LC0:
	...
	.ascii	"-1.4.1/src/core/ipv4/ip_addr.c\000"
	.space	2
.LC1:
	.ascii	"unhandled\000"
	.space	2
...
.Letext0:
	...
	.file 9 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/def.h"
...
.LASF899:
	.ascii	"isprint(c) in_range(c, 0x20, 0x7f)\000"
.LASF624:
...
.LASF902:
	.ascii	"islower(c) in_range(c, 'a', 'z')\000"
.LASF911:
...
.LASF900:
	.ascii	"isdigit(c) in_range(c, '0', '9')\000"
.LASF622:
...
.LASF905:
	.ascii	"short int\000"
.LASF901:
	.ascii	"isxdigit(c) (isdigit(c) || in_range(c, 'a', 'f') ||"
	.ascii	" in_range(c, 'A', 'F'))\000"
.LASF833:
...
.LASF898:
	.ascii	"in_range(c,lo,up) ((u8_t)c >= lo && (u8_t)c <= up)\000"
.LASF546:
