# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
# 41 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
...
# 42 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c" 2
...
# 46 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c" 2
...
# 49 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c" 2
...
# 52 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c" 2
...
# 53 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c" 2
...
# 54 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c" 2
...
# 59 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c" 2
# 70 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
...
# 93 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
static struct pbuf *
                      ...
                      u32_t seqno_be )
{
  ...
  if (p != ((void*)0)) {
    do { if(!((p->len >= 20 + optlen))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "check that first pbuf can hold struct tcp_hdr",
                                              101
# 100 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ,
                                              "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
# 100 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
...
# 158 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
...
tcp_create_segment(struct tcp_pcb *pcb, struct pbuf *p, u8_t flags, u32_t seqno, u8_t optflags)
{
  ...
  if ((seg = (struct tcp_seg *)malloc(memp_sizes[MEMP_TCP_SEG])) == ((void*)0)) {
    ;
    pbuf_free(p);
    return ((void*)0);
  }
...
# 185 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
  if (pbuf_header(p, 20)) {
    ;
    ++lwip_stats.tcp.err;
    tcp_seg_free(seg);
...
# 218 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
static struct pbuf *
                  ...
                  u8_t first_seg)
{
  struct pbuf *p;
  u16_t alloc = length;
# 234 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
  if (length < max_length) {
# 246 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    if ((apiflags & 0x02) ||
        (!(pcb->flags & ((u8_t)0x40U)) &&
         (!first_seg ||
          pcb->unsent != ((void*)0) ||
          pcb->unacked != ((void*)0)))) {
      alloc = (((max_length) < ((((length + 536) + 1 - 1) & ~(1 -1)))) ? (max_length) : ((((length + 536) + 1 - 1) & ~(1 -1))));
    }
  }
  ...
  do { if(!(p->next == ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "need unchained pbuf", 259, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"); fflush((stdout)); abort(); } while(0); } while(0);
  *oversize = p->len - length;

  p->len = p->tot_len = length;
  return p;
}
# 293 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
static err_t
tcp_write_checks(struct tcp_pcb *pcb, u16_t len)
{
  ...
  if ((pcb->snd_queuelen >= 40) || (pcb->snd_queuelen > (0xffffU-3))) {
  ...
  if (pcb->snd_queuelen != 0) {
    do { if(!(pcb->unacked != ((void*)0) || pcb->unsent != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "tcp_write: pbufs on queue => at least one queue non-empty",
                                                 329
# 328 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ,
                                                 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
# 328 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ); fflush((stdout)); abort(); } while(0); } while(0)
    ...
    do { if(!(pcb->unacked == ((void*)0) && pcb->unsent == ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "tcp_write: no pbufs on queue => both queues empty",
                                                 332
# 331 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ,
                                                 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
# 331 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ); fflush((stdout)); abort(); } while(0); } while(0)
...
# 353 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
err_t
tcp_write(struct tcp_pcb *pcb, const void *arg, u16_t len, u8_t apiflags)
{
  ...
  u16_t mss_local = (((pcb->mss) < (pcb->snd_wnd_max/2)) ? (pcb->mss) : (pcb->snd_wnd_max/2));
                                            ...
                                            ;
  do { if (!(arg != ((void*)0))) { do { printf("Assertion \"%s\" failed at line %d in %s\n", "tcp_write: arg == NULL (programmer violates API)",
                                         383
# 382 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
  ,
                                         "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
# 382 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
...
# 422 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
  if (pcb->unsent != ((void*)0)) {
    u16_t space;
    u16_t unsent_optlen;
...
# 447 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    oversize = pcb->unsent_oversize;
    if (oversize > 0) {
      do { if(!(oversize_used <= space)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "inconsistent oversize vs. space", 449, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"); fflush((stdout)); abort(); } while(0); } while(0);
      seg = last_unsent;
    ...
    do { if(!((oversize == 0) || (pos == len))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "inconsistend oversize vs. len", 457, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"); fflush((stdout)); abort(); } while(0); } while(0);
# 467 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ...
    do { if(!(pcb->unsent_oversize == 0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "unsent_oversize mismatch (pcb->unsent is NULL)",
                                         512
# 511 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ,
                                         "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
# 511 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ); fflush((stdout)); abort(); } while(0); } while(0)
  ...
  while (pos < len) {
    ...
    if (apiflags & 0x01) {
      ...
      do { if(!((p->len >= seglen))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "tcp_write: check that first pbuf can hold the complete seglen",
                                    540
# 539 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
      ,
                                    "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
# 539 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
      ); fflush((stdout)); abort(); } while(0); } while(0)
      ...
      do { if(!(oversize == 0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "oversize == 0", 550, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"); fflush((stdout)); abort(); } while(0); } while(0);
    ...
    if ((queuelen > 40) || (queuelen > (0xffffU-3))) {
      ;
      pbuf_free(p);
      goto memerr;
    }
...
# 599 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    if (queue == ((void*)0)) {
      queue = seg;
    } else {

      do { if(!(prev_seg != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "prev_seg != NULL", 603, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"); fflush((stdout)); abort(); } while(0); } while(0);
      prev_seg->next = seg;
    }
...
# 626 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
  if (oversize_used > 0) {
    struct pbuf *p;
  ...
  if (concat_p != ((void*)0)) {
    do { if(!((last_unsent != ((void*)0)))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "tcp_write: cannot concatenate when pcb->unsent is empty",
                           651
# 650 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ,
                           "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
# 650 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ); fflush((stdout)); abort(); } while(0); } while(0)
  ...
  if (pcb->snd_queuelen != 0) {
    do { if(!(pcb->unacked != ((void*)0) || pcb->unsent != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "tcp_write: valid queue length",
                                                           684
# 683 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ,
                                                           "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
# 683 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ); fflush((stdout)); abort(); } while(0); } while(0)
...
memerr:
  ...
  if (pcb->snd_queuelen != 0) {
    do { if(!(pcb->unacked != ((void*)0) || pcb->unsent != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "tcp_write: valid queue length",
                         705
# 704 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ,
                         "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
# 704 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ); fflush((stdout)); abort(); } while(0); } while(0)
...
# 721 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
err_t
tcp_enqueue_flags(struct tcp_pcb *pcb, u8_t flags)
{
  ...
  do { if(!((flags & (0x02U | 0x01U)) != 0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "tcp_enqueue_flags: need either TCP_SYN or TCP_FIN in flags (programmer violates API)",
                                                732
# 731 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
  ,
                                                "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
# 731 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
  ); fflush((stdout)); abort(); } while(0); } while(0)
  ...
  do { if(!((p->len >= optlen))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "tcp_enqueue_flags: check that first pbuf can hold optlen",
                                770
# 769 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
  ,
                                "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
# 769 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
  ); fflush((stdout)); abort(); } while(0); } while(0)
  ...
  do { if(!(((mem_ptr_t)seg->tcphdr % 1) == 0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "seg->tcphdr not aligned", 778, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"); fflush((stdout)); abort(); } while(0); } while(0);
  do { if(!(seg->len == 0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "tcp_enqueue_flags: invalid segment length", 779, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"); fflush((stdout)); abort(); } while(0); } while(0);
  ...
  if (pcb->snd_queuelen != 0) {
    do { if(!(pcb->unacked != ((void*)0) || pcb->unsent != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "tcp_enqueue_flags: invalid queue length",
                                                 815
# 814 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ,
                                                 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
# 814 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ); fflush((stdout)); abort(); } while(0); } while(0)
...
# 841 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
err_t
...
# 875 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
...
# 897 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
err_t
tcp_output(struct tcp_pcb *pcb)
{
  ...
  do { if(!(pcb->state != LISTEN)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "don't call tcp_output for listen-pcbs",
                        908
# 907 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
  ,
                        "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
# 907 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
  ); fflush((stdout)); abort(); } while(0); } while(0)
...
# 962 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
  while (seg != ((void*)0) &&
         lwip_ntohl(seg->tcphdr->seqno) - pcb->lastack + seg->len <= wnd) {
    do { if(!(((lwip_ntohs((seg->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x04U) == 0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "RST not expected here!",
                                                        965
# 964 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ,
                                                        "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
# 964 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    ); fflush((stdout)); abort(); } while(0); } while(0)
    ...
    if((((((pcb)->unacked == ((void*)0)) || ((pcb)->flags & (((u8_t)0x40U) | ((u8_t)0x04U))) || (((pcb)->unsent != ((void*)0)) && (((pcb)->unsent->next != ((void*)0)) || ((pcb)->unsent->len >= (pcb)->mss))) || ((((pcb)->snd_buf) == 0) || (((pcb)->snd_queuelen) >= 40)) ) ? 1 : 0) == 0) &&
      ((pcb->flags & (((u8_t)0x80U) | ((u8_t)0x20U))) == 0)){
      break;
    }
# 986 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
    pcb->unsent = seg->next;
...
tcp_output_segment(struct tcp_seg *seg, struct tcp_pcb *pcb)
{
  ...
  if (seg->flags & (u8_t)0x01U) {
    ...
    mss = tcp_eff_send_mss(536, &pcb->remote_ip);
...
# 1091 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
  if (pcb->rtime == -1) {
    pcb->rtime = 0;
  }
  ...
  seg->tcphdr->chksum = 0;
# 1158 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
...
# 1194 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
void
  ...
  u16_t local_port, u16_t remote_port)
{
  ...
  do { if(!((p->len >= sizeof(struct tcp_hdr)))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "check that first pbuf can hold struct tcp_hdr",
                                                1207
# 1206 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
  ,
                                                "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
# 1206 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
  ); fflush((stdout)); abort(); } while(0); } while(0)
  ...
  tcphdr->wnd = (((((10 * 536)) & 0xff) << 8) | ((((10 * 536)) & 0xff00) >> 8));
  tcphdr->chksum = 0;
  tcphdr->urgp = 0;
...
# 1238 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
void
...
# 1274 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
void
...
# 1363 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
void
...
# 1413 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/tcp_out.c"
void
