...
etharp_find_entry:
	.fnstart
.LFB2:
	.file 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
	.loc 1 267 0
	.cfi_startproc
...
.LVL47:
	...
	.cfi_offset 14, -4
	.loc 1 419 0
	ldrb	r4, [r0, #34]	@ zero_extendqisi2
	.loc 1 417 0
	ldr	ip, [r1, #4]
.LVL48:
	.loc 1 419 0
...
.LVL49:
	...
	.loc 1 422 0
	ldr	r3, [r2]	@ unaligned
	str	r3, [ip, #6]	@ unaligned
	ldrh	r3, [r2, #4]	@ unaligned
	.loc 1 423 0
	strb	r5, [ip, #13]
	strb	r4, [ip, #12]
	.loc 1 422 0
	strh	r3, [ip, #10]	@ unaligned
	.loc 1 426 0
	ldr	r3, [r0, #24]
	.loc 1 427 0
	pop	{r4, r5, r6, lr}
...
.LVL63:
	...
	add	ip, ip, r0
	.loc 1 478 0
	addeq	r3, lr, r3, lsl r2
	.loc 1 473 0
	addne	r3, lr, r3, lsl #2
	.loc 1 482 0
	lsl	ip, ip, #2
	.loc 1 473 0
	movne	r2, #4
...
.LFE4:
	...
	.syntax unified
	.arm
	.type	etharp_raw.constprop.2, %function
etharp_raw.constprop.2:
	.fnstart
.LFB18:
	.loc 1 1175 0
	.cfi_startproc
...
.LVL83:
	bl	lwip_htons
.LVL84:
	strh	r0, [r4, #20]	@ unaligned
	.loc 1 1208 0
	ldrb	r2, [r6, #34]	@ zero_extendqisi2
	cmp	r2, #6
	bne	.L85
	.loc 1 1217 0
	ldr	r1, [r8]	@ unaligned
...
.LVL85:
	...
	.loc 1 1225 0
	ldr	r1, [r7]	@ unaligned
	str	r1, [r4, #6]	@ unaligned
	.loc 1 1239 0
	mov	r1, r5
	.loc 1 1225 0
	ldrh	r7, [r7, #4]	@ unaligned
.LVL86:
	strh	r7, [r4, #10]	@ unaligned
	.loc 1 1228 0
	ldr	r7, [r9]	@ unaligned
	str	r7, [r4, #28]	@ unaligned
	.loc 1 1229 0
	ldr	r7, [sp, #32]
	ldr	r7, [r7]	@ unaligned
	.loc 1 1235 0
...
.LFE18:
	.fnend
	.size	etharp_raw.constprop.2, .-etharp_raw.constprop.2
	.align	2
	.syntax unified
	.arm
...
.LVL206:
	...
	ldrb	r2, [ip, #200]	@ zero_extendqisi2
	add	r3, r2, r2, lsl #2
	add	r3, ip, r3, lsl #2
...
.L260:
	...
	ldrbeq	r3, [r0, #13]	@ zero_extendqisi2
	orreq	r3, r3, #16
	strbeq	r3, [r0, #13]
.LVL255:
	b	.L218
...
.L262:
	...
	bne	.L227
	.loc 1 724 0
	ldrh	r3, [r6, #16]	@ unaligned
	cmp	r3, #8
	bne	.L227
	.loc 1 734 0
	movw	r8, #:lower16:lwip_stats
	.loc 1 745 0
	mov	r9, r6
	.loc 1 734 0
	movt	r8, #:upper16:lwip_stats
	.loc 1 749 0
	ldr	r2, [r7, #4]
	.loc 1 734 0
	ldrh	r3, [r8, #26]
	...
	strh	r3, [r8, #26]	@ movhi
	.loc 1 745 0
	ldr	r0, [r9, #28]!	@ unaligned
	str	r0, [sp]
	.loc 1 746 0
	ldr	r0, [r6, #38]	@ unaligned
	str	r0, [sp, #4]
	.loc 1 749 0
	beq	.L229
.LVL259:
...
.L264:
	...
	bl	lwip_htons
.LVL270:
	strh	r0, [r6, #20]	@ unaligned
	.loc 1 782 0
	ldr	r3, [r9]	@ unaligned
	str	r3, [r6, #38]	@ unaligned
	.loc 1 783 0
...
.LC0:
	...
	.ascii	"-1.4.1/src/netif/etharp.c\000"
	.space	3
.LC1:
	.ascii	"arp_table[i].q == NULL\000"
	.space	1
.LC2:
	.ascii	"Assertion \"%s\" failed at line %d in %s\012\000"
.LC3:
	.ascii	"i < ARP_TABLE_SIZE\000"
	.space	1
.LC4:
	.ascii	"arp_table[i].state == ETHARP_STATE_EMPTY\000"
	.space	3
.LC5:
	.ascii	"netif->hwaddr_len must be the same as ETHARP_HWADDR"
	.ascii	"_LEN for etharp!\000"
.LC6:
	.ascii	"netif->hwaddr_len == ETHARP_HWADDR_LEN\000"
	.space	1
.LC7:
	.ascii	"netif != NULL\000"
	.space	2
.LC8:
	.ascii	"check that first pbuf can hold struct etharp_hdr\000"
	.space	3
.LC9:
	.ascii	"arp_table[arp_idx].state >= ETHARP_STATE_STABLE\000"
.LC10:
	.ascii	"eth_ret != NULL && ip_ret != NULL\000"
	.space	2
.LC11:
	.ascii	"no packet queues allowed!\000"
	.space	2
.LC12:
	.ascii	"q != NULL\000"
	.space	2
.LC13:
	.ascii	"ipaddr != NULL\000"
	.space	1
.LC14:
	.ascii	"Can't move over header in packet\000"
	.bss
	.align	2
	.set	.LANCHOR0,. + 0
...
.Letext0:
	...
	.file 8 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/memp.h"
	.file 9 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/stats.h"
	.file 10 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/netif/etharp.h"
	...
	.file 14 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/ip.h"
	.file 15 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/string.h"
...
.Ldebug_macro0:
	...
	.uleb128 0xb
	.4byte	.LASF380
	.file 16 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/opt.h"
	.byte	0x3
	.uleb128 0x2e
	.uleb128 0x10
	.byte	0x5
	.uleb128 0x27
	.4byte	.LASF381
	.file 17 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/lwipopts.h"
	.byte	0x3
	.uleb128 0x2d
	.uleb128 0x11
	.byte	0x7
	.4byte	.Ldebug_macro1
	.byte	0x4
	.file 18 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/debug.h"
	.byte	0x3
	.uleb128 0x2e
	.uleb128 0x12
	.byte	0x5
	.uleb128 0x21
	.4byte	.LASF395
	.file 19 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/arch.h"
	.byte	0x3
	.uleb128 0x23
	.uleb128 0x13
	.byte	0x7
	...
	.uleb128 0x21
	.4byte	.LASF945
	.file 23 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/mem.h"
	.byte	0x3
	.uleb128 0x25
	.uleb128 0x17
	.byte	0x5
	.uleb128 0x21
	.4byte	.LASF946
	.file 24 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/stddef.h"
	.byte	0x3
	.uleb128 0x2b
	.uleb128 0x18
	.byte	0x7
	...
	.file 25 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/memp_std.h"
	.byte	0x3
	.uleb128 0x2d
	.uleb128 0x19
	.byte	0x7
	...
	.byte	0x4
	.file 27 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/dhcp.h"
	.byte	0x3
	.uleb128 0x37
	.uleb128 0x1b
	.byte	0x5
	...
	.4byte	.LASF1130
	.byte	0x4
	.file 28 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/autoip.h"
	.byte	0x3
	.uleb128 0x38
	.uleb128 0x1c
	.byte	0x5
...
.LASF1263:
	.ascii	"ETHARP_STATE_STABLE_REREQUESTING\000"
.LASF258:
...
.LASF1158:
	.ascii	"ARP_AGE_REREQUEST_USED (ARP_MAXAGE - 12)\000"
.LASF823:
...
.LASF1164:
	.ascii	"ETHARP_SET_HINT(netif,hint) (etharp_cached_entry = "
	.ascii	"(hint))\000"
.LASF123:
...
.LASF1157:
	.ascii	"ARP_MAXAGE 240\000"
.LASF879:
	.ascii	"PBUF_FLAG_LLMCAST 0x10U\000"
.LASF1269:
	.ascii	"etharp_send_ip\000"
.LASF685:
...
.LASF1156:
	.ascii	"LL_MULTICAST_ADDR_2 0x5e\000"
.LASF525:
	.ascii	"SEEK_END\000"
.LASF561:
...
.LASF1163:
	.ascii	"ETHARP_FLAG_STATIC_ENTRY 4\000"
.LASF1059:
...
.LASF1162:
	.ascii	"ETHARP_FLAG_FIND_ONLY 2\000"
.LASF1325:
	.ascii	"memcmp\000"
.LASF981:
...
.LASF1165:
	.ascii	"free_etharp_q(q) pbuf_free(q)\000"
.LASF999:
...
.LASF1154:
	.ascii	"LL_MULTICAST_ADDR_0 0x01\000"
.LASF1117:
...
.LASF1155:
	.ascii	"LL_MULTICAST_ADDR_1 0x00\000"
.LASF147:
...
.LASF1204:
	.ascii	"next\000"
.LASF1161:
	.ascii	"ETHARP_FLAG_TRY_HARD 1\000"
.LASF907:
