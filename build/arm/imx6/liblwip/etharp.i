# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
# 46 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
...
# 47 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c" 2
...
# 51 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c" 2
...
# 39 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/ip.h" 2
...
# 53 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c" 2
...
# 54 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c" 2
...
# 55 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/dhcp.h" 1




#define __LWIP_DHCP_H__ 
# 56 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c" 2
...
# 57 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c" 2
...
# 58 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c" 2
...
# 64 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c" 2
...
# 91 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
...
# 171 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
...
# 265 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
static s8_t
etharp_find_entry(ip_addr_t *ipaddr, u8_t flags)
{
  ...
  u8_t age_queue = 0;
# 291 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  for (i = 0; i < 10; ++i) {
    u8_t state = arp_table[i].state;
    ...
    if ((empty == 10) && (state == ETHARP_STATE_EMPTY)) {
      ...
      do { if(!(state == ETHARP_STATE_PENDING || state >= ETHARP_STATE_STABLE)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "state == ETHARP_STATE_PENDING || state >= ETHARP_STATE_STABLE",
                                                                     300
# 299 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
      ,
                                                                     "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
# 299 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
...
# 359 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  if (empty < 10) {
    i = empty;
    ;
  } else {
    ...
    if (old_stable < 10) {
      ...
      do { if(!(arp_table[i].q == ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "arp_table[i].q == NULL", 369, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"); fflush((stdout)); abort(); } while(0); } while(0);
    ...
    do { if(!(i < 10)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "i < ARP_TABLE_SIZE", 387, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"); fflush((stdout)); abort(); } while(0); } while(0);
    etharp_free_entry(i);
  }

  do { if(!(i < 10)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "i < ARP_TABLE_SIZE", 391, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"); fflush((stdout)); abort(); } while(0); } while(0);
  do { if(!(arp_table[i].state == ETHARP_STATE_EMPTY)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "arp_table[i].state == ETHARP_STATE_EMPTY",
                                            393
# 392 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  ,
                                            "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
# 392 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  ); fflush((stdout)); abort(); } while(0); } while(0)
...
# 414 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
static err_t
etharp_send_ip(struct netif *netif, struct pbuf *p, struct eth_addr *src, struct eth_addr *dst)
{
  ...
  do { if(!((netif->hwaddr_len == 6))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "netif->hwaddr_len must be the same as ETHARP_HWADDR_LEN for etharp!",
                                                      420
# 419 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  ,
                                                      "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
# 419 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  ); fflush((stdout)); abort(); } while(0); } while(0)
...
# 447 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
static err_t
etharp_update_arp_entry(struct netif *netif, ip_addr_t *ipaddr, struct eth_addr *ethaddr, u8_t flags)
{
  s8_t i;
  do { if(!(netif->hwaddr_len == 6)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "netif->hwaddr_len == ETHARP_HWADDR_LEN", 451, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"); fflush((stdout)); abort(); } while(0); } while(0);
  ...
  arp_table[i].ctime = 0;
# 504 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  if (arp_table[i].q != ((void*)0)) {
...
# 525 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
err_t
...
# 550 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
err_t
...
# 602 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
s8_t
         ...
         struct eth_addr **eth_ret, ip_addr_t **ip_ret)
{
  ...
  do { if(!(eth_ret != ((void*)0) && ip_ret != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "eth_ret != NULL && ip_ret != NULL",
                                     609
# 608 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  ,
                                     "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
# 608 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  ); fflush((stdout)); abort(); } while(0); } while(0)
...
# 687 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
static void
etharp_arp_input(struct netif *netif, struct eth_addr *ethaddr, struct pbuf *p)
{
  ...
  do { if (!((netif != ((void*)0)))) { do { printf("Assertion \"%s\" failed at line %d in %s\n", "netif != NULL", 699, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"); fflush((stdout)); abort(); } while(0); return;;}} while(0);
...
# 745 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  ...
  case ((((1) & 0xff) << 8) | (((1) & 0xff00) >> 8)):
    ...
    if (for_us) {
      ...
      do { if(!((netif->hwaddr_len == 6))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "netif->hwaddr_len must be the same as ETHARP_HWADDR_LEN for etharp!",
                                                          786
# 785 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
      ,
                                                          "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
# 785 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
      ); fflush((stdout)); abort(); } while(0); } while(0)
...
etharp_output_to_arp_index(struct netif *netif, struct pbuf *q, u8_t arp_idx)
{
  do { if(!(arp_table[arp_idx].state >= ETHARP_STATE_STABLE)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "arp_table[arp_idx].state >= ETHARP_STATE_STABLE",
                                                             845
# 844 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  ,
                                                             "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
# 844 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  ); fflush((stdout)); abort(); } while(0); } while(0)
...
# 878 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
err_t
etharp_output(struct netif *netif, struct pbuf *q, ip_addr_t *ipaddr)
{
  ...
  do { if(!(netif != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "netif != NULL", 885, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"); fflush((stdout)); abort(); } while(0); } while(0);
  do { if(!(q != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "q != NULL", 886, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"); fflush((stdout)); abort(); } while(0); } while(0);
  do { if(!(ipaddr != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "ipaddr != NULL", 887, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"); fflush((stdout)); abort(); } while(0); } while(0);
...
# 932 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
      {
...
# 1015 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
err_t
etharp_query(struct netif *netif, ip_addr_t *ipaddr, struct pbuf *q)
{
  ...
  do { if(!(((arp_table[i].state == ETHARP_STATE_PENDING) || (arp_table[i].state >= ETHARP_STATE_STABLE)))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "arp_table[i].state == PENDING or STABLE",
                                               ...
                                               1051
# 1049 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  ,
...
# 1049 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  ...
  do { if(!(q != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "q != NULL", 1069, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"); fflush((stdout)); abort(); } while(0); } while(0);
  ...
  if (arp_table[i].state >= ETHARP_STATE_STABLE) {
    ...
    p = q;
    while (p) {
      do { if(!((p->len != p->tot_len) || (p->next == 0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "no packet queues allowed!", 1086, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"); fflush((stdout)); abort(); } while(0); } while(0);
      if(p->type != PBUF_ROM) {
        copy_needed = 1;
        break;
      }
    ...
    if (p != ((void*)0)) {
# 1139 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
      if (arp_table[i].q != ((void*)0)) {
        ;
        pbuf_free(arp_table[i].q);
      }
...
# 1172 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
static
           ...
           const u16_t opcode)
{
  ...
  do { if(!(netif != ((void*)0))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "netif != NULL", 1189, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"); fflush((stdout)); abort(); } while(0); } while(0);
  ...
  do { if(!((p->len >= ((14 + 0) + 28)))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "check that first pbuf can hold struct etharp_hdr",
                                              1201
# 1200 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  ,
                                              "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
# 1200 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  ); fflush((stdout)); abort(); } while(0); } while(0)
  ...
  do { if(!((netif->hwaddr_len == 6))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "netif->hwaddr_len must be the same as ETHARP_HWADDR_LEN for etharp!",
                                                      1209
# 1208 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  ,
                                                      "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
# 1208 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  ); fflush((stdout)); abort(); } while(0); } while(0)
...
# 1258 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
err_t
...
# 1276 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
err_t
ethernet_input(struct pbuf *p, struct netif *netif)
{
  ...
  type = ethhdr->type;
# 1332 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
  ...
  switch (type) {
    ...
    case ((((0x0800U) & 0xff) << 8) | (((0x0800U) & 0xff00) >> 8)):
      ...
      if(pbuf_header(p, -ip_hdr_offset)) {
        do { if(!(0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "Can't move over header in packet", 1359, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"); fflush((stdout)); abort(); } while(0); } while(0);
        goto free_and_return;
      } else {
    ...
    case ((((0x0806U) & 0xff) << 8) | (((0x0806U) & 0xff00) >> 8)):
      ...
      break;
# 1385 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/netif/etharp.c"
    default:
      ++lwip_stats.etharp.proterr;
      ++lwip_stats.etharp.drop;
      goto free_and_return;
