...
udp_init:
	.fnstart
.LFB0:
	.file 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/udp.c"
	.loc 1 87 0
	.cfi_startproc
...
.LVL12:
	.loc 1 229 0
	movw	r3, #:lower16:udp_pcbs
	movt	r3, #:upper16:udp_pcbs
	str	r3, [sp, #20]
	ldr	r3, [r3]
	cmp	r3, #0
	mov	ip, r3
...
.LVL42:
	...
	.cfi_offset 14, -4
	.loc 1 777 0
	movw	r5, #:lower16:udp_pcbs
	movt	r5, #:upper16:udp_pcbs
	.loc 1 767 0
	mov	lr, r0
	.loc 1 777 0
	ldr	r6, [r5]
...
.L139:
	.loc 1 893 0
	movw	r2, #:lower16:udp_pcbs
	.loc 1 864 0
	cmp	r5, #0
	.loc 1 893 0
	movt	r2, #:upper16:udp_pcbs
	.loc 1 866 0
	ldrb	r3, [r4, #16]	@ zero_extendqisi2
	.loc 1 893 0
	ldr	r1, [r2]
...
.LC0:
	...
	.ascii	"-1.4.1/src/core/udp.c\000"
	.space	3
.LC1:
	.ascii	"pbuf_header failed\012\000"
.LC2:
	.ascii	"Assertion \"%s\" failed at line %d in %s\012\000"
.LC3:
	.ascii	"p->payload == iphdr\000"
.LC4:
	.ascii	"rebind == 0\000"
.LC5:
	.ascii	"check that first pbuf can hold struct udp_hdr\000"
	.text
.Letext0:
	...
	.file 9 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/udp.h"
	...
	.file 14 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/inet_chksum.h"
...
.Ldebug_macro0:
	...
	.byte	0x4
	.file 27 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/snmp.h"
	.byte	0x3
	.uleb128 0x3d
	.uleb128 0x1b
	.byte	0x7
	...
	.byte	0x4
	.file 28 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/arch/perf.h"
	.byte	0x3
	.uleb128 0x3e
	.uleb128 0x1c
	.byte	0x7
	...
	.byte	0x4
	.file 29 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/dhcp.h"
	.byte	0x3
	.uleb128 0x3f
	.uleb128 0x1d
	.byte	0x5
	...
	.4byte	.LASF1162
	.byte	0x4
	.file 30 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/string.h"
	.byte	0x3
	.uleb128 0x41
	.uleb128 0x1e
	.byte	0x7
...
.LASF1167:
	.ascii	"UDP_LOCAL_PORT_RANGE_END 0xffff\000"
.LASF1226:
	.ascii	"_tos\000"
.LASF728:
...
.LASF1166:
	.ascii	"UDP_LOCAL_PORT_RANGE_START 0xc000\000"
.LASF798:
...
.LASF1168:
	.ascii	"UDP_ENSURE_LOCAL_PORT_RANGE(port) (((port) & ~UDP_L"
	.ascii	"OCAL_PORT_RANGE_START) + UDP_LOCAL_PORT_RANGE_START"
	.ascii	")\000"
.LASF764:
