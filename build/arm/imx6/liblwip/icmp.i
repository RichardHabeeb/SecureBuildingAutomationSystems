# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"
# 42 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"
...
# 43 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c" 2
...
# 37 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/icmp.h" 2
...
# 38 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/icmp.h" 2
...
# 39 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/icmp.h" 2
...
# 47 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c" 2
...
# 48 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c" 2
...
# 49 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c" 2
...
# 51 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c" 2
...
# 52 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c" 2
...
# 54 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c" 2
...
# 76 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"
void
  ...
  case 8:
    ...
    if (pbuf_header(p, (20 + (14 + 0)))) {
      ...
      if (pbuf_header(p, hlen)) {
        do { if(!(0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "icmp_input: moving p->payload to ip header failed\n", 152, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"); fflush((stdout)); abort(); } while(0); } while(0);
        goto memerr;
      }
      ...
      do { if(!((r->len >= hlen + sizeof(struct icmp_echo_hdr)))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "check that first pbuf can hold struct the ICMP header",
                                                                 162
# 161 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"
      ,
                                                                 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"
# 161 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"
      ); fflush((stdout)); abort(); } while(0); } while(0)
                                                                  ;

      if (pbuf_copy(r, p) != 0) {
        do { if(!(0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "icmp_input: copying to new pbuf failed\n", 165, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"); fflush((stdout)); abort(); } while(0); } while(0);
        goto memerr;
      }
      iphdr = (struct ip_hdr *)r->payload;

      if (pbuf_header(r, -hlen)) {
        do { if(!(0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "icmp_input: restoring original p->payload failed\n", 171, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"); fflush((stdout)); abort(); } while(0); } while(0);
        goto memerr;
      }
      ...
      if (pbuf_header(p, -(s16_t)(20 + (14 + 0)))) {
        do { if(!(0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "icmp_input: restoring original p->payload failed\n", 181, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"); fflush((stdout)); abort(); } while(0); } while(0);
        goto memerr;
      }
    }
    ...
    if(pbuf_header(p, hlen)) {
      do { if(!(0)) do { printf("Assertion \"%s\" failed at line %d in %s\n", "Can't move over header in packet", 218, "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"); fflush((stdout)); abort(); } while(0); } while(0);
    } else {
      err_t ret;

      ret = ip_output_if(p, (&current_iphdr_dest), ((void*)0),
                   (255), 0, 1, inp);
      if (ret != 0) {
        ;
      }
...
# 260 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"
void
icmp_dest_unreach(struct pbuf *p, enum icmp_dur_type t)
{
  icmp_send_response(p, 3, t);
}
# 274 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"
void
icmp_time_exceeded(struct pbuf *p, enum icmp_te_type t)
{
  icmp_send_response(p, 11, t);
}
# 290 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"
static void
icmp_send_response(struct pbuf *p, u8_t type, u8_t code)
{
  ...
  do { if(!((q->len >= (sizeof(struct icmp_echo_hdr) + 20 + 8)))) do { printf("Assertion \"%s\" failed at line %d in %s\n", "check that first pbuf can hold icmp message",
                                                                                              307
# 306 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"
  ,
                                                                                              "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"
# 306 "/home/mint/seL4/dhs-demo-feb-2018/libs/liblwip/lwip-1.4.1/src/core/ipv4/icmp.c"
  ); fflush((stdout)); abort(); } while(0); } while(0)
  ...
  ip_output(q, ((void*)0), &iphdr_src, (255), 0, 1);
  pbuf_free(q);
}
