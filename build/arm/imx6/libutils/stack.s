...
.Ltext0:
	...
	.align	2
	.global	utils_run_on_stack
	.syntax unified
	.arm
	.type	utils_run_on_stack, %function
utils_run_on_stack:
	.fnstart
.LFB0:
	.file 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libutils/src/arch/arm/stack.c"
	.loc 1 15 0
	.cfi_startproc
...
.LVL0:
	...
	.loc 1 17 0
	.syntax divided
@ 17 "/home/mint/seL4/dhs-demo-feb-2018/libs/libutils/src/arch/arm/stack.c" 1
	mov r4, sp
	mov sp, ip
	mov r0, r6
	blx r5
...
.LFE0:
	.fnend
	.size	utils_run_on_stack, .-utils_run_on_stack
.Letext0:
...
.Ldebug_macro0:
	...
	.uleb128 0xb
	.4byte	.LASF380
	.file 2 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/utils/stack.h"
	.byte	0x3
	.uleb128 0xb
	.uleb128 0x2
	.byte	0x5
