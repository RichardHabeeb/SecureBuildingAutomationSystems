# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libelf/src/elf32.c"
# 1 "/home/mint/seL4/dhs-demo-feb-2018/build/arm/imx6/libelf//"
# 1 "<built-in>"
#define __STDC__ 1
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libelf/src/elf32.c"
# 81 "/home/mint/seL4/dhs-demo-feb-2018/libs/libelf/src/elf32.c"
...
void elf_getProgramHeaderInfo(void *elfFile, uint16_t ph, uint64_t *p_vaddr,
         uint64_t *p_paddr, uint64_t *p_filesz,
         uint64_t *p_offset, uint64_t *p_memsz);
# 82 "/home/mint/seL4/dhs-demo-feb-2018/libs/libelf/src/elf32.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/elf/debug.h" 1
# 82 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/elf/debug.h"
...
# 83 "/home/mint/seL4/dhs-demo-feb-2018/libs/libelf/src/elf32.c" 2
...
# 84 "/home/mint/seL4/dhs-demo-feb-2018/libs/libelf/src/elf32.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/inttypes.h" 1
...
# 14 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/inttypes.h" 2
...
# 85 "/home/mint/seL4/dhs-demo-feb-2018/libs/libelf/src/elf32.c" 2
...
# 214 "/home/mint/seL4/dhs-demo-feb-2018/libs/libelf/src/elf32.c"
int
...
# 246 "/home/mint/seL4/dhs-demo-feb-2018/libs/libelf/src/elf32.c"
void
 ...
 if (flags & 1) {
  ...
  for (i = 0; i < numSegments; i++) {
   if (segments[i].p_type != 1) {
    ...
    fprintf(f, "  LOAD           0x%06" "x" " 0x%08" "x" " 0x%08" "x"
           " 0x%05" "x"" 0x%05" "x" " %c%c%c 0x%04" "x" "\n",


     segments[i].p_offset, segments[i].p_vaddr,
     segments[i].p_paddr,
     segments[i].p_filesz, segments[i].p_memsz,
     segments[i].p_flags & 4 ? 'R' : ' ',
     segments[i].p_flags & 2 ? 'W' : ' ',
     segments[i].p_flags & 1 ? 'E' : ' ',
     segments[i].p_align);
   }
  }
 }
