...
.Ltext0:
	...
	.syntax unified
	.arm
	.type	pbuf_take_partial, %function
pbuf_take_partial:
	.fnstart
.LFB1:
	.file 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.c"
	.loc 1 38 0
	.cfi_startproc
...
.LFE1:
	.fnend
	.size	pbuf_take_partial, .-pbuf_take_partial
	.align	2
	.global	pb_alignl
	.syntax unified
	.arm
	.type	pb_alignl, %function
pb_alignl:
	.fnstart
.LFB0:
	.loc 1 30 0
...
.LFE0:
	.fnend
	.size	pb_alignl, .-pb_alignl
	.align	2
	.global	pb_write
	.syntax unified
	.arm
	.type	pb_write, %function
pb_write:
	.fnstart
.LFB2:
	.loc 1 65 0
...
.LFE2:
	.fnend
	.size	pb_write, .-pb_write
	.align	2
	.global	pb_write_arrl
	.syntax unified
	.arm
	.type	pb_write_arrl, %function
pb_write_arrl:
	.fnstart
.LFB3:
	.loc 1 71 0
...
.LFE3:
	.fnend
	.size	pb_write_arrl, .-pb_write_arrl
	.align	2
	.global	pb_writel
	.syntax unified
	.arm
	.type	pb_writel, %function
pb_writel:
	.fnstart
.LFB4:
	.loc 1 84 0
...
.LFE4:
	.fnend
	.size	pb_writel, .-pb_writel
	.align	2
	.global	pb_write_str
	.syntax unified
	.arm
	.type	pb_write_str, %function
pb_write_str:
	.fnstart
.LFB5:
	.loc 1 91 0
...
.LFE5:
	.fnend
	.size	pb_write_str, .-pb_write_str
	.align	2
	.global	pb_read
	.syntax unified
	.arm
...
.LFE7:
	.fnend
	.size	pb_read_arrl, .-pb_read_arrl
	.align	2
	.global	pb_readl
	.syntax unified
	.arm
	.type	pb_readl, %function
pb_readl:
	.fnstart
.LFB8:
	.loc 1 130 0
...
.LFE8:
	.fnend
	.size	pb_readl, .-pb_readl
	.align	2
	.global	pb_read_str
	.syntax unified
	.arm
	.type	pb_read_str, %function
pb_read_str:
	.fnstart
.LFB9:
	.loc 1 136 0
...
.LFE9:
	.fnend
	.size	pb_read_str, .-pb_read_str
	.section	.rodata
	.align	2
	.set	.LANCHOR0,. + 0
	.type	__func__.4869, %object
	.size	__func__.4869, 18
__func__.4869:
	.ascii	"pbuf_take_partial\000"
	.space	2
	.type	__func__.4913, %object
	.size	__func__.4913, 8
__func__.4913:
	.ascii	"pb_read\000"
	.type	__func__.4936, %object
	.size	__func__.4936, 12
__func__.4936:
	.ascii	"pb_read_str\000"
	.section	.rodata.str1.4,"aMS",%progbits,1
	.align	2
.LC0:
	.ascii	"/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/p"
	.ascii	"buf_helpers.c\000"
	.space	3
.LC1:
	.ascii	"offset < p->tot_len\000"
.LC2:
	.ascii	"offset + len <= p->tot_len\000"
	.space	1
.LC3:
	.ascii	"*pos <= pbuf->tot_len\000"
	.space	2
.LC4:
	.ascii	"*pos + count <= pbuf->tot_len\000"
	.space	2
.LC5:
	.ascii	"count == read\000"
	.space	2
.LC6:
	.ascii	"strlen < maxlen - 1\000"
	.text
.Letext0:
	...
	.file 4 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/pbuf.h"
	.file 5 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/assert.h"
	.file 6 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/def.h"
...
.Ldebug_macro0:
	...
	.uleb128 0xb
	.4byte	.LASF380
	.file 7 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.h"
	.byte	0x3
	.uleb128 0xb
	.uleb128 0x7
	.byte	0x5
	...
	.uleb128 0x22
	.4byte	.LASF480
	.file 11 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/opt.h"
	.byte	0x3
	.uleb128 0x24
	.uleb128 0xb
	.byte	0x5
	.uleb128 0x27
	.4byte	.LASF481
	.file 12 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/lwipopts.h"
	.byte	0x3
	.uleb128 0x2d
	.uleb128 0xc
	.byte	0x7
	.4byte	.Ldebug_macro7
	.byte	0x4
	.file 13 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/debug.h"
	.byte	0x3
	.uleb128 0x2e
	.uleb128 0xd
	.byte	0x5
	.uleb128 0x21
	.4byte	.LASF495
	.file 14 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/arch.h"
	.byte	0x3
	.uleb128 0x23
	.uleb128 0xe
	.byte	0x7
	...
	.byte	0x4
	.file 18 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/string.h"
	.byte	0x3
	.uleb128 0xe
	.uleb128 0x12
	.byte	0x7
