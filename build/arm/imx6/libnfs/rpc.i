# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c"
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c" 2
...
# 14 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/time.h" 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/time.h"
#define __TIME_H 
# 23 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/time.h"
uint32_t udp_time_get(const struct ip_addr *server);
# 15 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c" 2
...
# 16 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c" 2
...
# 17 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c" 2
...
# 21 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c" 2
...
# 22 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c" 2
...
my_udp_send(struct udp_pcb* pcb, struct pbuf *pbuf)
{
    ...
    ((!pbuf_copy(p, pbuf)) ? ((void)0) : (__assert_fail("!pbuf_copy(p, pbuf)", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c", 125, __func__)));
    err = udp_send(pcb, p);
    pbuf_free(p);
    switch(err){
    case -1:
...
struct rpc_queue *queue = ((void*)0);
# 192 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c"
void
rpc_timeout(int ms)
{
    struct rpc_queue *q_item;
    for (q_item = queue; q_item != ((void*)0); q_item = q_item->next) {
        q_item->timeout += ms;
        if (q_item->timeout > 500) {
            ;
         ...
         void *callback, uintptr_t arg)
{
    ...
    ((q_item != ((void*)0)) ? ((void)0) : (__assert_fail("q_item != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c", 219, __func__)));
    ...
    if (queue == ((void*)0)) {
        ...
        for(tmp = queue; tmp->next != ((void*)0); tmp = tmp->next)
            ;
        tmp->next = q_item;
    }
}
...
{
    struct rpc_queue *tmp, *last = ((void*)0);

    for (tmp = queue; tmp != ((void*)0) && tmp->xid != xid; tmp = tmp->next) {
        last = tmp;
        ;
    }
    if (tmp == ((void*)0)) {
    ...
    struct ip_addr *addr, u16_t port)
{
    ...
    ;
    if (q_item != ((void*)0)){
        ((q_item->func) ? ((void)0) : (__assert_fail("q_item->func", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c", 280, __func__)));
...
{
    ((pcb) ? ((void)0) : (__assert_fail("pcb", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c", 296, __func__)));
...
rpc_call_cb(void *callback, uintptr_t token, struct pbuf *pbuf)
{
    ...
    (void)callback;
    ;
    ((call_arg) ? ((void)0) : (__assert_fail("call_arg", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c", 316, __func__)));
     ...
     void *callback, uintptr_t token)
{
    ...
    ((pcb) ? ((void)0) : (__assert_fail("pcb", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c", 336, __func__)));
    ((pbuf) ? ((void)0) : (__assert_fail("pbuf", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c", 337, __func__)));
    ...
    stat = rpc_send(pbuf, pbuf->tot_len, pcb, &rpc_call_cb, ((void*)0),
                   (uintptr_t)&call_arg);
    if(stat){
        return stat;
    }
    ...
    q_item = get_from_queue(xid);
    ((q_item) ? ((void)0) : (__assert_fail("q_item", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c", 368, __func__)));
    pbuf_free(q_item->pbuf);
    free(q_item);
    return RPCERR_COMM;
}
            ...
            enum port_type local_port)
{
    ...
    ret = udp_new();
    ((ret) ? ((void)0) : (__assert_fail("ret", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c", 396, __func__)));
    udp_recv(ret, my_recv, ((void*)0));
    if(local_port == PORT_ROOT){
        if(root_port >= 1024 || root_port < 45){
            root_port = 45;
            ;
        }
        udp_bind(ret, ((ip_addr_t *)&ip_addr_any), root_port++);
    }else{
...
rpc_read_hdr(struct pbuf* pbuf, struct rpc_reply_hdr* hdr, int* pos)
{
    *pos = 0;
    ...
    if(hdr->msg_type != MSG_REPLY){
        ...
        ((auth.flavour == AUTH_NULL) ? ((void)0) : (__assert_fail("auth.flavour == AUTH_NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.c", 443, __func__)));
        ;
...
rpc_write_hdr(struct pbuf* pbuf, int prog, int vers, int proc, int* pos)
{
    ...
    const char* host = "boggo";
    uint32_t ids[] = {0, 0, 0};
    struct auth_hdr cred = {
            .flavour = AUTH_UNIX,
            .size = ((sizeof(uint32_t) + sizeof(uint32_t) + strlen(host) + sizeof(ids) + (4) - 1) - ((sizeof(uint32_t) + sizeof(uint32_t) + strlen(host) + sizeof(ids) + (4) - 1) & ((4) - 1)))
...
{
    struct pbuf* pbuf;
    pbuf = pbuf_alloc(PBUF_TRANSPORT, 1400, PBUF_RAM);
    if(pbuf) {
