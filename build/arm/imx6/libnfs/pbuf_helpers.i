# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.c"
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.h" 2
...
# 37 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/pbuf.h" 2
...
# 16 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.h" 2
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.c" 2
...
# 13 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.c" 2
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.c" 2
...
# 16 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.c" 2
...
void pb_alignl(int* pos)
{
    *pos = ((*pos + (sizeof(uint32_t)) - 1) - ((*pos + (sizeof(uint32_t)) - 1) & ((sizeof(uint32_t)) - 1)));
}
...
pbuf_take_partial(struct pbuf *p, const void *dataptr, u16_t len, u16_t offset)
{
    ...
    ((offset < p->tot_len) ? ((void)0) : (__assert_fail("offset < p->tot_len", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.c", 43, __func__)));
    ((offset + len <= p->tot_len) ? ((void)0) : (__assert_fail("offset + len <= p->tot_len", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.c", 44, __func__)));
    ...
    while(len > written){
        int bytes = (((p->len - offset)<(len - written))? (p->len - offset) : (len - written));
...
pb_write_str(struct pbuf* pbuf, const char* str, uint32_t len, int* pos)
{
    ...
    pb_write(pbuf, &padding, ((*pos + (4) - 1) - ((*pos + (4) - 1) & ((4) - 1))) - *pos, pos);
}
...
{
    u16_t read;
    ((*pos <= pbuf->tot_len) ? ((void)0) : (__assert_fail("*pos <= pbuf->tot_len", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.c", 109, __func__)));
    ((*pos + count <= pbuf->tot_len) ? ((void)0) : (__assert_fail("*pos + count <= pbuf->tot_len", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.c", 110, __func__)));
    read = pbuf_copy_partial(pbuf, data, count, *pos);
    ((count == read) ? ((void)0) : (__assert_fail("count == read", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.c", 112, __func__)));
    *pos = *pos + read;
}
...
pb_read_str(struct pbuf* pbuf, char* str, int maxlen, int* pos)
{
    ...
    ((strlen < maxlen - 1) ? ((void)0) : (__assert_fail("strlen < maxlen - 1", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.c", 140, __func__)));
