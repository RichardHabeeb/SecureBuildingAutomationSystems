...
.Ltext0:
	...
	.syntax unified
	.arm
	.type	time_recv, %function
time_recv:
	.fnstart
.LFB0:
	.file 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/time.c"
	.loc 1 41 0
	.cfi_startproc
...
.LFE0:
	.fnend
	.size	time_recv, .-time_recv
	.align	2
	.global	udp_time_get
	.syntax unified
	.arm
	.type	udp_time_get, %function
udp_time_get:
	.fnstart
.LFB1:
	.loc 1 50 0
...
.LVL9:
	...
	beq	.L4
	.loc 1 61 0
	movw	r1, #:lower16:time_recv
	mov	r2, #0
	movt	r1, #:upper16:time_recv
.LBB2:
	.loc 1 75 0
...
.LFE1:
	.fnend
	.size	udp_time_get, .-udp_time_get
	.section	.rodata
	.align	2
	.set	.LANCHOR1,. + 0
	.type	__func__.4970, %object
	.size	__func__.4970, 13
__func__.4970:
	.ascii	"udp_time_get\000"
	.section	.rodata.str1.4,"aMS",%progbits,1
	.align	2
.LC0:
	.ascii	"/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/t"
	.ascii	"ime.c\000"
	.space	3
.LC1:
	.ascii	"pbuf\000"
	...
	.align	2
	.set	.LANCHOR0,. + 0
	.type	utc1900_seconds, %object
	.size	utc1900_seconds, 4
utc1900_seconds:
	.space	4
	.text
.Letext0:
...
.Ldebug_macro0:
	...
	.uleb128 0xb
	.4byte	.LASF380
	.file 10 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/time.h"
	.byte	0x3
	.uleb128 0xb
	.uleb128 0xa
	.byte	0x5
...
.LASF964:
	.ascii	"TIME_RETRY_TO_US 10000\000"
.LASF437:
