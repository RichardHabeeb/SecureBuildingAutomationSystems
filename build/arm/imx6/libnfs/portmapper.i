# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/portmapper.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/portmapper.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/portmapper.c"
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/portmapper.h" 2
...
# 16 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/portmapper.h" 2
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/portmapper.c" 2
...
# 18 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.h" 2
...
# 13 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/portmapper.c" 2
...
# 14 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/portmapper.c" 2
...
# 16 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/portmapper.c" 2
...
portmapper_getport(const struct ip_addr *server, uint32_t prog, uint32_t vers)
{
    ...
    rpc_pcb = rpc_new_udp(server, 111, PORT_ANY);
    ((rpc_pcb) ? ((void)0) : (__assert_fail("rpc_pcb", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/portmapper.c", 60, __func__)));

    ;

    pbuf = rpcpbuf_init(100000, 2, 3, &pos);
    ((pbuf != ((void*)0)) ? ((void)0) : (__assert_fail("pbuf != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/portmapper.c", 65, __func__)));


    pb_writel(pbuf, prog, &pos);
    pb_writel(pbuf, vers, &pos);
    pb_writel(pbuf, 17, &pos);
    pb_writel(pbuf, 0, &pos);


    err = rpc_call(pbuf, pos, rpc_pcb, &getport_cb, ((void*)0), (uintptr_t)&port);
    udp_remove(rpc_pcb);
    if(err){
        ;
        return -1;
