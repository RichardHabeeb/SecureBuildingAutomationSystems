# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c"
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.h" 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.h"
#define __NFS_H 
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.h" 2
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c" 2
...
# 13 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/mountd.h" 1
# 23 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/mountd.h"
#define __MOUNTD_H 
# 38 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/mountd.h"
...
# 14 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/portmapper.h" 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/portmapper.h"
#define __PORTMAPPER_H 
# 27 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/portmapper.h"
int portmapper_getport(const ip_addr_t *server, uint32_t prog, uint32_t vers);
# 15 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.h" 1
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.h"
...
# 16 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c" 2
...
# 19 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c" 2
...
# 21 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c" 2
...
# 80 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c"
#define READDIR_BUF_SIZE 1024

static struct udp_pcb *_nfs_pcb = ((void*)0);
...
{
    ((_nfs_pcb) ? ((void)0) : (__assert_fail("_nfs_pcb", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c", 93, __func__)));
...
{
    ((_nfs_pcb) ? ((void)0) : (__assert_fail("_nfs_pcb", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c", 100, __func__)));
...
nfs_init(const struct ip_addr *server)
{
    ...
    port = portmapper_getport(server, 100003, 2);
    switch(port){
    case -1:
    ...
    default:
        ...
        ((_nfs_pcb) ? ((void)0) : (__assert_fail("_nfs_pcb", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c", 132, __func__)));
        return RPC_OK;
    }
}
...
_nfs_getattr_cb(void * callback, uintptr_t token, struct pbuf *pbuf)
{
    ...
    ((callback != ((void*)0)) ? ((void)0) : (__assert_fail("callback != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c", 150, __func__)));
            ...
            nfs_getattr_cb_t func, uintptr_t token)
{
    ...
    pbuf = rpcpbuf_init(100003, 2, 1, &pos);
    if(pbuf == ((void*)0)){
        return RPCERR_NOBUF;
    }
...
_nfs_lookup_cb(void * callback, uintptr_t token, struct pbuf *pbuf)
{
    ...
    ((callback != ((void*)0)) ? ((void)0) : (__assert_fail("callback != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c", 196, __func__)));
           ...
           nfs_lookup_cb_t func, uintptr_t token)
{
    ...
    pbuf = rpcpbuf_init(100003, 2, 4, &pos);
    if(pbuf == ((void*)0)){
        return RPCERR_NOBUF;
    }
...
_nfs_read_cb(void * callback, uintptr_t token, struct pbuf *pbuf)
{
    ...
    ((callback != ((void*)0)) ? ((void)0) : (__assert_fail("callback != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c", 245, __func__)));
    ...
    if (rpc_read_hdr(pbuf, &hdr, &pos) == RPCERR_OK){
        ...
        if (status == NFS_OK) {
            ...
            data = malloc(size);
            ((data != ((void*)0)) ? ((void)0) : (__assert_fail("data != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c", 257, __func__)));
         ...
         nfs_read_cb_t func, uintptr_t token)
{
    ...
    pbuf = rpcpbuf_init(100003, 2, 6, &pos);
    if(pbuf == ((void*)0)){
        return RPCERR_NOBUF;
    }
...
_nfs_write_cb(void * callback, uintptr_t token, struct pbuf *pbuf)
{
    ...
    ((callback != ((void*)0)) ? ((void)0) : (__assert_fail("callback != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c", 307, __func__)));
          ...
          nfs_write_cb_t func, uintptr_t token)
{
    ...
    pbuf = rpcpbuf_init(100003, 2, 8, &pos);
    if(pbuf == ((void*)0)){
        free(t);
        return RPCERR_NOBUF;
    }
...
_nfs_create_cb(void * callback, uintptr_t token, struct pbuf *pbuf)
{
    ...
    ((callback != ((void*)0)) ? ((void)0) : (__assert_fail("callback != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c", 380, __func__)));
           ...
           nfs_create_cb_t func, uintptr_t token)
{
    ...
    pbuf = rpcpbuf_init(100003, 2, 9, &pos);
    if(pbuf == ((void*)0)){
        return RPCERR_NOBUF;
    }
...
_nfs_remove_cb(void * callback, uintptr_t token, struct pbuf *pbuf)
{
    ...
    ((callback != ((void*)0)) ? ((void)0) : (__assert_fail("callback != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c", 428, __func__)));
           ...
           nfs_remove_cb_t func, uintptr_t token)
{
    ...
    pbuf = rpcpbuf_init(100003, 2, 10, &pos);
    if(pbuf == ((void*)0)){
        return RPCERR_NOBUF;
    }
...
_nfs_readdir_cb(void * callback, uintptr_t token, struct pbuf *pbuf)
{
    ...
    ;
    cb = callback;
    ((callback != ((void*)0)) ? ((void)0) : (__assert_fail("callback != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c", 474, __func__)));
    ...
    if (rpc_read_hdr(pbuf, &hdr, &pos) == RPCERR_OK){
        ...
        if (status == NFS_OK) {
            ...
            ((entries) ? ((void)0) : (__assert_fail("entries", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c", 514, __func__)));
            for(i = 0; i < num_entries; i++){
                struct filelist *old_head;
                ((head) ? ((void)0) : (__assert_fail("head", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/nfs.c", 517, __func__)));
                old_head = head;
                head = head->next;
        ...
        nfs_readdir_cb_t func, uintptr_t token)
{
    ...
    pbuf = rpcpbuf_init(100003, 2, 16, &pos);
    if(pbuf == ((void*)0)){
        return RPCERR_NOBUF;
    }
