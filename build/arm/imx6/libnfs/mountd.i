# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/mountd.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/mountd.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/mountd.c"
...
# 26 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/mountd.h" 2
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/mountd.c" 2
...
# 13 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/mountd.c" 2
...
# 14 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/mountd.c" 2
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/mountd.c" 2
...
# 17 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/mountd.c" 2
...
# 18 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/mountd.c" 2
...
{
    int port = portmapper_getport(server, 100005, 1);
...
mountd_print_exports(const struct ip_addr *server)
{
    ...
    ((mnt_pcb) ? ((void)0) : (__assert_fail("mnt_pcb", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/mountd.c", 104, __func__)));


    pbuf = rpcpbuf_init(100005, 1, 5, &pos);
    ((pbuf != ((void*)0)) ? ((void)0) : (__assert_fail("pbuf != NULL", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/mountd.c", 108, __func__)));


    err = rpc_call(pbuf, pos, mnt_pcb, &mountd_print_exports_cb, ((void*)0),
                    (uintptr_t)&token);
    udp_remove(mnt_pcb);
...
mountd_mount(const struct ip_addr *server, const char *dir, fhandle_t *pfh)
{
    ...
    mnt_pcb = mnt_new_udp(server);
    ((mnt_pcb) ? ((void)0) : (__assert_fail("mnt_pcb", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/mountd.c", 175, __func__)));


    pbuf = rpcpbuf_init(100005, 1, 1, &pos);
    if(pbuf == ((void*)0)){
        udp_remove(mnt_pcb);
        return RPCERR_NOBUF;
    }
    ...
    token.pfh = pfh;
    token.stat = RPC_OK;
    stat = rpc_call(pbuf, pos, mnt_pcb, &mountd_mount_cb, ((void*)0), (uintptr_t)&token);
    udp_remove(mnt_pcb);
