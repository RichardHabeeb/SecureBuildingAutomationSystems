# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/time.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/time.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/time.c"
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/time.h" 2
...
# 16 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/time.h" 2
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/time.c" 2
...
# 13 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/time.c" 2
...
# 14 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/time.c" 2
...
# 16 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/time.c" 2
...
# 17 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/time.c" 2
...
{
    struct udp_pcb *time_pcb = ((void*)0);
    struct pbuf *pbuf;
    int retry_count;
    ...
    while(utc1900_seconds == 0 && retry_count-- >= 0){
        ...
        pbuf = pbuf_alloc(PBUF_TRANSPORT, 0, PBUF_RAM);
        ((pbuf) ? ((void)0) : (__assert_fail("pbuf", "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/time.c", 75, __func__)));
        ...
        cnt_out = 0;
        while(utc1900_seconds == 0 && cnt_out < 10000){
            sos_usleep(1000);
            cnt_out += 1000;
        }
    }
