...
.Ltext0:
	...
	.syntax unified
	.arm
	.type	getport_cb, %function
getport_cb:
	.fnstart
.LFB0:
	.file 1 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/portmapper.c"
	.loc 1 38 0
	.cfi_startproc
...
.LFE0:
	.fnend
	.size	getport_cb, .-getport_cb
	.align	2
	.global	portmapper_getport
	.syntax unified
	.arm
	.type	portmapper_getport, %function
portmapper_getport:
	.fnstart
.LFB1:
	.loc 1 52 0
...
.LVL17:
	...
	add	ip, sp, #12
	mov	r2, #0
	movw	r3, #:lower16:getport_cb
	stm	sp, {r2, ip}
	ldr	r1, [sp, #8]
	mov	r0, r4
	movt	r3, #:upper16:getport_cb
	mov	r2, r5
	bl	rpc_call
.LVL18:
	mov	r4, r0
...
.LFE1:
	.fnend
	.size	portmapper_getport, .-portmapper_getport
	.section	.rodata
	.align	2
	.set	.LANCHOR0,. + 0
	.type	__func__.5177, %object
	.size	__func__.5177, 19
__func__.5177:
...
.Letext0:
	...
	.file 7 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/rpc.h"
	.file 8 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/pbuf_helpers.h"
...
.Ldebug_macro0:
	...
	.uleb128 0xb
	.4byte	.LASF380
	.file 10 "/home/mint/seL4/dhs-demo-feb-2018/libs/libnfs/src/portmapper.h"
	.byte	0x3
	.uleb128 0xb
	.uleb128 0xa
	.byte	0x5
	...
	.uleb128 0x22
	.4byte	.LASF854
	.file 21 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/err.h"
	.byte	0x3
	.uleb128 0x25
	.uleb128 0x15
	.byte	0x7
	...
	.byte	0x4
	.file 22 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/lwip/netif.h"
	.byte	0x3
	.uleb128 0x28
	.uleb128 0x16
	.byte	0x7
	...
	.byte	0x4
	.file 24 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/nfs/nfs.h"
	.byte	0x3
	.uleb128 0x11
	.uleb128 0x18
	.byte	0x7
...
.Ldebug_macro25:
	...
	.4byte	.LASF955
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.nfs.h.49.51cd264276528aea0d0b6635e8f23f45,comdat
.Ldebug_macro26:
	.2byte	0x4
	.byte	0
	.byte	0x5
