# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/sys/panic.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/sys/panic.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/sys/panic.c"
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/sys/panic.c" 2
...
# 13 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/sys/panic.c" 2
...
int rand_r (unsigned *);
# 16 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/sys/panic.c" 2
...
# 17 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/sys/panic.c" 2
...
inline void __conditional_panic(int condition, const char *message,
    ...
    if (condition) {
        do { if ((0) < 1){ printf("\033[1;31m"); plogf("\nPANIC %s-%s:%d %s\n\n", file, func, line, message); printf("\033[0;0m"); } } while (0);
        abort();
    }
}
