# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c"
# 17 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c"
...
char *ctermid(char *);
#define L_ctermid 20
# 18 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c" 2
...
int rand_r (unsigned *);
# 19 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c" 2
...
# 20 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c" 2
...
# 21 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c" 2
...
# 23 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c" 2
...
extern seL4_Error cspace_ut_retype_addr(seL4_Word address,
                                        ...
                                        cspace_t *dest,
                                        seL4_CPtr *dest_cap);
# 24 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.h" 1
# 11 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.h"
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.h" 2
...
# 25 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c" 2
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/mapping.h" 2
...
# 26 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c" 2
...
# 27 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c" 2
...
# 28 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c" 2
...
# 31 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c" 2
...
# 32 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c" 2
...
_dma_fill(seL4_Word pstart, seL4_Word pend, int cached){
    seL4_CPtr* caps = &_dma_caps[(pstart - _dma_pstart) >> 12];
    ...
    pstart -= ((pstart) & ((1 << 12) - 1));
    while(pstart < pend){
        if(*caps == seL4_CapNull){

            err = cspace_ut_retype_addr(pstart, seL4_ARM_SmallPageObject,
                                        12, cur_cspace, caps);
            ((!err) ? ((void)0) : (__assert_fail("!err", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c", 67, __func__)));

            err = map_page(*caps, seL4_CapInitThreadVSpace, ((pstart) + (0x10000000) - _dma_pstart),
                           seL4_AllRights, vm_attr);
            ((!err) ? ((void)0) : (__assert_fail("!err", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c", 71, __func__)));
        }
...
dma_init(seL4_Word dma_paddr_start, int sizebits){
    ((_dma_pstart == 0) ? ((void)0) : (__assert_fail("_dma_pstart == 0", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c", 82, __func__)));

    _dma_pstart = _dma_pnext = dma_paddr_start;
    _dma_pend = dma_paddr_start + (1 << sizebits);
    _dma_caps = (seL4_CPtr*)malloc(sizeof(seL4_CPtr) * ((_dma_pend - _dma_pstart) >> 12));
    __conditional_panic(!_dma_caps, "Not enough heap space for dma frame caps", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c", __func__, 87);

    memset(_dma_caps, 0, sizeof(seL4_CPtr) * ((_dma_pend - _dma_pstart) >> 12));
    return 0;
}
...
sos_dma_malloc(void* cookie, size_t size, int align, int cached, ps_mem_flags_t flags) {
    ...
    ((_dma_pstart) ? ((void)0) : (__assert_fail("_dma_pstart", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c", 100, __func__)));
    _dma_pnext = ({ typeof (_dma_pnext) _n = (_dma_pnext); typeof (7) _b = (7); (_n + (_n % 7 == 0 ? 0 : (_b - (_n % _b)))); });
    if(_dma_pnext < _dma_pend){

        if(alloc_cached != cached && ((_dma_pnext) & ((1 << 12) - 1)) != 0){
            _dma_pnext = ({ typeof (_dma_pnext) _n = (_dma_pnext); typeof ((1ul<<(12))) _b = ((1ul<<(12))); (_n + (_n % (1ul<<(12)) == 0 ? 0 : (_b - (_n % _b)))); });
        }

        _dma_pnext = ({ typeof (_dma_pnext) _n = (_dma_pnext); typeof (align) _b = (align); (_n + (_n % align == 0 ? 0 : (_b - (_n % _b)))); });
        alloc_cached = cached;

        _dma_fill(_dma_pnext, _dma_pnext + size, cached);

        dma_addr = (void*)((_dma_pnext) + (0x10000000) - _dma_pstart);
        _dma_pnext += size;
    }else{
        dma_addr = ((void*)0);
    }
    do { if ((5) < 5){ printf("\033[22;33m"); plogf("DMA: 0x%x\n", (uint32_t)dma_addr); printf("\033[0;0m"); } } while (0);

    sos_dma_cache_op(((void*)0), dma_addr, size, DMA_CACHE_OP_CLEAN_INVALIDATE);
    return dma_addr;
}
...
uintptr_t sos_dma_pin(void *cookie, void *addr, size_t size) {
    if ((uintptr_t)addr < (0x10000000) || (uintptr_t)addr >= ((0x10000000) + (1ull << (22)))) {
        return 0;
    } else {
        return (((uintptr_t)addr) - (0x10000000) + _dma_pstart);
    }
}
...
cache_foreach(void *vaddr, int range, sel4_cache_op_fn_t proc)
{
    ...
    for (uintptr_t addr = (uintptr_t)vaddr; addr < end; addr = next) {
        next = ({ typeof (((addr + ((1ul<<(12)))) & ~(((1ul<<(12))) - 1))) _a = (((addr + ((1ul<<(12)))) & ~(((1ul<<(12))) - 1))); typeof (end) _b = (end); _a < _b ? _a : _b; });
        error = proc(seL4_CapInitThreadVSpace, addr, next);
        ((!error) ? ((void)0) : (__assert_fail("!error", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/dma.c", 151, __func__)));
    }
}
