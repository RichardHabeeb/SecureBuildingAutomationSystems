# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c"
...
int rand_r (unsigned *);
# 12 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c" 2
...
# 13 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c" 2
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut.h" 2
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c" 2
# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/bitfield.h" 1
# 13 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/bitfield.h"
#define _BITFIELD_H_ 
...
# 16 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c" 2
...
char *ctermid(char *);
#define L_ctermid 20
# 15 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/sys/debug.h" 2
...
# 20 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c" 2
...
# 21 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c" 2
...
static bitfield_t* _pool14 = ((void*)0);
static bitfield_t* _pool12 = ((void*)0);
static bitfield_t* _pool10 = ((void*)0);
static suballocator_t* _pool9 = ((void*)0);
static suballocator_t* _pool4 = ((void*)0);
...
static void _bitfield_fill_pool(bitfield_t* bf, int sizebits){
    if(sizebits != 14){
        ...
        offset = bf_set_next_free(_pool14);
        if(offset != -1){
            int units;
            int i;
...
static void _bitfield_merge_up(bitfield_t* pool, int sizebits, int offset){
    if(sizebits != 14){
        ...
        sublevel_units = 1 << (14 - sizebits);
        sublevel_base = offset & ~(sublevel_units - 1);
        primary_base = sublevel_base >> (14 - sizebits);
...
static seL4_Word do_ut_alloc_from_bitfield(int sizebits){
    ...
    default:
        ...
        ((!"Invalid size") ? ((void)0) : (__assert_fail("!\"Invalid size\"", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 125, __func__)));
        return 0;
    }
...
static void do_ut_free_from_bitfield(seL4_Word addr, int sizebits){
    ...
    default:
        ...
        ((!"Invalid size") ? ((void)0) : (__assert_fail("!\"Invalid size\"", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 163, __func__)));
        return;
    }
...
static void _pool_list_detach(suballocator_t* node){
    ...
    ((node != ((void*)0)) ? ((void)0) : (__assert_fail("node != NULL", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 182, __func__)));
    ((*node->prev != ((void*)0)) ? ((void)0) : (__assert_fail("*node->prev != NULL", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 183, __func__)));
...
static void _pool_list_attach(suballocator_t** pool, suballocator_t* node){
    ((node) ? ((void)0) : (__assert_fail("node", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 200, __func__)));
    ((node->next == ((void*)0)) ? ((void)0) : (__assert_fail("node->next == NULL", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 201, __func__)));
    ((node->prev == ((void*)0)) ? ((void)0) : (__assert_fail("node->prev == NULL", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 202, __func__)));
...
static suballocator_t* _new_suballocator(int sizebits){
    ...
    primary_addr = do_ut_alloc_from_bitfield(14);
    if(primary_addr == 0){
        return ((void*)0);
    }
    ...
    if(pool_node == ((void*)0)){
        do_ut_free_from_bitfield(primary_addr, 14);
        return ((void*)0);
    }
    pool_node->base = primary_addr;
    pool_node->next = ((void*)0);
    pool_node->prev = ((void*)0);


    pool_node->bitfield = new_bitfield(units, BITFIELD_INIT_EMPTY);
    if(pool_node->bitfield == ((void*)0)){
        free(pool_node);
        do_ut_free_from_bitfield(primary_addr, 14);
        return ((void*)0);
    }
...
static seL4_Word do_ut_alloc_from_list(int sizebits){
    ...
    if(sizebits == 9){
        ...
        ((!"Invalid size") ? ((void)0) : (__assert_fail("!\"Invalid size\"", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 284, __func__)));
        return 0;
    }
    ...
    ((offset != -1) ? ((void)0) : (__assert_fail("offset != -1", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 300, __func__)));
...
static void do_ut_free_from_list(seL4_Word addr, int sizebits){
    ...
    if(sizebits == 9){
        ...
        ((!"Invalid size") ? ((void)0) : (__assert_fail("!\"Invalid size\"", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 320, __func__)));
        return;
    }
    ...
    ((pool_node) ? ((void)0) : (__assert_fail("pool_node", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 330, __func__)));


    bf_clr(pool_node->bitfield, offset);
    if(pool_node->bitfield->available == units){
        _pool_list_detach(pool_node);
        do_ut_free_from_bitfield(pool_node->base, 14);
...
void ut_allocator_init(seL4_Word low, seL4_Word high){
    ...
    ((!_initialised) ? ((void)0) : (__assert_fail("!_initialised", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 351, __func__)));


    low = ((low) & ~((1 << 14) - 1));
    high = (((high) + (1 << 14) - 1) & ~((1 << 14) - 1));
...
seL4_Word ut_alloc(int sizebits){
    ...
    ((_initialised) ? ((void)0) : (__assert_fail("_initialised", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 379, __func__)));


    ((_pool14 != ((void*)0)) ? ((void)0) : (__assert_fail("PRIMARY_POOL != NULL", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 382, __func__)));
    ...
    case 14:
        ...
        break;
    default:
        ((!"ut_free received invalid size") ? ((void)0) : (__assert_fail("!\"ut_free received invalid size\"", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 396, __func__)));
        return 0;
    }
...
void ut_free(seL4_Word addr, int sizebits){
    ((addr != 0) ? ((void)0) : (__assert_fail("addr != 0", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 404, __func__)));
    (((addr & ((1 << sizebits) - 1)) == 0 || !"Address not aligned") ? ((void)0) : (__assert_fail("(addr & ((1 << sizebits) - 1)) == 0 || !\"Address not aligned\"", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 405, __func__)));
    ...
    case 14:
        ...
        break;
    default:
        ((!"ut_free received invalid size") ? ((void)0) : (__assert_fail("!\"ut_free received invalid size\"", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/ut_manager/ut_allocator.c", 419, __func__)));
    }
}
