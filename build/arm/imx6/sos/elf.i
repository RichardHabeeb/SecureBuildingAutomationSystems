# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c"
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c" 2
...
# 107 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/elf/elf.h" 2
...
char *ctermid(char *);
#define L_ctermid 20
# 108 "/home/mint/seL4/dhs-demo-feb-2018/stage/arm/imx6/include/elf/elf.h" 2
...
void elf_getProgramHeaderInfo(void *elfFile, uint16_t ph, uint64_t *p_vaddr,
         uint64_t *p_paddr, uint64_t *p_filesz,
         uint64_t *p_offset, uint64_t *p_memsz);
# 13 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c" 2
...
# 14 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c" 2
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c" 2
...
extern seL4_Error cspace_ut_retype_addr(seL4_Word address,
                                        ...
                                        cspace_t *dest,
                                        seL4_CPtr *dest_cap);
# 16 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c" 2
...
# 18 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c" 2
...
# 20 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c" 2
...
# 21 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c" 2
...
# 22 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c" 2
...
# 25 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c" 2
...
# 26 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c" 2
...
# 88 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c"
    ((file_size <= segment_size) ? ((void)0) : (__assert_fail("file_size <= segment_size", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c", 88, __func__)));
    ...
    while(pos < segment_size) {
        ...
        kdst = dst_local + (0xD0000000);
        vpage = ((dst) & ~((((1 << (12))) - 1)));
        kvpage = ((kdst) & ~((((1 << (12))) - 1)));


        paddr = ut_alloc(12);
        __conditional_panic(!paddr, "Out of memory - could not allocate frame", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c", __func__, 111);
        err = cspace_ut_retype_addr(paddr,
                                    seL4_ARM_SmallPageObject,
                                    12,
                                    cur_cspace,
                                    &tty_cap);
        __conditional_panic(err, "Failed to retype to a frame object", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c", __func__, 117);


        sos_cap = cspace_copy_cap(cur_cspace, cur_cspace, tty_cap, seL4_AllRights);
        __conditional_panic(sos_cap == 0, "Failed to copy frame cap", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c", __func__, 121);


        err = map_page(tty_cap, dest_as, vpage, permissions,
                       seL4_ARM_Default_VMAttributes);
        __conditional_panic(err, "Failed to map to tty address space", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c", __func__, 126);

        err = map_page(sos_cap, seL4_CapInitThreadVSpace, kvpage, seL4_AllRights,
                       seL4_ARM_Default_VMAttributes);

        __conditional_panic(err, "Failed to map sos address space", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c", __func__, 131);


        nbytes = (1 << (12)) - (dst & (((1 << (12))) - 1));
        if (pos < file_size){
            memcpy((void*)kdst, (void*)src, (((nbytes)<(file_size - pos))?(nbytes):(file_size - pos)));
        }


        seL4_ARM_Page_Unify_Instruction(sos_cap, 0, (1 << (12)));

        err = unmap_page(sos_cap);
...
int elf_load(seL4_ARM_PageDirectory dest_as, char *elf_file) {
    ...
    for (i = 0; i < num_headers; i++) {
        ...
        if (elf_getProgramHeaderType(elf_file, i) != 1)
            continue;
        ...
        do { if ((1) < 0){ printf("\033[22;33m"); plogf(" * Loading segment %08x-->%08x\n", (int)vaddr, (int)(vaddr + segment_size)); printf("\033[0;0m"); } } while (0);
        ...
        __conditional_panic(err != 0, "Elf loading failed!\n", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/elf.c", __func__, 182);
    }
