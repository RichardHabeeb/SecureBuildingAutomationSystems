# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/mapping.c"
...
#define FASTPATH 1
# 1 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/mapping.c"
# 11 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/mapping.c"
...
# 12 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/mapping.c" 2
...
# 14 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/mapping.c" 2
...
# 15 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/mapping.c" 2
...
char *ctermid(char *);
#define L_ctermid 20
# 15 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/sys/panic.h" 2
...
# 18 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/mapping.c" 2
...
# 19 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/mapping.c" 2
...
extern seL4_Error cspace_ut_retype_addr(seL4_Word address,
                                        ...
                                        cspace_t *dest,
                                        seL4_CPtr *dest_cap);
# 20 "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/mapping.c" 2
...
map_device(void* paddr, int size){
    static seL4_Word virt = (0xB0000000);
    seL4_Word phys = (seL4_Word)paddr;
    seL4_Word vstart = virt;

    do { if ((1) < 0){ printf("\033[22;33m"); plogf("Mapping device memory 0x%x -> 0x%x (0x%x bytes)\n", phys, vstart, size); printf("\033[0;0m"); } } while (0)
                                   ;
    while(virt - vstart < size){
        ...
        err = cspace_ut_retype_addr(phys,
                                    ...
                                    cur_cspace,
                                    &frame_cap);
        __conditional_panic(err, "Unable to retype device memory", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/mapping.c", __func__, 93);
        ...
        err = map_page(frame_cap,
                       ...
                       seL4_AllRights,
                       0);
        __conditional_panic(err, "Unable to map device", "/home/mint/seL4/dhs-demo-feb-2018/apps/sos/src/mapping.c", __func__, 100);
...
int
unmap_page(seL4_CPtr frame_cap){
